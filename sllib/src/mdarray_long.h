...
/**
 * @file   mdarray_long.h
 * @brief  long型の多次元配列を扱う mdarray_long クラスのヘッダファイル
 */
 ...
 * @brief  long型の多次元配列を扱うためのクラス
 *
 *   mdarray_longクラスは，long型の多次元配列を IDL や Python のように
 ...
 * 
 * @note  mdarray_longクラスは mdarray(基底クラス) を継承しています．<br>
  ...
  public:
    ...
    */
    ...
    virtual mdarray_long &vinit( bool auto_resize, const char *dim_info,
				  long v0, va_list );
#endif
    /*  mdarray_long &init( const mdarray &obj ); が隠れている */
