/**
  example code
  mdarray¥¯¥é¥¹: ssize_t mdarray::transposef_xyz2zxy_copy(...)
*/
...
int main( int argc, char *argv[] )
{
    ...
    sio.printf("*** BEGIN: 81_transposef_xyz2zxy_sample ***\n");
    ...
    myarr.transposef_xyz2zxy_copy(&myarr, "*");
    ...
    myarr.transposef_xyz2zxy_copy(&myarr1, "1:2, 2:4, 1:2");
    ...
    sio.printf("*** END: 81_transposef_xyz2zxy_sample ***\n");
    sio.printf("\n");
