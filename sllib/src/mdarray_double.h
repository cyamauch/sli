...
#ifndef _SLI__MDARRAY_DOUBLE_H
#define _SLI__MDARRAY_DOUBLE_H 1

/**
 * @file   mdarray_double.h
 * @brief  double型の多次元配列を扱う mdarray_double クラスのヘッダファイル
 */
...
/*
 * sli::mdarray_double is an inherited class of sli::mdarray, and is a 
...
/**
 * @class  sli::mdarray_double
 * @brief  double型の多次元配列を扱うためのクラス
 *
 *   mdarray_doubleクラスは，double型の多次元配列を IDL や Python のように
 ...
 * 
 * @note  mdarray_doubleクラスは mdarray(基底クラス) を継承しています．<br>
 *        SIMD命令(SSE2)により，基本的な部分が高速化されています．
 * @author  Chisato YAMAUCHI
 * @date  2013-04-01 00:00:00
 */

  class mdarray_double : public mdarray
  {

  public:
    /* constructor                                                           */
    /* The mdarray_double class has two kinds of operating modes:            */
    ...
    mdarray_double();
    mdarray_double( bool auto_resize );
    mdarray_double( bool auto_resize, double **extptr_address );
    mdarray_double( bool auto_resize, double *const **extptr2d_address );
    mdarray_double( bool auto_resize, double *const *const **extptr3d_address );
    mdarray_double( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf );
    mdarray_double( bool auto_resize, size_t naxis0 );
    mdarray_double( bool auto_resize, size_t naxis0, size_t naxis1 );
    mdarray_double( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 );
    mdarray_double( bool auto_resize, size_t naxis0, 
		   const double vals[] );
    mdarray_double( bool auto_resize, size_t naxis0, size_t naxis1,
		   const double vals[] );
...
#if 0
    mdarray_double( bool auto_resize, const char *dim_info, double v0, ... );
#endif
    mdarray_double( const mdarray_double &obj );


    /* --------------------------------------------------------------------- */

    /* `virtual' がついてるものはオーバーライドではなくオーバーロード     */
    /*   mdarray_double &operator=(const mdarray_double &obj);            */
    /* が隠れて存在する事に注意 (演算子 = だけは，特別な規則があるらしい) */

    /* substitute an array (copy the attribute, too)                      */
    virtual mdarray_double &operator=(const mdarray &obj);

    /* (overridden) */
    mdarray_double &operator+=(const mdarray &obj);
    mdarray_double &operator-=(const mdarray &obj);
    mdarray_double &operator*=(const mdarray &obj);
    mdarray_double &operator/=(const mdarray &obj);

    /* (overridden) */
    mdarray_double &operator=(dcomplex v);
    mdarray_double &operator=(double v);
    mdarray_double &operator=(long long v);
    mdarray_double &operator=(long v);
    mdarray_double &operator=(int v);
    mdarray_double &operator+=(dcomplex v);
    mdarray_double &operator+=(double v);
    mdarray_double &operator+=(long long v);
    mdarray_double &operator+=(long v);
    ...
    */
    ...
    /* <overloaded>                */
    virtual mdarray_double &init( bool auto_resize );
    virtual mdarray_double &init( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf );
    virtual mdarray_double &init( bool auto_resize, size_t naxis0 );
    virtual mdarray_double &init( bool auto_resize, size_t naxis0, size_t naxis1 );
    virtual mdarray_double &init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 );
    virtual mdarray_double &init( bool auto_resize, size_t naxis0, 
				 const double vals[] );
    virtual mdarray_double &init( bool auto_resize, size_t naxis0, size_t naxis1,
				 const double vals[] );
    ...
    virtual mdarray_double &init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2,
				 const double *const *const vals[] );
#if 0
    virtual mdarray_double &init( bool auto_resize, const char *dim_info,
				 double v0, ... );
    virtual mdarray_double &vinit( bool auto_resize, const char *dim_info,
				  double v0, va_list );
#endif
    /*  mdarray_double &init( const mdarray &obj ); が隠れている */
    /*  (↑mdarrayクラスのポインタ経由で呼び出し可能)            */

    /* (overridden)                                           */
    mdarray_double &init( const mdarray &obj );

    /* copy properties (auto_resize, auto_init, and rounding) */
    /* (overridden)                                           */
    mdarray_double &init_properties( const mdarray &src_obj );

    /* setting of the resize mode */
    /* (overridden)               */
    mdarray_double &set_auto_resize( bool tf );

    /* setting of the initialize mode */
    /* (overridden)                   */
    mdarray_double &set_auto_init( bool tf );

    /* setting of the rounding off possibility */
    /* (overridden)                            */
    mdarray_double &set_rounding( bool tf );

    /* setting of strategy of memory allocation */
    /* "auto", "min" and "pow" can be set.      */
    /* (overridden)                             */
    mdarray_double &set_alloc_strategy( const char *strategy );

    /* convert the value of the full array element */
    /* <overloaded>                                */
    virtual mdarray_double &convert_via_udf(
		void (*func)(const double *,double *,size_t,int,void *),
		void *user_ptr );

    /* swap contents between self and another objects */
    /* (overridden)                 */
    mdarray_double &swap( mdarray &sobj );
    ...
    /* (overridden)                             */
    mdarray_double &cut( mdarray *dest );

    /* interchange rows and columns */
    /* (overridden)                 */
    mdarray_double &transpose_xy();

    /* interchange xyz to zxy */
    /* (overridden)           */
    mdarray_double &transpose_xyz2zxy();

    /* rotate image                                              */
    /*   angle: 90,-90, or 180                                   */
    /*          (anticlockwise when image is bottom-left origin) */
    /* (overridden)                                              */
    mdarray_double &rotate_xy( int angle );
    ...
    */
    ...
    /* (overridden)                                          */
    mdarray_double &assign( dcomplex value,
			    ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF,
			    ssize_t idx2 = MDARRAY_INDEF );
    mdarray_double &assign( double value, 
			    ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF,
			    ssize_t idx2 = MDARRAY_INDEF );

    /* a reference to the specified value of the element (1 dimension) */
    virtual double &operator[]( ssize_t idx0 );
    virtual const double &operator[]( ssize_t idx0 ) const;

    /* a reference to the specified value of the element (1-3 dimensions) */
    virtual double &operator()( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				ssize_t idx2 = MDARRAY_INDEF);
    virtual const double &operator()( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				ssize_t idx2 = MDARRAY_INDEF) const;

    /* a reference to the specified value of the element (1-3 dimensions) */
    virtual double &at( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
			  ssize_t idx2 = MDARRAY_INDEF);
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const double &at( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				 ssize_t idx2 = MDARRAY_INDEF) const;
#endif
    virtual const double &at_cs( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				 ssize_t idx2 = MDARRAY_INDEF) const;
    ...
    /* <overloaded>                                */
    virtual mdarray_double &put( double value, ssize_t idx, size_t len );
    virtual mdarray_double &put( double value,
				size_t dim_index, ssize_t idx, size_t len );

    /* copy the array stored in object into the programmer's buffer. */
    /* <overloaded>                                                  */
    virtual ssize_t get_elements( double *dest_buf, size_t elem_size, 
				ssize_t idx0 = 0, ssize_t idx1 = MDARRAY_INDEF,
				ssize_t idx2 = MDARRAY_INDEF ) const;

    /* copy the array in the programmer's buffer into object's buffer. */
    /* <overloaded>                                                    */
    virtual ssize_t put_elements( const double *src_buf, size_t elem_size,
				ssize_t idx0 = 0, ssize_t idx1 = MDARRAY_INDEF,
				ssize_t idx2 = MDARRAY_INDEF );
    ...
    /* (overridden)                      */
    mdarray_double &increase_dim();

    /* reduction of the dimension number */
    /* (overridden)                      */
    mdarray_double &decrease_dim();

    /* change the length of the array */
    /* (overridden)                   */
    mdarray_double &resize( size_t len );
    mdarray_double &resize( size_t dim_index, size_t len );
    mdarray_double &resize( const mdarray &src );

    /* change the length of the 1-d array */
    /* (overridden)                       */
    mdarray_double &resize_1d( size_t x_len );

    /* change the length of the 2-d array */
    /* (overridden)                       */
    mdarray_double &resize_2d( size_t x_len, size_t y_len );

    /* change the length of the 3-d array */
    /* (overridden)                       */
    mdarray_double &resize_3d( size_t x_len, size_t y_len, size_t z_len );

    /* change the length of the array (supports n-dim) */
    /* (overridden)                                    */
    mdarray_double &resize( const size_t naxisx[], size_t ndim, 
			    bool init_buf );
    ...
    /* (overridden)                                                   */
    mdarray_double &resizef( const char *exp_fmt, ... );
    mdarray_double &vresizef( const char *exp_fmt, va_list ap );

    /* change the length of the array relatively */
    /* (overridden)                              */
    mdarray_double &resizeby( ssize_t len );			/* for 1-d */
    mdarray_double &resizeby( size_t dim_index, ssize_t len );

    /* change the length of the 1-d array relatively */
    /* (overridden)                                  */
    mdarray_double &resizeby_1d( ssize_t x_len );

    /* change the length of the 2-d array relatively */
    /* (overridden)                                  */
    mdarray_double &resizeby_2d( ssize_t x_len, ssize_t y_len );

    /* change the length of the 3-d array relatively */
    /* (overridden)                                  */
    mdarray_double &resizeby_3d(ssize_t x_len, ssize_t y_len, ssize_t z_len);
    ...
    /* (overridden)                                                         */
    mdarray_double &resizeby( const ssize_t naxisx_rel[], size_t ndim, 
			       bool init_buf );
    ...
    /* length of first dimension.                                      */
    /* (overridden)                                                    */
    mdarray_double &resizebyf( const char *exp_fmt, ... );
    mdarray_double &vresizebyf( const char *exp_fmt, va_list ap );

    /* change length of array without adjusting buffer contents */
    /* (overridden)                                             */
    mdarray_double &reallocate( const size_t naxisx[], size_t ndim, 
				bool init_buf );

    /* free current buffer and alloc new memory */
    /* (overridden)                             */
    mdarray_double &allocate( const size_t naxisx[], size_t ndim, 
			      bool init_buf );

    /* setting of the initial value for .resize(), etc. */
    /* <overloaded>                                     */
    virtual mdarray_double &assign_default( double value );

    /* insert a blank section */
    /* (overridden)           */
    mdarray_double &insert( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_double &insert( size_t dim_index, ssize_t idx, size_t len );

    /* erase a section */
    /* (overridden)    */
    mdarray_double &erase( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_double &erase( size_t dim_index, ssize_t idx, size_t len );

    /* copy values between elements (without automatic resizing) */
    /* 移動 (バッファのサイズは変更しない)                       */
    /* (overridden)                                              */
    mdarray_double &move( ssize_t idx_src, size_t len, ssize_t idx_dst,
			   bool clr );				/* for 1-d */
    mdarray_double &move( size_t dim_index, 
    ...
    /* (overridden)                                           */
    mdarray_double &cpy( ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr );				/* for 1-d */
    mdarray_double &cpy( size_t dim_index, 
			  ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr );

    /* replace values between elements */
    /* (overridden)                    */
    mdarray_double &swap( ssize_t idx_src, size_t len, 
			  ssize_t idx_dst );			/* for 1-d */
    mdarray_double &swap( size_t dim_index, 
			   ssize_t idx_src, size_t len, ssize_t idx_dst );

    /* extract a section           */
    /* see also trimf() and trim() */
    /* (overridden)                */
    mdarray_double &crop( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_double &crop( size_t dim_index, ssize_t idx, size_t len );

    /* flip a section   */
    /* see also flipf() */
    /* (overridden)     */
    mdarray_double &flip( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_double &flip( size_t dim_index, ssize_t idx, size_t len );
    ...
    */
    ...
    /* Flipping elements is supported */
    /* (overridden)                   */
    mdarray_double &trimf( const char *exp_fmt, ... );
    mdarray_double &vtrimf( const char *exp_fmt, va_list ap );

    /* flip elements in a section */
    /* (overridden)               */
    mdarray_double &flipf( const char *exp_fmt, ... );
    mdarray_double &vflipf( const char *exp_fmt, va_list ap );
    ...
    /* (overridden)                        */
    mdarray_double &cleanf( const char *exp_fmt, ... );
    mdarray_double &vcleanf( const char *exp_fmt, va_list ap );

    /* rewrite element values with a value in a section */
    /* (overridden)                                     */
    mdarray_double &fillf( double value, const char *exp_fmt, ... );
    mdarray_double &vfillf( double value, const char *exp_fmt, va_list ap );

    /* <overloaded>                                     */
    virtual mdarray_double &fillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_double *,void *),
        void *user_ptr, const char *exp_fmt, ... );
    virtual mdarray_double &vfillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_double *,void *),
        void *user_ptr, const char *exp_fmt, va_list ap );

    /* add a scalar value to element values in a section */
    /* (overridden)                                      */
    mdarray_double &addf( double value, 
			  const char *exp_fmt, ... );
    mdarray_double &vaddf( double value, 
			   const char *exp_fmt, va_list ap );

    /* subtract a scalar value from element values in a section */
    /* (overridden)                                             */
    mdarray_double &subtractf( double value, 
			       const char *exp_fmt, ... );
    mdarray_double &vsubtractf( double value, 
				const char *exp_fmt, va_list ap );

    /* multiply element values in a section by a scalar value */
    /* (overridden)                                           */
    mdarray_double &multiplyf( double value, 
			       const char *exp_fmt, ... );
    mdarray_double &vmultiplyf( double value, 
				const char *exp_fmt, va_list ap );

    /* divide element values in a section by a scalar value */
    /* (overridden)                                         */
    mdarray_double &dividef( double value, 
			     const char *exp_fmt, ... );
    mdarray_double &vdividef( double value, 
			      const char *exp_fmt, va_list ap );
    ...
    /* (overridden)                                                          */
    mdarray_double &pastef( const mdarray &src,
			    const char *exp_fmt, ... );
    mdarray_double &vpastef( const mdarray &src,
			     const char *exp_fmt, va_list ap );
    ...
    /*   8. user pointer                                                     */
    /* <overloaded>                                                          */
    virtual mdarray_double &pastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_double *,void *),
	void *user_ptr,
        const char *exp_fmt, ... );
    virtual mdarray_double &vpastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_double *,void *),
	void *user_ptr,
        const char *exp_fmt, va_list ap );
    ...
    /* add an array object */
    /* (overridden)        */
    mdarray_double &addf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_double &vaddf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* subtract an array object */
    /* (overridden)             */
    mdarray_double &subtractf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_double &vsubtractf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* multiply an array object */
    /* (overridden)             */
    mdarray_double &multiplyf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_double &vmultiplyf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* divide an array object */
    /* (overridden)           */
    mdarray_double &dividef( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_double &vdividef( const mdarray &src_img, const char *exp_fmt, va_list ap );
    ...
    */
    ...
    /* rewrite element values with a value in a section */
    /* (overridden)                                     */
    mdarray_double &fill( double value,
			 ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
			 ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
			 ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );

    /* <overloaded>                                     */
    virtual mdarray_double &fill_via_udf( double value,
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_double *,void *),
	void *user_ptr,
	ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
	ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
    ...
    /* add a scalar value to element values in a section */
    /* (overridden)                                      */
    mdarray_double &add( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* subtract a scalar value from element values in a section */
    /* (overridden)                                             */
    mdarray_double &subtract( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* multiply element values in a section by a scalar value */
    /* (overridden)                                           */
    mdarray_double &multiply( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* divide element values in a section by a scalar value */
    /* (overridden)                                         */
    mdarray_double &divide( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* paste up an array object */
    /* (overridden)             */
    mdarray_double &paste( const mdarray &src,
	ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* <overloaded>             */
    virtual mdarray_double &paste_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t,ssize_t,ssize_t,ssize_t,mdarray_double *,void *),
	void *user_ptr,
	ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );
    ...
    /* add an array object */
    /* (overridden)        */
    mdarray_double &add( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* subtract an array object */
    /* (overridden)             */
    mdarray_double &subtract( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* multiply an array object */
    /* (overridden)             */
    mdarray_double &multiply( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* divide an array object */
    /* (overridden)           */
    mdarray_double &divide( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );
    ...
    */
    ...
    /* <overloaded>                                                    */
    virtual mdarray_double &register_extptr( double **extptr_address );
    virtual mdarray_double &register_extptr_2d( double *const **extptr2d_address );
    virtual mdarray_double &register_extptr_3d( double *const *const **extptr3d_address );

    /* Acquire the specified element's address */
    virtual const double *carray() const;
    virtual const double *carray( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
    virtual double *array_ptr();
    virtual double *array_ptr( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF );
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const double *array_ptr() const;
    virtual const double *array_ptr( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
#endif
    virtual const double *array_ptr_cs() const;
    virtual const double *array_ptr_cs( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
    ...
    virtual double *const *array_ptr_2d( bool use );
    /* followings have no overhead. Execute .array_ptr_2d(true) before use. */
    virtual double *const *array_ptr_2d();
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const double *const *array_ptr_2d() const;
#endif
    virtual const double *const *array_ptr_2d_cs() const;
    ...
    /*        "use=false" when there is no requirement of referring         */
    /*        obtained address table.                                       */
    virtual double *const *const *array_ptr_3d( bool use );
    /* followings have no overhead. Execute .array_ptr_3d(true) before use. */
    virtual double *const *const *array_ptr_3d();
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const double *const *const *array_ptr_3d() const;
#endif
    virtual const double *const *const *array_ptr_3d_cs() const;
    ...
    */
    ...
    /* (overridden)                    */
    mdarray_double &reverse_endian( bool is_little_endian );
    /* (overridden)                    */
    mdarray_double &reverse_endian( bool is_little_endian, 
				    size_t begin, size_t length );

    /* acquisition of the initial value */
    virtual double default_value() const;
 ...
 *
 */
inline mdarray_double &mdarray_double::put( double value, ssize_t idx, size_t len )
{
 ...
 *
 */
inline mdarray_double &mdarray_double::put( double value,
				    size_t dim_index, ssize_t idx, size_t len )
{
 ...
 */
inline mdarray_double &mdarray_double::assign( dcomplex value,
 ...
 *
 */
inline mdarray_double &mdarray_double::assign( double value, 
				     ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
    this->mdarray::assign(value, idx0, idx1, idx2);
    return *this;
 ...
 *
 */
inline double &mdarray_double::operator[]( ssize_t idx0 )
{
    return ((0 <= idx0 && idx0 < (ssize_t)this->length()) ? 
	    ((double *)(this->data_ptr()))[idx0] :
	    this->at(idx0));
}
 ...
 *
 */
inline const double &mdarray_double::operator[]( ssize_t idx0 ) const
{
    return ((0 <= idx0 && idx0 < (ssize_t)this->length()) ? 
	    ((const double *)(this->data_ptr_cs()))[idx0] :
	    this->at_cs(idx0));
}
 ...
 *
 */
inline double &mdarray_double::operator()( ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
 ...
 *
 */
inline const double &mdarray_double::operator()( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
 ...
 *
 */
inline double &mdarray_double::at( ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
    ssize_t idx = this->get_idx_3d(idx0,idx1,idx2);
    if ( 0 <= idx ) {
	return ((double *)(this->data_ptr()))[idx];
    }
    else {
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const double &mdarray_double::at( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
    return this->at_cs(idx0, idx1, idx2);
}
#endif
 ...
 *
 */
inline const double &mdarray_double::at_cs( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
    ssize_t idx = this->get_idx_3d_cs(idx0,idx1,idx2);
    if ( 0 <= idx ) {
	return ((const double *)(this->data_ptr()))[idx];
    }
    else {
	double *p = (double *)(this->junk_rec);
	*p = NAN;
 ...
 *
 */
inline mdarray_double &mdarray_double::ceil()
{
    this->mdarray::ceil();
    return *this;
}
 ...
 *
 */
inline mdarray_double &mdarray_double::floor()
{
    this->mdarray::floor();
    return *this;
}
 ...
 *
 */
inline mdarray_double &mdarray_double::round()
{
    this->mdarray::round();
    return *this;
}
 ...
 *
 */
inline mdarray_double &mdarray_double::trunc()
{
    this->mdarray::trunc();
    return *this;
}
 ...
 *
 */
inline mdarray_double &mdarray_double::abs()
{
    this->mdarray::abs();
    return *this;
}
 ...
 *
 */
inline const double *mdarray_double::carray() const
{
    return (const double *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const double *mdarray_double::carray( ssize_t idx0, 
				     ssize_t idx1, ssize_t idx2 ) const
{
    return (const double *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *
 */
inline double *mdarray_double::array_ptr()
{
 ...
 *
 */
inline double *mdarray_double::array_ptr( ssize_t idx0, 
				  ssize_t idx1, ssize_t idx2 )
{
    return (double *)(this->data_ptr(idx0,idx1,idx2));
}
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const double *mdarray_double::array_ptr() const
{
    return (const double *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const double *mdarray_double::array_ptr( ssize_t idx0, 
					   ssize_t idx1, ssize_t idx2 ) const
{
    return (const double *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *
 */
inline const double *mdarray_double::array_ptr_cs() const
{
    return (const double *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const double *mdarray_double::array_ptr_cs( ssize_t idx0, 
					   ssize_t idx1, ssize_t idx2 ) const
{
    return (const double *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *             使用しない場合はfalse(機能off)．
 */
inline double *const *mdarray_double::array_ptr_2d( bool use )
{
    return (double *const *)(this->mdarray::data_ptr_2d(use));
}

/**
 * @brief  内部で生成された2次元配列用ポインタ配列のアドレスを取得
 */
inline double *const *mdarray_double::array_ptr_2d()
{
    return (double *const *)(this->mdarray::data_ptr_2d());
}
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const double *const *mdarray_double::array_ptr_2d() const
{
    return (const double *const *)(this->mdarray::data_ptr_2d_cs());
}
#endif
 ...
 * @brief  内部で生成された2次元配列用ポインタ配列のアドレスを取得 (読取専用)
 */
inline const double *const *mdarray_double::array_ptr_2d_cs() const
{
    return (const double *const *)(this->mdarray::data_ptr_2d_cs());
}
 ...
 *             使用しない場合はfalse(機能off)．
 */
inline double *const *const *mdarray_double::array_ptr_3d( bool use )
{
    return (double *const *const *)(this->mdarray::data_ptr_3d(use));
}

/**
 * @brief  内部で生成された3次元配列用ポインタ配列のアドレスを取得
 */
inline double *const *const *mdarray_double::array_ptr_3d()
{
    return (double *const *const *)(this->mdarray::data_ptr_3d());
}
 ...
 */
inline const double *const *const *mdarray_double::array_ptr_3d() const
{
    return (const double *const *const *)(this->mdarray::data_ptr_3d_cs());
}
#endif
 ...
 * @brief  内部で生成された3次元配列用ポインタ配列のアドレスを取得 (読取専用)
 */
inline const double *const *const *mdarray_double::array_ptr_3d_cs() const
{
    return (const double *const *const *)(this->mdarray::data_ptr_3d_cs());
}
 ...
 *
 */
inline double mdarray_double::default_value() const
{
    const double *p = (const double *)(this->default_value_ptr());
    if ( p == NULL ) return 0;
    else return *p;
}
