...
/**
 * @file   mdarray_int16.cc
 * @brief  int16_t型の多次元配列を扱う mdarray_int16 クラスのコード
 */

#define CLASS_NAME "mdarray_int16"
 ...
 */
mdarray_int16::mdarray_int16()
{
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)INT16_ZT, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int16::mdarray_int16( bool auto_r )
{
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)INT16_ZT, auto_r);
    return;
}
 ...
 *             ます．
 */
mdarray_int16::mdarray_int16( bool auto_r, int16_t **extptr_address )
{
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)INT16_ZT, auto_r);
 ...
 *             ます．
 */
mdarray_int16::mdarray_int16( bool auto_r, int16_t *const **extptr2d_address )
{
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)INT16_ZT, auto_r);
 ...
 *             ます．
 */
mdarray_int16::mdarray_int16( bool auto_r, int16_t *const *const **extptr3d_address )
{
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)INT16_ZT, auto_r);
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int16::mdarray_int16( bool auto_r, const size_t naxisx[], size_t ndim, bool init_buf )
{
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)INT16_ZT, auto_r, naxisx, ndim, init_buf);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
*/
mdarray_int16::mdarray_int16( bool auto_r, size_t naxis0 )
{
    const size_t naxisx[] = {naxis0};
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)INT16_ZT, auto_r, naxisx, 1, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int16::mdarray_int16( bool auto_r, size_t naxis0, size_t naxis1 )
{
    const size_t naxisx[] = {naxis0, naxis1};
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)INT16_ZT, auto_r, naxisx, 2, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int16::mdarray_int16( bool auto_r, size_t naxis0, size_t naxis1, size_t naxis2 )
{
    const size_t naxisx[] = {naxis0, naxis1, naxis2};
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)INT16_ZT, auto_r, naxisx, 3, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int16::mdarray_int16( bool auto_r, const char *dim_info,
			      int16_t v0, ... )
{
    va_list ap;
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int16::mdarray_int16( const mdarray_int16 &obj )
{
    this->class_level_rec ++;
 ...
 *
 */
mdarray_int16 &mdarray_int16::operator=(const mdarray &obj)
{
    debug_report("(const mdarray &obj)");
    if ( &obj == this ) return *this;

    if ( obj.size_type() == (ssize_t)INT16_ZT ) {
	this->mdarray::init(obj);
    }
    else {
 ...
 *
 */
mdarray_int16 &mdarray_int16::operator=(dcomplex v)
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::operator=(double v)
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::operator=(long long v)
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::operator=(long v)
{
    debug_report("(long v)");
 ...
 *
 */
mdarray_int16 &mdarray_int16::operator=(int v)
{
    debug_report("(int v)");
 ...
 *
 */
mdarray_int16 &mdarray_int16::init()
{
    debug_report("()");
    this->mdarray::init();
    return *this;
 ...
 *
 */
mdarray_int16 &mdarray_int16::init( bool auto_resize )
{
    this->mdarray::init();
 ...
 *
 */
mdarray_int16 &mdarray_int16::init( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf )
{
    this->mdarray::init((ssize_t)INT16_ZT, auto_resize, naxisx, ndim, init_buf);
    return *this;
}
 ...
 *
 */
mdarray_int16 &mdarray_int16::init( bool auto_resize, size_t naxis0 )
{
    const size_t naxisx[] = {naxis0};
    this->mdarray::init((ssize_t)INT16_ZT, auto_resize, naxisx, 1, true);
    return *this;
}
 ...
 *
 */
mdarray_int16 &mdarray_int16::init( bool auto_resize, size_t naxis0, size_t naxis1 )
{
    const size_t naxisx[] = {naxis0, naxis1};
    this->mdarray::init((ssize_t)INT16_ZT, auto_resize, naxisx, 2, true);
    return *this;
}
 ...
 *
 */
mdarray_int16 &mdarray_int16::init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 )
{
    const size_t naxisx[] = {naxis0, naxis1, naxis2};
    this->mdarray::init((ssize_t)INT16_ZT, auto_resize, naxisx, 3, true);
    return *this;
}
 ...
 *          3次元までしかサポートしていません.
 */
size_t mdarray_int16::parse_dim_info( const char *dim_info )
{
    size_t i;
    tarray_tstring arr0;
    this->dinfo_dlen[0] = 0;
...
{
    const size_t naxisx[] = {naxis0};
    this->mdarray::init((ssize_t)INT16_ZT, auto_resize, naxisx, 1, false);
...
{
    const size_t naxisx[] = {naxis0, naxis1};
    this->mdarray::init((ssize_t)INT16_ZT, auto_resize, naxisx, 2, false);
    this->mdarray::putdata((const void *)vals, this->byte_length());
    return *this;
}
...
{
    const size_t naxisx[] = {naxis0, naxis1, naxis2};
    this->mdarray::init((ssize_t)INT16_ZT, auto_resize, naxisx, 3, false);
    this->mdarray::putdata((const void *)vals, this->byte_length());
    return *this;
}
 ...
 * @throw   内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int16 &mdarray_int16::init( bool auto_resize, const char *dim_info, int16_t v0, ... )
{
    va_list ap;
    va_start(ap, v0);
    try {
 ...
 * @throw   内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int16 &mdarray_int16::vinit( bool auto_resize, const char *dim_info, int16_t v0, va_list ap )
{
    size_t ndim = this->parse_dim_info(dim_info);
    if ( ndim < 1 ) {
	this->mdarray::init((ssize_t)INT16_ZT, auto_resize);
    }
    else {
	size_t i;
	this->mdarray::init((ssize_t)INT16_ZT, auto_resize, this->dinfo_dlen, ndim, true);
	i = 0;
	if ( i < this->length() ) this->i16(i) = v0;
	i++;
	for ( ; i < this->length() ; i++ ) {
	    this->i16(i) = va_arg(ap,int16_t);
	}
    }
    return *this;
}
 ...
 *
 */
mdarray_int16 &mdarray_int16::init( const mdarray &obj )
{
    debug_report("( const mdarray &obj )");
 ...
 *            
 */
mdarray_int16 &mdarray_int16::init_properties( const mdarray &src_obj )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::set_auto_resize( bool tf )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::set_auto_init( bool tf )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::set_rounding( bool tf )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::set_alloc_strategy( const char *strategy )
{
...
{
    mdarray_int16 *this_p = (mdarray_int16 *)p;
    int16_t v0 = *((const int16_t *)v0p);
    *((int16_t *)v1p) = (*(this_p->convert_func_rec))(v0, this_p->convert_user_ptr_rec);
}
*/

/*
mdarray_int16 &mdarray_int16::convert( int16_t (*func)(int16_t,void *),
				       void *user_ptr )
{
    this->convert_func_rec = func;
    this->convert_user_ptr_rec = user_ptr;
    this->mdarray::convert((ssize_t)INT16_ZT, &fnc_for_convert, (void *)this);
    return *this;
}
*/
 ...
 * @throw      内部バッファの確保に失敗した場合
 */
mdarray_int16 &mdarray_int16::convert_via_udf( void (*func)(const int16_t *,int16_t *,size_t,int,void *),
				       void *user_ptr )
{
    this->mdarray::convert_via_udf((ssize_t)INT16_ZT,
 ...
 */
mdarray_int16 &mdarray_int16::swap( mdarray &sobj )
{
 ...
 *  dest には，mdarray_int16 クラスのオブジェクトあるいは mdarray クラスの
 ...
 *
 */
ssize_t mdarray_int16::copy( mdarray *dest ) const
{
 ...
 * @deprecated 非推奨．<br>
 * ssize_t mdarray_int16::copy( mdarray *dest ) const <br>
 * をお使いください．
 */
ssize_t mdarray_int16::copy( mdarray &dest ) const
{
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int16 &mdarray_int16::cut( mdarray *dest )
{
    debug_report("( mdarray *dest )");
 ...
 */
mdarray_int16 &mdarray_int16::transpose_xy()
{
 ...
 * @note  高速なアルゴリズムを使用しています．
 */
mdarray_int16 &mdarray_int16::transpose_xyz2zxy()
{
 ...
 * 
 */
mdarray_int16 &mdarray_int16::rotate_xy( int angle )
{
 ...
 *
 */
ssize_t mdarray_int16::get_elements( int16_t *dest_buf, size_t elem_size, 
 ...
 *
 */
ssize_t mdarray_int16::put_elements( const int16_t *src_buf, size_t elem_size,
 ...
 *
 */
mdarray_int16 &mdarray_int16::increase_dim()
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::decrease_dim()
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::resize( size_t len )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::resize( size_t dim_index, size_t len )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::resize( const mdarray &src )
{
 ...
 */
mdarray_int16 &mdarray_int16::resize_1d( size_t x_len )
{
 ...
 */
mdarray_int16 &mdarray_int16::resize_2d( size_t x_len, size_t y_len )
{
 ...
 *  します．
 */
mdarray_int16 &mdarray_int16::resize_3d( size_t x_len, size_t y_len, size_t z_len )
{
 ...
 */
mdarray_int16 &mdarray_int16::resize( const size_t naxisx[], size_t ndim, bool init_buf )
{
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_int16 &mdarray_int16::resizef( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_int16 &mdarray_int16::vresizef( const char *exp_fmt, va_list ap )
{
    this->mdarray::vresizef(exp_fmt,ap);
    return *this;
}
 ...
 *
 */
mdarray_int16 &mdarray_int16::resizeby( ssize_t len )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::resizeby( size_t dim_index, ssize_t len )
{
 ...
 */
mdarray_int16 &mdarray_int16::resizeby_1d( ssize_t x_len )
{
 ...
 */
mdarray_int16 &mdarray_int16::resizeby_2d( ssize_t x_len, ssize_t y_len )
{
 ...
 */
mdarray_int16 &mdarray_int16::resizeby_3d(ssize_t x_len, ssize_t y_len, ssize_t z_len)
{
 ...
 * @throw     内部バッファの確保に失敗した場合
 */
mdarray_int16 &mdarray_int16::resizeby( const ssize_t naxisx_rel[], size_t ndim, 
			    bool init_buf )
{
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_int16 &mdarray_int16::resizebyf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_int16 &mdarray_int16::vresizebyf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vresizebyf(exp_fmt,ap);
    return *this;
}
 ...
 * @throw     内部バッファの確保に失敗した場合
 */
mdarray_int16 &mdarray_int16::reallocate( const size_t naxisx[], size_t ndim, bool init_buf )
{
 ...
 * @throw    内部バッファの確保に失敗した場合
 */
mdarray_int16 &mdarray_int16::allocate( const size_t naxisx[], size_t ndim, bool init_buf )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::assign_default( int16_t value )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::insert( ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::insert( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::erase( ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::erase( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::move( ssize_t idx_src, size_t len, ssize_t idx_dst,
			   bool clr )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::move( size_t dim_index, 
 ...
 *
 */
mdarray_int16 &mdarray_int16::cpy( ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::cpy( size_t dim_index, 
			  ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::swap( ssize_t idx_src, size_t len, ssize_t idx_dst )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::swap( size_t dim_index, 
		      ssize_t idx_src, size_t len, ssize_t idx_dst )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::crop( ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::crop( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 * @deprecated 未実装です.
 */
mdarray_int16 &mdarray_int16::cropf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @deprecated 未実装です.
 */
mdarray_int16 &mdarray_int16::vcropf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vcropf(exp_fmt,ap);
    return *this;
}
 ...
 * @return    自身の参照
 */
mdarray_int16 &mdarray_int16::flip( ssize_t idx, size_t len )
{
 ...
 * @return    自身の参照
 */
mdarray_int16 &mdarray_int16::flip( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
ssize_t mdarray_int16::copyf( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
ssize_t mdarray_int16::vcopyf( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 * @deprecated  未実装
 */
ssize_t mdarray_int16::convertf_copy( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @deprecated  未実装
 */
ssize_t mdarray_int16::vconvertf_copy( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int16 &mdarray_int16::trimf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int16 &mdarray_int16::vtrimf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vtrimf(exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int16 &mdarray_int16::flipf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  任意の次元(複数も可)で配列の並びを反転 (IDLの記法)
 */
mdarray_int16 &mdarray_int16::vflipf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vflipf(exp_fmt, ap);
    return *this;
}
 ...
 */
ssize_t mdarray_int16::transposef_xy_copy( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @brief  (x,y)のトランスポーズを行なった配列を取得 (IDLの記法)
 */
ssize_t mdarray_int16::vtransposef_xy_copy( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 */
ssize_t mdarray_int16::transposef_xyz2zxy_copy( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @brief  (x,y,z)→(z,x,y)のトランスポーズを行なった配列を取得 (IDLの記法)
 */
ssize_t mdarray_int16::vtransposef_xyz2zxy_copy( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 */
mdarray_int16 &mdarray_int16::cleanf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列をデフォルト値でパディング (IDLの記法)
 */
mdarray_int16 &mdarray_int16::vcleanf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vcleanf(exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int16 &mdarray_int16::fillf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を指定されたスカラー値で書き換え (IDLの記法)
 */
mdarray_int16 &mdarray_int16::vfillf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vfillf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int16 &mdarray_int16::fillf_via_udf( double value, 
 ...
 * @brief  自身の配列をスカラー値で書き換え (ユーザ関数経由・IDLの記法)
 */
mdarray_int16 &mdarray_int16::vfillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_int16 *,void *),
 ...
 */
mdarray_int16 &mdarray_int16::addf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたスカラー値で加算 (IDLの記法)
 */
mdarray_int16 &mdarray_int16::vaddf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vaddf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int16 &mdarray_int16::subtractf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を，指定されたスカラー値で減算 (IDLの記法)
 */
mdarray_int16 &mdarray_int16::vsubtractf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vsubtractf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int16 &mdarray_int16::multiplyf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたスカラー値を乗算 (IDLの記法)
 */
mdarray_int16 &mdarray_int16::vmultiplyf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vmultiplyf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int16 &mdarray_int16::dividef( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を，指定されたスカラー値で除算 (IDLの記法)
 */
mdarray_int16 &mdarray_int16::vdividef( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vdividef(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int16 &mdarray_int16::pastef( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に指定されたオブジェクトの配列を貼り付け (IDLの記法)
 */
mdarray_int16 &mdarray_int16::vpastef( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vpastef(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int16 &mdarray_int16::pastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_int16 *,void *),
	void *user_ptr,
        const char *exp_fmt, ... )
{
 ...
 * @brief  自身の配列に指定された配列を貼り付け (ユーザ関数経由・IDLの記法)
 */
mdarray_int16 &mdarray_int16::vpastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_int16 *,void *),
	void *user_ptr,
 ...
 */
mdarray_int16 &mdarray_int16::addf( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたオブジェクトの配列を加算 (IDLの記法)
 */
mdarray_int16 &mdarray_int16::vaddf( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vaddf(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int16 &mdarray_int16::subtractf( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief 自身の配列を，指定されたオブジェクトの配列で減算 (IDLの記法)
 */
mdarray_int16 &mdarray_int16::vsubtractf( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vsubtractf(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int16 &mdarray_int16::multiplyf( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたオブジェクトの配列を乗算 (IDLの記法)
 */
mdarray_int16 &mdarray_int16::vmultiplyf( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vmultiplyf(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int16 &mdarray_int16::dividef( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を，指定されたオブジェクトの配列で除算 (IDLの記法)
 */
mdarray_int16 &mdarray_int16::vdividef( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vdividef(src, exp_fmt, ap);
    return *this;
}
 ...
 *
 */
ssize_t mdarray_int16::copy( mdarray *dest,
 ...
 * @deprecated  未実装
 */
ssize_t mdarray_int16::convert_copy( mdarray *dest,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 */
mdarray_int16 &mdarray_int16::move_from(ssize_t col_idx, size_t col_len,
					  ssize_t row_idx, size_t row_len, 
 ...
 */
mdarray_int16 &mdarray_int16::move_to( 
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int16 &mdarray_int16::trim( ssize_t col_idx, size_t col_len,
				      ssize_t row_idx, size_t row_len, 
				      ssize_t layer_idx, size_t layer_len )
{
 ...
 * @return    自身の参照
 */
mdarray_int16 &mdarray_int16::flip_cols( ssize_t col_idx, size_t col_len,
					  ssize_t row_idx, size_t row_len, 
					  ssize_t layer_idx, size_t layer_len )
{
 ...
 * @return    自身の参照
 */
mdarray_int16 &mdarray_int16::flip_rows( ssize_t col_idx, size_t col_len,
					  ssize_t row_idx, size_t row_len, 
					  ssize_t layer_idx, size_t layer_len )
{
 ...
 */
ssize_t mdarray_int16::transpose_xy_copy( mdarray *dest,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 */
ssize_t mdarray_int16::transpose_xyz2zxy_copy( mdarray *dest,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 */
ssize_t mdarray_int16::rotate_xy_copy( mdarray *dest, int angle,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::clean( ssize_t col_index, size_t col_size,
 ...
 *
 */
mdarray_int16 &mdarray_int16::fill( double value, 
 ...
 *
 */
mdarray_int16 &mdarray_int16::fill_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_int16 *,void *),
	void *user_ptr,
	ssize_t col_index, size_t col_size,
	ssize_t row_index, size_t row_size,
 ...
 *
 */
mdarray_int16 &mdarray_int16::add( double value, 
		    ssize_t col_index, size_t col_size,
		    ssize_t row_index, size_t row_size,
		    ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::subtract( double value, 
				       ssize_t col_index, size_t col_size,
				       ssize_t row_index, size_t row_size,
				       ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::multiply( double value, 
		    ssize_t col_index, size_t col_size,
		    ssize_t row_index, size_t row_size,
		    ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::divide( double value, 
				       ssize_t col_index, size_t col_size,
				       ssize_t row_index, size_t row_size,
				       ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::paste( const mdarray &src,
	ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::paste_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t,ssize_t,ssize_t,ssize_t,mdarray_int16 *,void *),
	void *user_ptr,
	ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::add( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::subtract( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::multiply( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_int16 &mdarray_int16::divide( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *             ます．
 */
mdarray_int16 &mdarray_int16::register_extptr( int16_t **extptr_address )
{
    this->mdarray::register_extptr((void *)extptr_address);
    return *this;
}
 ...
 *             ます．
 */
mdarray_int16 &mdarray_int16::register_extptr_2d( int16_t *const **extptr2d_address )
{
    this->mdarray::register_extptr_2d((void *)extptr2d_address);
    return *this;
}
 ...
 *             ます．
 */
mdarray_int16 &mdarray_int16::register_extptr_3d( int16_t *const *const **extptr3d_address )
{
    this->mdarray::register_extptr_3d((void *)extptr3d_address);
    return *this;
}
 ...
 *
 */
mdarray_int16 &mdarray_int16::reverse_endian( bool is_little_endian )
{
 ...
 * 
 * @return  型種別 (固定値: int16_t)
 * @note    このメンバ関数はprotectedです．
 */
ssize_t mdarray_int16::default_size_type()
{
    return (ssize_t)INT16_ZT;
}
 ...
 * 
 * @param   sz_type 型種別
 * @return  受け入れ可能な型(int16_t)なら真
 * @note    このメンバ関数はprotectedです．
 */
bool mdarray_int16::is_acceptable_size_type( ssize_t sz_type )
{
    if ( sz_type == (ssize_t)INT16_ZT ) return true;
    else return false;
}
