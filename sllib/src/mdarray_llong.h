...
#ifndef _SLI__MDARRAY_LLONG_H
#define _SLI__MDARRAY_LLONG_H 1

/**
 * @file   mdarray_llong.h
 * @brief  long long型の多次元配列を扱う mdarray_llong クラスのヘッダファイル
 */
...
/*
 * sli::mdarray_llong is an inherited class of sli::mdarray, and is a 
...
/**
 * @class  sli::mdarray_llong
 * @brief  long long型の多次元配列を扱うためのクラス
 *
 *   mdarray_llongクラスは，long long型の多次元配列を IDL や Python のように
 ...
 * 
 * @note  mdarray_llongクラスは mdarray(基底クラス) を継承しています．<br>
 *        SIMD命令(SSE2)により，基本的な部分が高速化されています．
 * @author  Chisato YAMAUCHI
 * @date  2013-04-01 00:00:00
 */

  class mdarray_llong : public mdarray
  {

  public:
    /* constructor                                                           */
    /* The mdarray_llong class has two kinds of operating modes:            */
    ...
    mdarray_llong();
    mdarray_llong( bool auto_resize );
    mdarray_llong( bool auto_resize, long long **extptr_address );
    mdarray_llong( bool auto_resize, long long *const **extptr2d_address );
    mdarray_llong( bool auto_resize, long long *const *const **extptr3d_address );
    mdarray_llong( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf );
    mdarray_llong( bool auto_resize, size_t naxis0 );
    mdarray_llong( bool auto_resize, size_t naxis0, size_t naxis1 );
    mdarray_llong( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 );
    mdarray_llong( bool auto_resize, size_t naxis0, 
...
#if 0
    mdarray_llong( bool auto_resize, const char *dim_info, long long v0, ... );
#endif
    mdarray_llong( const mdarray_llong &obj );


    /* --------------------------------------------------------------------- */

    /* `virtual' がついてるものはオーバーライドではなくオーバーロード     */
    /*   mdarray_llong &operator=(const mdarray_llong &obj);            */
    /* が隠れて存在する事に注意 (演算子 = だけは，特別な規則があるらしい) */

    /* substitute an array (copy the attribute, too)                      */
    virtual mdarray_llong &operator=(const mdarray &obj);

    /* (overridden) */
    mdarray_llong &operator+=(const mdarray &obj);
    mdarray_llong &operator-=(const mdarray &obj);
    mdarray_llong &operator*=(const mdarray &obj);
    mdarray_llong &operator/=(const mdarray &obj);

    /* (overridden) */
    mdarray_llong &operator=(dcomplex v);
    mdarray_llong &operator=(double v);
    mdarray_llong &operator=(long long v);
    mdarray_llong &operator=(long v);
    mdarray_llong &operator=(int v);
    mdarray_llong &operator+=(dcomplex v);
    mdarray_llong &operator+=(double v);
    mdarray_llong &operator+=(long long v);
    mdarray_llong &operator+=(long v);
    ...
    */
    ...
    /* <overloaded>                */
    virtual mdarray_llong &init( bool auto_resize );
    virtual mdarray_llong &init( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf );
    virtual mdarray_llong &init( bool auto_resize, size_t naxis0 );
    virtual mdarray_llong &init( bool auto_resize, size_t naxis0, size_t naxis1 );
    virtual mdarray_llong &init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 );
    virtual mdarray_llong &init( bool auto_resize, size_t naxis0, 
				 const long long vals[] );
    virtual mdarray_llong &init( bool auto_resize, size_t naxis0, size_t naxis1,
				 const long long vals[] );
    ...
    virtual mdarray_llong &init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2,
				 const long long *const *const vals[] );
#if 0
    virtual mdarray_llong &init( bool auto_resize, const char *dim_info,
				 long long v0, ... );
    virtual mdarray_llong &vinit( bool auto_resize, const char *dim_info,
				  long long v0, va_list );
#endif
    /*  mdarray_llong &init( const mdarray &obj ); が隠れている */
    /*  (↑mdarrayクラスのポインタ経由で呼び出し可能)            */

    /* (overridden)                                           */
    mdarray_llong &init( const mdarray &obj );

    /* copy properties (auto_resize, auto_init, and rounding) */
    /* (overridden)                                           */
    mdarray_llong &init_properties( const mdarray &src_obj );

    /* setting of the resize mode */
    /* (overridden)               */
    mdarray_llong &set_auto_resize( bool tf );

    /* setting of the initialize mode */
    /* (overridden)                   */
    mdarray_llong &set_auto_init( bool tf );

    /* setting of the rounding off possibility */
    /* (overridden)                            */
    mdarray_llong &set_rounding( bool tf );

    /* setting of strategy of memory allocation */
    /* "auto", "min" and "pow" can be set.      */
    /* (overridden)                             */
    mdarray_llong &set_alloc_strategy( const char *strategy );

    /* convert the value of the full array element */
    /* <overloaded>                                */
    virtual mdarray_llong &convert_via_udf(
		void (*func)(const long long *,long long *,size_t,int,void *),
		void *user_ptr );

    /* swap contents between self and another objects */
    /* (overridden)                 */
    mdarray_llong &swap( mdarray &sobj );
    ...
    /* (overridden)                             */
    mdarray_llong &cut( mdarray *dest );

    /* interchange rows and columns */
    /* (overridden)                 */
    mdarray_llong &transpose_xy();

    /* interchange xyz to zxy */
    /* (overridden)           */
    mdarray_llong &transpose_xyz2zxy();

    /* rotate image                                              */
    /*   angle: 90,-90, or 180                                   */
    /*          (anticlockwise when image is bottom-left origin) */
    /* (overridden)                                              */
    mdarray_llong &rotate_xy( int angle );
    ...
    */
    ...
    /* (overridden)                                          */
    mdarray_llong &assign( dcomplex value,
			    ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF,
			    ssize_t idx2 = MDARRAY_INDEF );
    mdarray_llong &assign( double value, 
			    ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF,
			    ssize_t idx2 = MDARRAY_INDEF );

    /* a reference to the specified value of the element (1 dimension) */
    virtual long long &operator[]( ssize_t idx0 );
    virtual const long long &operator[]( ssize_t idx0 ) const;

    /* a reference to the specified value of the element (1-3 dimensions) */
    virtual long long &operator()( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				ssize_t idx2 = MDARRAY_INDEF);
    virtual const long long &operator()( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				ssize_t idx2 = MDARRAY_INDEF) const;

    /* a reference to the specified value of the element (1-3 dimensions) */
    virtual long long &at( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
			  ssize_t idx2 = MDARRAY_INDEF);
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const long long &at( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				 ssize_t idx2 = MDARRAY_INDEF) const;
#endif
    virtual const long long &at_cs( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				 ssize_t idx2 = MDARRAY_INDEF) const;
    ...
    /* <overloaded>                                */
    virtual mdarray_llong &put( long long value, ssize_t idx, size_t len );
    virtual mdarray_llong &put( long long value,
				size_t dim_index, ssize_t idx, size_t len );

    /* copy the array stored in object into the programmer's buffer. */
    /* <overloaded>                                                  */
    virtual ssize_t get_elements( long long *dest_buf, size_t elem_size, 
				ssize_t idx0 = 0, ssize_t idx1 = MDARRAY_INDEF,
				ssize_t idx2 = MDARRAY_INDEF ) const;

    /* copy the array in the programmer's buffer into object's buffer. */
    /* <overloaded>                                                    */
    virtual ssize_t put_elements( const long long *src_buf, size_t elem_size,
				ssize_t idx0 = 0, ssize_t idx1 = MDARRAY_INDEF,
				ssize_t idx2 = MDARRAY_INDEF );
    ...
    /* (overridden)                      */
    mdarray_llong &increase_dim();

    /* reduction of the dimension number */
    /* (overridden)                      */
    mdarray_llong &decrease_dim();

    /* change the length of the array */
    /* (overridden)                   */
    mdarray_llong &resize( size_t len );
    mdarray_llong &resize( size_t dim_index, size_t len );
    mdarray_llong &resize( const mdarray &src );

    /* change the length of the 1-d array */
    /* (overridden)                       */
    mdarray_llong &resize_1d( size_t x_len );

    /* change the length of the 2-d array */
    /* (overridden)                       */
    mdarray_llong &resize_2d( size_t x_len, size_t y_len );

    /* change the length of the 3-d array */
    /* (overridden)                       */
    mdarray_llong &resize_3d( size_t x_len, size_t y_len, size_t z_len );

    /* change the length of the array (supports n-dim) */
    /* (overridden)                                    */
    mdarray_llong &resize( const size_t naxisx[], size_t ndim, 
			    bool init_buf );
    ...
    /* (overridden)                                                   */
    mdarray_llong &resizef( const char *exp_fmt, ... );
    mdarray_llong &vresizef( const char *exp_fmt, va_list ap );

    /* change the length of the array relatively */
    /* (overridden)                              */
    mdarray_llong &resizeby( ssize_t len );			/* for 1-d */
    mdarray_llong &resizeby( size_t dim_index, ssize_t len );

    /* change the length of the 1-d array relatively */
    /* (overridden)                                  */
    mdarray_llong &resizeby_1d( ssize_t x_len );

    /* change the length of the 2-d array relatively */
    /* (overridden)                                  */
    mdarray_llong &resizeby_2d( ssize_t x_len, ssize_t y_len );

    /* change the length of the 3-d array relatively */
    /* (overridden)                                  */
    mdarray_llong &resizeby_3d(ssize_t x_len, ssize_t y_len, ssize_t z_len);
    ...
    /* (overridden)                                                         */
    mdarray_llong &resizeby( const ssize_t naxisx_rel[], size_t ndim, 
			       bool init_buf );
    ...
    /* length of first dimension.                                      */
    /* (overridden)                                                    */
    mdarray_llong &resizebyf( const char *exp_fmt, ... );
    mdarray_llong &vresizebyf( const char *exp_fmt, va_list ap );

    /* change length of array without adjusting buffer contents */
    /* (overridden)                                             */
    mdarray_llong &reallocate( const size_t naxisx[], size_t ndim, 
				bool init_buf );

    /* free current buffer and alloc new memory */
    /* (overridden)                             */
    mdarray_llong &allocate( const size_t naxisx[], size_t ndim, 
			      bool init_buf );

    /* setting of the initial value for .resize(), etc. */
    /* <overloaded>                                     */
    virtual mdarray_llong &assign_default( long long value );

    /* insert a blank section */
    /* (overridden)           */
    mdarray_llong &insert( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_llong &insert( size_t dim_index, ssize_t idx, size_t len );

    /* erase a section */
    /* (overridden)    */
    mdarray_llong &erase( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_llong &erase( size_t dim_index, ssize_t idx, size_t len );

    /* copy values between elements (without automatic resizing) */
    /* 移動 (バッファのサイズは変更しない)                       */
    /* (overridden)                                              */
    mdarray_llong &move( ssize_t idx_src, size_t len, ssize_t idx_dst,
			   bool clr );				/* for 1-d */
    mdarray_llong &move( size_t dim_index, 
    ...
    /* (overridden)                                           */
    mdarray_llong &cpy( ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr );				/* for 1-d */
    mdarray_llong &cpy( size_t dim_index, 
			  ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr );

    /* replace values between elements */
    /* (overridden)                    */
    mdarray_llong &swap( ssize_t idx_src, size_t len, 
			  ssize_t idx_dst );			/* for 1-d */
    mdarray_llong &swap( size_t dim_index, 
			   ssize_t idx_src, size_t len, ssize_t idx_dst );

    /* extract a section           */
    /* see also trimf() and trim() */
    /* (overridden)                */
    mdarray_llong &crop( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_llong &crop( size_t dim_index, ssize_t idx, size_t len );

    /* flip a section   */
    /* see also flipf() */
    /* (overridden)     */
    mdarray_llong &flip( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_llong &flip( size_t dim_index, ssize_t idx, size_t len );
    ...
    */
    ...
    /* Flipping elements is supported */
    /* (overridden)                   */
    mdarray_llong &trimf( const char *exp_fmt, ... );
    mdarray_llong &vtrimf( const char *exp_fmt, va_list ap );

    /* flip elements in a section */
    /* (overridden)               */
    mdarray_llong &flipf( const char *exp_fmt, ... );
    mdarray_llong &vflipf( const char *exp_fmt, va_list ap );
    ...
    /* (overridden)                        */
    mdarray_llong &cleanf( const char *exp_fmt, ... );
    mdarray_llong &vcleanf( const char *exp_fmt, va_list ap );

    /* rewrite element values with a value in a section */
    /* (overridden)                                     */
    mdarray_llong &fillf( double value, const char *exp_fmt, ... );
    mdarray_llong &vfillf( double value, const char *exp_fmt, va_list ap );

    /* <overloaded>                                     */
    virtual mdarray_llong &fillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_llong *,void *),
        void *user_ptr, const char *exp_fmt, ... );
    virtual mdarray_llong &vfillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_llong *,void *),
        void *user_ptr, const char *exp_fmt, va_list ap );

    /* add a scalar value to element values in a section */
    /* (overridden)                                      */
    mdarray_llong &addf( double value, 
			  const char *exp_fmt, ... );
    mdarray_llong &vaddf( double value, 
			   const char *exp_fmt, va_list ap );

    /* subtract a scalar value from element values in a section */
    /* (overridden)                                             */
    mdarray_llong &subtractf( double value, 
			       const char *exp_fmt, ... );
    mdarray_llong &vsubtractf( double value, 
				const char *exp_fmt, va_list ap );

    /* multiply element values in a section by a scalar value */
    /* (overridden)                                           */
    mdarray_llong &multiplyf( double value, 
			       const char *exp_fmt, ... );
    mdarray_llong &vmultiplyf( double value, 
				const char *exp_fmt, va_list ap );

    /* divide element values in a section by a scalar value */
    /* (overridden)                                         */
    mdarray_llong &dividef( double value, 
			     const char *exp_fmt, ... );
    mdarray_llong &vdividef( double value, 
			      const char *exp_fmt, va_list ap );
    ...
    /* (overridden)                                                          */
    mdarray_llong &pastef( const mdarray &src,
			    const char *exp_fmt, ... );
    mdarray_llong &vpastef( const mdarray &src,
			     const char *exp_fmt, va_list ap );
    ...
    /*   8. user pointer                                                     */
    /* <overloaded>                                                          */
    virtual mdarray_llong &pastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_llong *,void *),
	void *user_ptr,
        const char *exp_fmt, ... );
    virtual mdarray_llong &vpastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_llong *,void *),
	void *user_ptr,
        const char *exp_fmt, va_list ap );
    ...
    /* add an array object */
    /* (overridden)        */
    mdarray_llong &addf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_llong &vaddf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* subtract an array object */
    /* (overridden)             */
    mdarray_llong &subtractf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_llong &vsubtractf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* multiply an array object */
    /* (overridden)             */
    mdarray_llong &multiplyf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_llong &vmultiplyf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* divide an array object */
    /* (overridden)           */
    mdarray_llong &dividef( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_llong &vdividef( const mdarray &src_img, const char *exp_fmt, va_list ap );
    ...
    */
    ...
    /* rewrite element values with a value in a section */
    /* (overridden)                                     */
    mdarray_llong &fill( double value,
			 ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
			 ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
			 ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );

    /* <overloaded>                                     */
    virtual mdarray_llong &fill_via_udf( double value,
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_llong *,void *),
	void *user_ptr,
	ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
	ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
    ...
    /* add a scalar value to element values in a section */
    /* (overridden)                                      */
    mdarray_llong &add( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* subtract a scalar value from element values in a section */
    /* (overridden)                                             */
    mdarray_llong &subtract( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* multiply element values in a section by a scalar value */
    /* (overridden)                                           */
    mdarray_llong &multiply( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* divide element values in a section by a scalar value */
    /* (overridden)                                         */
    mdarray_llong &divide( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* paste up an array object */
    /* (overridden)             */
    mdarray_llong &paste( const mdarray &src,
	ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* <overloaded>             */
    virtual mdarray_llong &paste_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t,ssize_t,ssize_t,ssize_t,mdarray_llong *,void *),
	void *user_ptr,
	ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );
    ...
    /* add an array object */
    /* (overridden)        */
    mdarray_llong &add( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* subtract an array object */
    /* (overridden)             */
    mdarray_llong &subtract( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* multiply an array object */
    /* (overridden)             */
    mdarray_llong &multiply( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* divide an array object */
    /* (overridden)           */
    mdarray_llong &divide( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );
    ...
    */
    ...
    /* <overloaded>                                                    */
    virtual mdarray_llong &register_extptr( long long **extptr_address );
    virtual mdarray_llong &register_extptr_2d( long long *const **extptr2d_address );
    virtual mdarray_llong &register_extptr_3d( long long *const *const **extptr3d_address );

    /* Acquire the specified element's address */
    virtual const long long *carray() const;
    virtual const long long *carray( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
    virtual long long *array_ptr();
    virtual long long *array_ptr( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF );
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const long long *array_ptr() const;
    virtual const long long *array_ptr( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
#endif
    virtual const long long *array_ptr_cs() const;
    virtual const long long *array_ptr_cs( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
    ...
    virtual long long *const *array_ptr_2d( bool use );
    /* followings have no overhead. Execute .array_ptr_2d(true) before use. */
    virtual long long *const *array_ptr_2d();
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const long long *const *array_ptr_2d() const;
#endif
    virtual const long long *const *array_ptr_2d_cs() const;
    ...
    /*        "use=false" when there is no requirement of referring         */
    /*        obtained address table.                                       */
    virtual long long *const *const *array_ptr_3d( bool use );
    /* followings have no overhead. Execute .array_ptr_3d(true) before use. */
    virtual long long *const *const *array_ptr_3d();
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const long long *const *const *array_ptr_3d() const;
#endif
    virtual const long long *const *const *array_ptr_3d_cs() const;
    ...
    */
    ...
    /* (overridden)                    */
    mdarray_llong &reverse_endian( bool is_little_endian );
    /* (overridden)                    */
    mdarray_llong &reverse_endian( bool is_little_endian, 
				    size_t begin, size_t length );

    /* acquisition of the initial value */
    virtual long long default_value() const;
 ...
 *
 */
inline mdarray_llong &mdarray_llong::put( long long value, ssize_t idx, size_t len )
{
 ...
 *
 */
inline mdarray_llong &mdarray_llong::put( long long value,
				    size_t dim_index, ssize_t idx, size_t len )
{
 ...
 */
inline mdarray_llong &mdarray_llong::assign( dcomplex value,
 ...
 *
 */
inline mdarray_llong &mdarray_llong::assign( double value, 
				     ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
    this->mdarray::assign(value, idx0, idx1, idx2);
    return *this;
 ...
 *
 */
inline long long &mdarray_llong::operator[]( ssize_t idx0 )
{
    return ((0 <= idx0 && idx0 < (ssize_t)this->length()) ? 
	    ((long long *)(this->data_ptr()))[idx0] :
	    this->at(idx0));
}
 ...
 *
 */
inline const long long &mdarray_llong::operator[]( ssize_t idx0 ) const
{
    return ((0 <= idx0 && idx0 < (ssize_t)this->length()) ? 
	    ((const long long *)(this->data_ptr_cs()))[idx0] :
	    this->at_cs(idx0));
}
 ...
 *
 */
inline long long &mdarray_llong::operator()( ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
 ...
 *
 */
inline const long long &mdarray_llong::operator()( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
 ...
 *
 */
inline long long &mdarray_llong::at( ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
    ssize_t idx = this->get_idx_3d(idx0,idx1,idx2);
    if ( 0 <= idx ) {
	return ((long long *)(this->data_ptr()))[idx];
    }
    else {
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const long long &mdarray_llong::at( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
    return this->at_cs(idx0, idx1, idx2);
}
#endif
 ...
 *
 */
inline const long long &mdarray_llong::at_cs( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
    ssize_t idx = this->get_idx_3d_cs(idx0,idx1,idx2);
    if ( 0 <= idx ) {
	return ((const long long *)(this->data_ptr()))[idx];
    }
    else {
	long long *p = (long long *)(this->junk_rec);
	*p = INDEF_LLONG;
 ...
 *
 */
inline mdarray_llong &mdarray_llong::ceil()
{
    this->mdarray::ceil();
    return *this;
}
 ...
 *
 */
inline mdarray_llong &mdarray_llong::floor()
{
    this->mdarray::floor();
    return *this;
}
 ...
 *
 */
inline mdarray_llong &mdarray_llong::round()
{
    this->mdarray::round();
    return *this;
}
 ...
 *
 */
inline mdarray_llong &mdarray_llong::trunc()
{
    this->mdarray::trunc();
    return *this;
}
 ...
 *
 */
inline mdarray_llong &mdarray_llong::abs()
{
    this->mdarray::abs();
    return *this;
}
 ...
 *
 */
inline const long long *mdarray_llong::carray() const
{
    return (const long long *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const long long *mdarray_llong::carray( ssize_t idx0, 
				     ssize_t idx1, ssize_t idx2 ) const
{
    return (const long long *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *
 */
inline long long *mdarray_llong::array_ptr()
{
    return (long long *)(this->data_ptr());
}
 ...
 *
 */
inline long long *mdarray_llong::array_ptr( ssize_t idx0, 
				  ssize_t idx1, ssize_t idx2 )
{
    return (long long *)(this->data_ptr(idx0,idx1,idx2));
}
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const long long *mdarray_llong::array_ptr() const
{
    return (const long long *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const long long *mdarray_llong::array_ptr( ssize_t idx0, 
					   ssize_t idx1, ssize_t idx2 ) const
{
    return (const long long *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *
 */
inline const long long *mdarray_llong::array_ptr_cs() const
{
    return (const long long *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const long long *mdarray_llong::array_ptr_cs( ssize_t idx0, 
					   ssize_t idx1, ssize_t idx2 ) const
{
    return (const long long *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *             使用しない場合はfalse(機能off)．
 */
inline long long *const *mdarray_llong::array_ptr_2d( bool use )
{
    return (long long *const *)(this->mdarray::data_ptr_2d(use));
}

/**
 * @brief  内部で生成された2次元配列用ポインタ配列のアドレスを取得
 */
inline long long *const *mdarray_llong::array_ptr_2d()
{
    return (long long *const *)(this->mdarray::data_ptr_2d());
}
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const long long *const *mdarray_llong::array_ptr_2d() const
{
    return (const long long *const *)(this->mdarray::data_ptr_2d_cs());
}
#endif
 ...
 * @brief  内部で生成された2次元配列用ポインタ配列のアドレスを取得 (読取専用)
 */
inline const long long *const *mdarray_llong::array_ptr_2d_cs() const
{
    return (const long long *const *)(this->mdarray::data_ptr_2d_cs());
}
 ...
 *             使用しない場合はfalse(機能off)．
 */
inline long long *const *const *mdarray_llong::array_ptr_3d( bool use )
{
    return (long long *const *const *)(this->mdarray::data_ptr_3d(use));
}

/**
 * @brief  内部で生成された3次元配列用ポインタ配列のアドレスを取得
 */
inline long long *const *const *mdarray_llong::array_ptr_3d()
{
    return (long long *const *const *)(this->mdarray::data_ptr_3d());
}
 ...
 */
inline const long long *const *const *mdarray_llong::array_ptr_3d() const
{
    return (const long long *const *const *)(this->mdarray::data_ptr_3d_cs());
}
#endif
 ...
 * @brief  内部で生成された3次元配列用ポインタ配列のアドレスを取得 (読取専用)
 */
inline const long long *const *const *mdarray_llong::array_ptr_3d_cs() const
{
    return (const long long *const *const *)(this->mdarray::data_ptr_3d_cs());
}
 ...
 *
 */
inline long long mdarray_llong::default_value() const
{
    const long long *p = (const long long *)(this->default_value_ptr());
    if ( p == NULL ) return 0;
    else return *p;
}
