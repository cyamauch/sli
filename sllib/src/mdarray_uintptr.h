...
#ifndef _SLI__MDARRAY_UINTPTR_H
#define _SLI__MDARRAY_UINTPTR_H 1

/**
 * @file   mdarray_uintptr.h
 * @brief  uintptr_t型の多次元配列を扱う mdarray_uintptr クラスのヘッダファイル
 */
...
/*
 * sli::mdarray_uintptr is an inherited class of sli::mdarray, and is a 
...
/**
 * @class  sli::mdarray_uintptr
 * @brief  uintptr_t型の多次元配列を扱うためのクラス
 *
 *   mdarray_uintptrクラスは，uintptr_t型の多次元配列を IDL や Python のように
 ...
 * 
 * @note  mdarray_uintptrクラスは mdarray(基底クラス) を継承しています．<br>
 *        SIMD命令(SSE2)により，基本的な部分が高速化されています．
 * @author  Chisato YAMAUCHI
 * @date  2013-04-01 00:00:00
 */

  class mdarray_uintptr : public mdarray
  {

  public:
    /* constructor                                                           */
    /* The mdarray_uintptr class has two kinds of operating modes:            */
    ...
    mdarray_uintptr();
    mdarray_uintptr( bool auto_resize );
    mdarray_uintptr( bool auto_resize, uintptr_t **extptr_address );
    mdarray_uintptr( bool auto_resize, uintptr_t *const **extptr2d_address );
    mdarray_uintptr( bool auto_resize, uintptr_t *const *const **extptr3d_address );
    mdarray_uintptr( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf );
    mdarray_uintptr( bool auto_resize, size_t naxis0 );
    mdarray_uintptr( bool auto_resize, size_t naxis0, size_t naxis1 );
    mdarray_uintptr( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 );
    mdarray_uintptr( bool auto_resize, size_t naxis0, 
...
#if 0
    mdarray_uintptr( bool auto_resize, const char *dim_info, uintptr_t v0, ... );
#endif
    mdarray_uintptr( const mdarray_uintptr &obj );


    /* --------------------------------------------------------------------- */

    /* `virtual' がついてるものはオーバーライドではなくオーバーロード     */
    /*   mdarray_uintptr &operator=(const mdarray_uintptr &obj);            */
    /* が隠れて存在する事に注意 (演算子 = だけは，特別な規則があるらしい) */

    /* substitute an array (copy the attribute, too)                      */
    virtual mdarray_uintptr &operator=(const mdarray &obj);

    /* (overridden) */
    mdarray_uintptr &operator+=(const mdarray &obj);
    mdarray_uintptr &operator-=(const mdarray &obj);
    mdarray_uintptr &operator*=(const mdarray &obj);
    mdarray_uintptr &operator/=(const mdarray &obj);

    /* (overridden) */
    mdarray_uintptr &operator=(dcomplex v);
    mdarray_uintptr &operator=(double v);
    mdarray_uintptr &operator=(long long v);
    mdarray_uintptr &operator=(long v);
    mdarray_uintptr &operator=(int v);
    mdarray_uintptr &operator+=(dcomplex v);
    mdarray_uintptr &operator+=(double v);
    mdarray_uintptr &operator+=(long long v);
    mdarray_uintptr &operator+=(long v);
    ...
    */
    ...
    /* (overridden)                */
    mdarray_uintptr &init();

    /* <overloaded>                */
    virtual mdarray_uintptr &init( bool auto_resize );
    virtual mdarray_uintptr &init( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf );
    virtual mdarray_uintptr &init( bool auto_resize, size_t naxis0 );
    virtual mdarray_uintptr &init( bool auto_resize, size_t naxis0, size_t naxis1 );
    virtual mdarray_uintptr &init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 );
    virtual mdarray_uintptr &init( bool auto_resize, size_t naxis0, 
				 const uintptr_t vals[] );
    virtual mdarray_uintptr &init( bool auto_resize, size_t naxis0, size_t naxis1,
				 const uintptr_t vals[] );
    ...
    virtual mdarray_uintptr &init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2,
				 const uintptr_t *const *const vals[] );
#if 0
    virtual mdarray_uintptr &init( bool auto_resize, const char *dim_info,
				 uintptr_t v0, ... );
    virtual mdarray_uintptr &vinit( bool auto_resize, const char *dim_info,
				  uintptr_t v0, va_list );
#endif
    /*  mdarray_uintptr &init( const mdarray &obj ); が隠れている */
    /*  (↑mdarrayクラスのポインタ経由で呼び出し可能)            */

    /* (overridden)                                           */
    mdarray_uintptr &init( const mdarray &obj );

    /* copy properties (auto_resize, auto_init, and rounding) */
    /* (overridden)                                           */
    mdarray_uintptr &init_properties( const mdarray &src_obj );

    /* setting of the resize mode */
    /* (overridden)               */
    mdarray_uintptr &set_auto_resize( bool tf );

    /* setting of the initialize mode */
    /* (overridden)                   */
    mdarray_uintptr &set_auto_init( bool tf );

    /* setting of the rounding off possibility */
    /* (overridden)                            */
    mdarray_uintptr &set_rounding( bool tf );

    /* setting of strategy of memory allocation */
    /* "auto", "min" and "pow" can be set.      */
    /* (overridden)                             */
    mdarray_uintptr &set_alloc_strategy( const char *strategy );

    /* convert the value of the full array element */
    /* <overloaded>                                */
    virtual mdarray_uintptr &convert_via_udf(
		void (*func)(const uintptr_t *,uintptr_t *,size_t,int,void *),
		void *user_ptr );

    /* swap contents between self and another objects */
    /* (overridden)                 */
    mdarray_uintptr &swap( mdarray &sobj );
    ...
    /* (overridden)                             */
    mdarray_uintptr &cut( mdarray *dest );

    /* interchange rows and columns */
    /* (overridden)                 */
    mdarray_uintptr &transpose_xy();

    /* interchange xyz to zxy */
    /* (overridden)           */
    mdarray_uintptr &transpose_xyz2zxy();

    /* rotate image                                              */
    /*   angle: 90,-90, or 180                                   */
    /*          (anticlockwise when image is bottom-left origin) */
    /* (overridden)                                              */
    mdarray_uintptr &rotate_xy( int angle );
    ...
    */
    ...
    /* (overridden)                                          */
    mdarray_uintptr &assign( dcomplex value,
			    ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF,
			    ssize_t idx2 = MDARRAY_INDEF );
    mdarray_uintptr &assign( double value, 
			    ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF,
			    ssize_t idx2 = MDARRAY_INDEF );

    /* a reference to the specified value of the element (1 dimension) */
    virtual uintptr_t &operator[]( ssize_t idx0 );
    virtual const uintptr_t &operator[]( ssize_t idx0 ) const;

    /* a reference to the specified value of the element (1-3 dimensions) */
    virtual uintptr_t &operator()( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				ssize_t idx2 = MDARRAY_INDEF);
    virtual const uintptr_t &operator()( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				ssize_t idx2 = MDARRAY_INDEF) const;

    /* a reference to the specified value of the element (1-3 dimensions) */
    virtual uintptr_t &at( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
			  ssize_t idx2 = MDARRAY_INDEF);
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const uintptr_t &at( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				 ssize_t idx2 = MDARRAY_INDEF) const;
#endif
    virtual const uintptr_t &at_cs( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				 ssize_t idx2 = MDARRAY_INDEF) const;
    ...
    /* <overloaded>                                */
    virtual mdarray_uintptr &put( uintptr_t value, ssize_t idx, size_t len );
    virtual mdarray_uintptr &put( uintptr_t value,
				size_t dim_index, ssize_t idx, size_t len );

    /* copy the array stored in object into the programmer's buffer. */
    /* <overloaded>                                                  */
    virtual ssize_t get_elements( uintptr_t *dest_buf, size_t elem_size, 
				ssize_t idx0 = 0, ssize_t idx1 = MDARRAY_INDEF,
				ssize_t idx2 = MDARRAY_INDEF ) const;

    /* copy the array in the programmer's buffer into object's buffer. */
    /* <overloaded>                                                    */
    virtual ssize_t put_elements( const uintptr_t *src_buf, size_t elem_size,
				ssize_t idx0 = 0, ssize_t idx1 = MDARRAY_INDEF,
				ssize_t idx2 = MDARRAY_INDEF );
    ...
    /* (overridden)                      */
    mdarray_uintptr &increase_dim();

    /* reduction of the dimension number */
    /* (overridden)                      */
    mdarray_uintptr &decrease_dim();

    /* change the length of the array */
    /* (overridden)                   */
    mdarray_uintptr &resize( size_t len );
    mdarray_uintptr &resize( size_t dim_index, size_t len );
    mdarray_uintptr &resize( const mdarray &src );

    /* change the length of the 1-d array */
    /* (overridden)                       */
    mdarray_uintptr &resize_1d( size_t x_len );

    /* change the length of the 2-d array */
    /* (overridden)                       */
    mdarray_uintptr &resize_2d( size_t x_len, size_t y_len );

    /* change the length of the 3-d array */
    /* (overridden)                       */
    mdarray_uintptr &resize_3d( size_t x_len, size_t y_len, size_t z_len );

    /* change the length of the array (supports n-dim) */
    /* (overridden)                                    */
    mdarray_uintptr &resize( const size_t naxisx[], size_t ndim, 
			    bool init_buf );
    ...
    /* (overridden)                                                   */
    mdarray_uintptr &resizef( const char *exp_fmt, ... );
    mdarray_uintptr &vresizef( const char *exp_fmt, va_list ap );

    /* change the length of the array relatively */
    /* (overridden)                              */
    mdarray_uintptr &resizeby( ssize_t len );			/* for 1-d */
    mdarray_uintptr &resizeby( size_t dim_index, ssize_t len );

    /* change the length of the 1-d array relatively */
    /* (overridden)                                  */
    mdarray_uintptr &resizeby_1d( ssize_t x_len );

    /* change the length of the 2-d array relatively */
    /* (overridden)                                  */
    mdarray_uintptr &resizeby_2d( ssize_t x_len, ssize_t y_len );

    /* change the length of the 3-d array relatively */
    /* (overridden)                                  */
    mdarray_uintptr &resizeby_3d(ssize_t x_len, ssize_t y_len, ssize_t z_len);
    ...
    /* (overridden)                                                         */
    mdarray_uintptr &resizeby( const ssize_t naxisx_rel[], size_t ndim, 
			       bool init_buf );
    ...
    /* length of first dimension.                                      */
    /* (overridden)                                                    */
    mdarray_uintptr &resizebyf( const char *exp_fmt, ... );
    mdarray_uintptr &vresizebyf( const char *exp_fmt, va_list ap );

    /* change length of array without adjusting buffer contents */
    /* (overridden)                                             */
    mdarray_uintptr &reallocate( const size_t naxisx[], size_t ndim, 
				bool init_buf );

    /* free current buffer and alloc new memory */
    /* (overridden)                             */
    mdarray_uintptr &allocate( const size_t naxisx[], size_t ndim, 
			      bool init_buf );

    /* setting of the initial value for .resize(), etc. */
    /* <overloaded>                                     */
    virtual mdarray_uintptr &assign_default( uintptr_t value );

    /* insert a blank section */
    /* (overridden)           */
    mdarray_uintptr &insert( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_uintptr &insert( size_t dim_index, ssize_t idx, size_t len );

    /* erase a section */
    /* (overridden)    */
    mdarray_uintptr &erase( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_uintptr &erase( size_t dim_index, ssize_t idx, size_t len );

    /* copy values between elements (without automatic resizing) */
    /* 移動 (バッファのサイズは変更しない)                       */
    /* (overridden)                                              */
    mdarray_uintptr &move( ssize_t idx_src, size_t len, ssize_t idx_dst,
			   bool clr );				/* for 1-d */
    mdarray_uintptr &move( size_t dim_index, 
    ...
    /* (overridden)                                           */
    mdarray_uintptr &cpy( ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr );				/* for 1-d */
    mdarray_uintptr &cpy( size_t dim_index, 
			  ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr );

    /* replace values between elements */
    /* (overridden)                    */
    mdarray_uintptr &swap( ssize_t idx_src, size_t len, 
			  ssize_t idx_dst );			/* for 1-d */
    mdarray_uintptr &swap( size_t dim_index, 
			   ssize_t idx_src, size_t len, ssize_t idx_dst );

    /* extract a section           */
    /* see also trimf() and trim() */
    /* (overridden)                */
    mdarray_uintptr &crop( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_uintptr &crop( size_t dim_index, ssize_t idx, size_t len );

    /* flip a section   */
    /* see also flipf() */
    /* (overridden)     */
    mdarray_uintptr &flip( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_uintptr &flip( size_t dim_index, ssize_t idx, size_t len );


    /* raise decimals to the next whole number in a float/double type value */
    /* (overridden)                                                         */
    mdarray_uintptr &ceil();

    /* devalue decimals in a float/double type value */
    /* (overridden)                                  */
    mdarray_uintptr &floor();

    /* round off decimals in a float/double type value */
    /* (overridden)                                    */
    mdarray_uintptr &round();

    /* omit decimals in a float/double type value */
    /* (overridden)                               */
    mdarray_uintptr &trunc();
    ...
    */
    ...
    /* Flipping elements is supported */
    /* (overridden)                   */
    mdarray_uintptr &trimf( const char *exp_fmt, ... );
    mdarray_uintptr &vtrimf( const char *exp_fmt, va_list ap );

    /* flip elements in a section */
    /* (overridden)               */
    mdarray_uintptr &flipf( const char *exp_fmt, ... );
    mdarray_uintptr &vflipf( const char *exp_fmt, va_list ap );
    ...
    /* (overridden)                        */
    mdarray_uintptr &cleanf( const char *exp_fmt, ... );
    mdarray_uintptr &vcleanf( const char *exp_fmt, va_list ap );

    /* rewrite element values with a value in a section */
    /* (overridden)                                     */
    mdarray_uintptr &fillf( double value, const char *exp_fmt, ... );
    mdarray_uintptr &vfillf( double value, const char *exp_fmt, va_list ap );

    /* <overloaded>                                     */
    virtual mdarray_uintptr &fillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_uintptr *,void *),
        void *user_ptr, const char *exp_fmt, ... );
    virtual mdarray_uintptr &vfillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_uintptr *,void *),
        void *user_ptr, const char *exp_fmt, va_list ap );

    /* add a scalar value to element values in a section */
    /* (overridden)                                      */
    mdarray_uintptr &addf( double value, 
			  const char *exp_fmt, ... );
    mdarray_uintptr &vaddf( double value, 
			   const char *exp_fmt, va_list ap );

    /* subtract a scalar value from element values in a section */
    /* (overridden)                                             */
    mdarray_uintptr &subtractf( double value, 
			       const char *exp_fmt, ... );
    mdarray_uintptr &vsubtractf( double value, 
				const char *exp_fmt, va_list ap );

    /* multiply element values in a section by a scalar value */
    /* (overridden)                                           */
    mdarray_uintptr &multiplyf( double value, 
			       const char *exp_fmt, ... );
    mdarray_uintptr &vmultiplyf( double value, 
				const char *exp_fmt, va_list ap );

    /* divide element values in a section by a scalar value */
    /* (overridden)                                         */
    mdarray_uintptr &dividef( double value, 
			     const char *exp_fmt, ... );
    mdarray_uintptr &vdividef( double value, 
			      const char *exp_fmt, va_list ap );
    ...
    /* (overridden)                                                          */
    mdarray_uintptr &pastef( const mdarray &src,
			    const char *exp_fmt, ... );
    mdarray_uintptr &vpastef( const mdarray &src,
			     const char *exp_fmt, va_list ap );
    ...
    /*   8. user pointer                                                     */
    /* <overloaded>                                                          */
    virtual mdarray_uintptr &pastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_uintptr *,void *),
	void *user_ptr,
        const char *exp_fmt, ... );
    virtual mdarray_uintptr &vpastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_uintptr *,void *),
	void *user_ptr,
        const char *exp_fmt, va_list ap );
    ...
    /* add an array object */
    /* (overridden)        */
    mdarray_uintptr &addf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_uintptr &vaddf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* subtract an array object */
    /* (overridden)             */
    mdarray_uintptr &subtractf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_uintptr &vsubtractf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* multiply an array object */
    /* (overridden)             */
    mdarray_uintptr &multiplyf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_uintptr &vmultiplyf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* divide an array object */
    /* (overridden)           */
    mdarray_uintptr &dividef( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_uintptr &vdividef( const mdarray &src_img, const char *exp_fmt, va_list ap );
    ...
    */
    ...
    /* rewrite element values with a value in a section */
    /* (overridden)                                     */
    mdarray_uintptr &fill( double value,
			 ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
			 ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
			 ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );

    /* <overloaded>                                     */
    virtual mdarray_uintptr &fill_via_udf( double value,
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_uintptr *,void *),
	void *user_ptr,
	ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
	ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
    ...
    /* add a scalar value to element values in a section */
    /* (overridden)                                      */
    mdarray_uintptr &add( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* subtract a scalar value from element values in a section */
    /* (overridden)                                             */
    mdarray_uintptr &subtract( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* multiply element values in a section by a scalar value */
    /* (overridden)                                           */
    mdarray_uintptr &multiply( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* divide element values in a section by a scalar value */
    /* (overridden)                                         */
    mdarray_uintptr &divide( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* paste up an array object */
    /* (overridden)             */
    mdarray_uintptr &paste( const mdarray &src,
	ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* <overloaded>             */
    virtual mdarray_uintptr &paste_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t,ssize_t,ssize_t,ssize_t,mdarray_uintptr *,void *),
	void *user_ptr,
	ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );
    ...
    /* add an array object */
    /* (overridden)        */
    mdarray_uintptr &add( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* subtract an array object */
    /* (overridden)             */
    mdarray_uintptr &subtract( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* multiply an array object */
    /* (overridden)             */
    mdarray_uintptr &multiply( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* divide an array object */
    /* (overridden)           */
    mdarray_uintptr &divide( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );
    ...
    */
    ...
    /* <overloaded>                                                    */
    virtual mdarray_uintptr &register_extptr( uintptr_t **extptr_address );
    virtual mdarray_uintptr &register_extptr_2d( uintptr_t *const **extptr2d_address );
    virtual mdarray_uintptr &register_extptr_3d( uintptr_t *const *const **extptr3d_address );

    /* Acquire the specified element's address */
    virtual const uintptr_t *carray() const;
    virtual const uintptr_t *carray( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
    virtual uintptr_t *array_ptr();
    virtual uintptr_t *array_ptr( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF );
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const uintptr_t *array_ptr() const;
    virtual const uintptr_t *array_ptr( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
#endif
    virtual const uintptr_t *array_ptr_cs() const;
    virtual const uintptr_t *array_ptr_cs( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
    ...
    virtual uintptr_t *const *array_ptr_2d( bool use );
    /* followings have no overhead. Execute .array_ptr_2d(true) before use. */
    virtual uintptr_t *const *array_ptr_2d();
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const uintptr_t *const *array_ptr_2d() const;
#endif
    virtual const uintptr_t *const *array_ptr_2d_cs() const;
    ...
    /*        "use=false" when there is no requirement of referring         */
    /*        obtained address table.                                       */
    virtual uintptr_t *const *const *array_ptr_3d( bool use );
    /* followings have no overhead. Execute .array_ptr_3d(true) before use. */
    virtual uintptr_t *const *const *array_ptr_3d();
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const uintptr_t *const *const *array_ptr_3d() const;
#endif
    virtual const uintptr_t *const *const *array_ptr_3d_cs() const;
    ...
    */
    ...
    /* (overridden)                    */
    mdarray_uintptr &reverse_endian( bool is_little_endian );
    /* (overridden)                    */
    mdarray_uintptr &reverse_endian( bool is_little_endian, 
				    size_t begin, size_t length );

    /* acquisition of the initial value */
    virtual uintptr_t default_value() const;
 ...
 *
 */
inline mdarray_uintptr &mdarray_uintptr::put( uintptr_t value, ssize_t idx, size_t len )
{
 ...
 *
 */
inline mdarray_uintptr &mdarray_uintptr::put( uintptr_t value,
				    size_t dim_index, ssize_t idx, size_t len )
{
 ...
 */
inline mdarray_uintptr &mdarray_uintptr::assign( dcomplex value,
 ...
 *
 */
inline mdarray_uintptr &mdarray_uintptr::assign( double value, 
				     ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
    this->mdarray::assign(value, idx0, idx1, idx2);
    return *this;
 ...
 *
 */
inline uintptr_t &mdarray_uintptr::operator[]( ssize_t idx0 )
{
    return ((0 <= idx0 && idx0 < (ssize_t)this->length()) ? 
	    ((uintptr_t *)(this->data_ptr()))[idx0] :
	    this->at(idx0));
}
 ...
 *
 */
inline const uintptr_t &mdarray_uintptr::operator[]( ssize_t idx0 ) const
{
    return ((0 <= idx0 && idx0 < (ssize_t)this->length()) ? 
	    ((const uintptr_t *)(this->data_ptr_cs()))[idx0] :
	    this->at_cs(idx0));
}
 ...
 *
 */
inline uintptr_t &mdarray_uintptr::operator()( ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
 ...
 *
 */
inline const uintptr_t &mdarray_uintptr::operator()( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
 ...
 *
 */
inline uintptr_t &mdarray_uintptr::at( ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
    ssize_t idx = this->get_idx_3d(idx0,idx1,idx2);
    if ( 0 <= idx ) {
	return ((uintptr_t *)(this->data_ptr()))[idx];
    }
    else {
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const uintptr_t &mdarray_uintptr::at( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
    return this->at_cs(idx0, idx1, idx2);
}
#endif
 ...
 *
 */
inline const uintptr_t &mdarray_uintptr::at_cs( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
    ssize_t idx = this->get_idx_3d_cs(idx0,idx1,idx2);
    if ( 0 <= idx ) {
	return ((const uintptr_t *)(this->data_ptr()))[idx];
    }
    else {
	uintptr_t *p = (uintptr_t *)(this->junk_rec);
	*p = (uintptr_t)(NULL);
 ...
 *
 */
inline mdarray_uintptr &mdarray_uintptr::ceil()
{
    this->mdarray::ceil();
    return *this;
}
 ...
 *
 */
inline mdarray_uintptr &mdarray_uintptr::floor()
{
    this->mdarray::floor();
    return *this;
}
 ...
 *
 */
inline mdarray_uintptr &mdarray_uintptr::round()
{
    this->mdarray::round();
    return *this;
}
 ...
 *
 */
inline mdarray_uintptr &mdarray_uintptr::trunc()
{
    this->mdarray::trunc();
    return *this;
}
 ...
 *
 */
inline mdarray_uintptr &mdarray_uintptr::abs()
{
    this->mdarray::abs();
    return *this;
}
 ...
 *
 */
inline const uintptr_t *mdarray_uintptr::carray() const
{
    return (const uintptr_t *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const uintptr_t *mdarray_uintptr::carray( ssize_t idx0, 
				     ssize_t idx1, ssize_t idx2 ) const
{
    return (const uintptr_t *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *
 */
inline uintptr_t *mdarray_uintptr::array_ptr()
{
    return (uintptr_t *)(this->data_ptr());
}
 ...
 *
 */
inline uintptr_t *mdarray_uintptr::array_ptr( ssize_t idx0, 
				  ssize_t idx1, ssize_t idx2 )
{
    return (uintptr_t *)(this->data_ptr(idx0,idx1,idx2));
}
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const uintptr_t *mdarray_uintptr::array_ptr() const
{
    return (const uintptr_t *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const uintptr_t *mdarray_uintptr::array_ptr( ssize_t idx0, 
					   ssize_t idx1, ssize_t idx2 ) const
{
    return (const uintptr_t *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *
 */
inline const uintptr_t *mdarray_uintptr::array_ptr_cs() const
{
    return (const uintptr_t *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const uintptr_t *mdarray_uintptr::array_ptr_cs( ssize_t idx0, 
					   ssize_t idx1, ssize_t idx2 ) const
{
    return (const uintptr_t *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *             使用しない場合はfalse(機能off)．
 */
inline uintptr_t *const *mdarray_uintptr::array_ptr_2d( bool use )
{
    return (uintptr_t *const *)(this->mdarray::data_ptr_2d(use));
}

/**
 * @brief  内部で生成された2次元配列用ポインタ配列のアドレスを取得
 */
inline uintptr_t *const *mdarray_uintptr::array_ptr_2d()
{
    return (uintptr_t *const *)(this->mdarray::data_ptr_2d());
}
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const uintptr_t *const *mdarray_uintptr::array_ptr_2d() const
{
    return (const uintptr_t *const *)(this->mdarray::data_ptr_2d_cs());
}
#endif
 ...
 * @brief  内部で生成された2次元配列用ポインタ配列のアドレスを取得 (読取専用)
 */
inline const uintptr_t *const *mdarray_uintptr::array_ptr_2d_cs() const
{
    return (const uintptr_t *const *)(this->mdarray::data_ptr_2d_cs());
}
 ...
 *             使用しない場合はfalse(機能off)．
 */
inline uintptr_t *const *const *mdarray_uintptr::array_ptr_3d( bool use )
{
    return (uintptr_t *const *const *)(this->mdarray::data_ptr_3d(use));
}

/**
 * @brief  内部で生成された3次元配列用ポインタ配列のアドレスを取得
 */
inline uintptr_t *const *const *mdarray_uintptr::array_ptr_3d()
{
    return (uintptr_t *const *const *)(this->mdarray::data_ptr_3d());
}
 ...
 */
inline const uintptr_t *const *const *mdarray_uintptr::array_ptr_3d() const
{
    return (const uintptr_t *const *const *)(this->mdarray::data_ptr_3d_cs());
}
#endif
 ...
 * @brief  内部で生成された3次元配列用ポインタ配列のアドレスを取得 (読取専用)
 */
inline const uintptr_t *const *const *mdarray_uintptr::array_ptr_3d_cs() const
{
    return (const uintptr_t *const *const *)(this->mdarray::data_ptr_3d_cs());
}
 ...
 *
 */
inline uintptr_t mdarray_uintptr::default_value() const
{
    const uintptr_t *p = (const uintptr_t *)(this->default_value_ptr());
    if ( p == NULL ) return 0;
    else return *p;
}
