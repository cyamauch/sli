...
#ifndef _SLI__MDARRAY_FCOMPLEX_H
#define _SLI__MDARRAY_FCOMPLEX_H 1

/**
 * @file   mdarray_fcomplex.h
 * @brief  fcomplex型の多次元配列を扱う mdarray_fcomplex クラスのヘッダファイル
 */
...
/*
 * sli::mdarray_fcomplex is an inherited class of sli::mdarray, and is a 
...
/**
 * @class  sli::mdarray_fcomplex
 * @brief  fcomplex型の多次元配列を扱うためのクラス
 *
 *   mdarray_fcomplexクラスは，fcomplex型の多次元配列を IDL や Python のように
 ...
 * 
 * @note  mdarray_fcomplexクラスは mdarray(基底クラス) を継承しています．<br>
 *        SIMD命令(SSE2)により，基本的な部分が高速化されています．
 * @author  Chisato YAMAUCHI
 * @date  2013-04-01 00:00:00
 */

  class mdarray_fcomplex : public mdarray
  {

  public:
    /* constructor                                                           */
    /* The mdarray_fcomplex class has two kinds of operating modes:            */
    ...
    mdarray_fcomplex();
    mdarray_fcomplex( bool auto_resize );
    mdarray_fcomplex( bool auto_resize, fcomplex **extptr_address );
    mdarray_fcomplex( bool auto_resize, fcomplex *const **extptr2d_address );
    mdarray_fcomplex( bool auto_resize, fcomplex *const *const **extptr3d_address );
    mdarray_fcomplex( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf );
    mdarray_fcomplex( bool auto_resize, size_t naxis0 );
    mdarray_fcomplex( bool auto_resize, size_t naxis0, size_t naxis1 );
    mdarray_fcomplex( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 );
    mdarray_fcomplex( bool auto_resize, size_t naxis0, 
		   const fcomplex vals[] );
    mdarray_fcomplex( bool auto_resize, size_t naxis0, size_t naxis1,
		   const fcomplex vals[] );
...
#if 0
    mdarray_fcomplex( bool auto_resize, const char *dim_info, fcomplex v0, ... );
#endif
    mdarray_fcomplex( const mdarray_fcomplex &obj );


    /* --------------------------------------------------------------------- */

    /* `virtual' がついてるものはオーバーライドではなくオーバーロード     */
    /*   mdarray_fcomplex &operator=(const mdarray_fcomplex &obj);            */
    /* が隠れて存在する事に注意 (演算子 = だけは，特別な規則があるらしい) */

    /* substitute an array (copy the attribute, too)                      */
    virtual mdarray_fcomplex &operator=(const mdarray &obj);

    /* (overridden) */
    mdarray_fcomplex &operator+=(const mdarray &obj);
    mdarray_fcomplex &operator-=(const mdarray &obj);
    mdarray_fcomplex &operator*=(const mdarray &obj);
    mdarray_fcomplex &operator/=(const mdarray &obj);

    /* (overridden) */
    mdarray_fcomplex &operator=(dcomplex v);
    mdarray_fcomplex &operator=(double v);
    mdarray_fcomplex &operator=(long long v);
    mdarray_fcomplex &operator=(long v);
    mdarray_fcomplex &operator=(int v);
    mdarray_fcomplex &operator+=(dcomplex v);
    mdarray_fcomplex &operator+=(double v);
    mdarray_fcomplex &operator+=(long long v);
    mdarray_fcomplex &operator+=(long v);
    ...
    */
    ...
    /* (overridden)                */
    mdarray_fcomplex &init();

    /* <overloaded>                */
    virtual mdarray_fcomplex &init( bool auto_resize );
    virtual mdarray_fcomplex &init( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf );
    virtual mdarray_fcomplex &init( bool auto_resize, size_t naxis0 );
    virtual mdarray_fcomplex &init( bool auto_resize, size_t naxis0, size_t naxis1 );
    virtual mdarray_fcomplex &init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 );
    virtual mdarray_fcomplex &init( bool auto_resize, size_t naxis0, 
				 const fcomplex vals[] );
    virtual mdarray_fcomplex &init( bool auto_resize, size_t naxis0, size_t naxis1,
				 const fcomplex vals[] );
    ...
    virtual mdarray_fcomplex &init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2,
				 const fcomplex *const *const vals[] );
#if 0
    virtual mdarray_fcomplex &init( bool auto_resize, const char *dim_info,
				 fcomplex v0, ... );
    virtual mdarray_fcomplex &vinit( bool auto_resize, const char *dim_info,
				  fcomplex v0, va_list );
#endif
    /*  mdarray_fcomplex &init( const mdarray &obj ); が隠れている */
    /*  (↑mdarrayクラスのポインタ経由で呼び出し可能)            */

    /* (overridden)                                           */
    mdarray_fcomplex &init( const mdarray &obj );

    /* copy properties (auto_resize, auto_init, and rounding) */
    /* (overridden)                                           */
    mdarray_fcomplex &init_properties( const mdarray &src_obj );

    /* setting of the resize mode */
    /* (overridden)               */
    mdarray_fcomplex &set_auto_resize( bool tf );

    /* setting of the initialize mode */
    /* (overridden)                   */
    mdarray_fcomplex &set_auto_init( bool tf );

    /* setting of the rounding off possibility */
    /* (overridden)                            */
    mdarray_fcomplex &set_rounding( bool tf );

    /* setting of strategy of memory allocation */
    /* "auto", "min" and "pow" can be set.      */
    /* (overridden)                             */
    mdarray_fcomplex &set_alloc_strategy( const char *strategy );

    /* convert the value of the full array element */
    /* <overloaded>                                */
    virtual mdarray_fcomplex &convert_via_udf(
		void (*func)(const fcomplex *,fcomplex *,size_t,int,void *),
		void *user_ptr );

    /* swap contents between self and another objects */
    /* (overridden)                 */
    mdarray_fcomplex &swap( mdarray &sobj );
    ...
    /* (overridden)                             */
    mdarray_fcomplex &cut( mdarray *dest );

    /* interchange rows and columns */
    /* (overridden)                 */
    mdarray_fcomplex &transpose_xy();

    /* interchange xyz to zxy */
    /* (overridden)           */
    mdarray_fcomplex &transpose_xyz2zxy();

    /* rotate image                                              */
    /*   angle: 90,-90, or 180                                   */
    /*          (anticlockwise when image is bottom-left origin) */
    /* (overridden)                                              */
    mdarray_fcomplex &rotate_xy( int angle );
    ...
    */
    ...
    /* (overridden)                                          */
    mdarray_fcomplex &assign( dcomplex value,
			    ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF,
			    ssize_t idx2 = MDARRAY_INDEF );
    mdarray_fcomplex &assign( double value, 
			    ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF,
			    ssize_t idx2 = MDARRAY_INDEF );

    /* a reference to the specified value of the element (1 dimension) */
    virtual fcomplex &operator[]( ssize_t idx0 );
    virtual const fcomplex &operator[]( ssize_t idx0 ) const;

    /* a reference to the specified value of the element (1-3 dimensions) */
    virtual fcomplex &operator()( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				ssize_t idx2 = MDARRAY_INDEF);
    virtual const fcomplex &operator()( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				ssize_t idx2 = MDARRAY_INDEF) const;

    /* a reference to the specified value of the element (1-3 dimensions) */
    virtual fcomplex &at( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
			  ssize_t idx2 = MDARRAY_INDEF);
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const fcomplex &at( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				 ssize_t idx2 = MDARRAY_INDEF) const;
#endif
    virtual const fcomplex &at_cs( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				 ssize_t idx2 = MDARRAY_INDEF) const;
    ...
    /* <overloaded>                                */
    virtual mdarray_fcomplex &put( fcomplex value, ssize_t idx, size_t len );
    virtual mdarray_fcomplex &put( fcomplex value,
				size_t dim_index, ssize_t idx, size_t len );

    /* copy the array stored in object into the programmer's buffer. */
    /* <overloaded>                                                  */
    virtual ssize_t get_elements( fcomplex *dest_buf, size_t elem_size, 
				ssize_t idx0 = 0, ssize_t idx1 = MDARRAY_INDEF,
				ssize_t idx2 = MDARRAY_INDEF ) const;

    /* copy the array in the programmer's buffer into object's buffer. */
    /* <overloaded>                                                    */
    virtual ssize_t put_elements( const fcomplex *src_buf, size_t elem_size,
				ssize_t idx0 = 0, ssize_t idx1 = MDARRAY_INDEF,
				ssize_t idx2 = MDARRAY_INDEF );
    ...
    /* (overridden)                      */
    mdarray_fcomplex &increase_dim();

    /* reduction of the dimension number */
    /* (overridden)                      */
    mdarray_fcomplex &decrease_dim();

    /* change the length of the array */
    /* (overridden)                   */
    mdarray_fcomplex &resize( size_t len );
    mdarray_fcomplex &resize( size_t dim_index, size_t len );
    mdarray_fcomplex &resize( const mdarray &src );

    /* change the length of the 1-d array */
    /* (overridden)                       */
    mdarray_fcomplex &resize_1d( size_t x_len );

    /* change the length of the 2-d array */
    /* (overridden)                       */
    mdarray_fcomplex &resize_2d( size_t x_len, size_t y_len );

    /* change the length of the 3-d array */
    /* (overridden)                       */
    mdarray_fcomplex &resize_3d( size_t x_len, size_t y_len, size_t z_len );

    /* change the length of the array (supports n-dim) */
    /* (overridden)                                    */
    mdarray_fcomplex &resize( const size_t naxisx[], size_t ndim, 
			    bool init_buf );
    ...
    /* (overridden)                                                   */
    mdarray_fcomplex &resizef( const char *exp_fmt, ... );
    mdarray_fcomplex &vresizef( const char *exp_fmt, va_list ap );

    /* change the length of the array relatively */
    /* (overridden)                              */
    mdarray_fcomplex &resizeby( ssize_t len );			/* for 1-d */
    mdarray_fcomplex &resizeby( size_t dim_index, ssize_t len );

    /* change the length of the 1-d array relatively */
    /* (overridden)                                  */
    mdarray_fcomplex &resizeby_1d( ssize_t x_len );

    /* change the length of the 2-d array relatively */
    /* (overridden)                                  */
    mdarray_fcomplex &resizeby_2d( ssize_t x_len, ssize_t y_len );

    /* change the length of the 3-d array relatively */
    /* (overridden)                                  */
    mdarray_fcomplex &resizeby_3d(ssize_t x_len, ssize_t y_len, ssize_t z_len);
    ...
    /* (overridden)                                                         */
    mdarray_fcomplex &resizeby( const ssize_t naxisx_rel[], size_t ndim, 
			       bool init_buf );
    ...
    /* length of first dimension.                                      */
    /* (overridden)                                                    */
    mdarray_fcomplex &resizebyf( const char *exp_fmt, ... );
    mdarray_fcomplex &vresizebyf( const char *exp_fmt, va_list ap );

    /* change length of array without adjusting buffer contents */
    /* (overridden)                                             */
    mdarray_fcomplex &reallocate( const size_t naxisx[], size_t ndim, 
				bool init_buf );

    /* free current buffer and alloc new memory */
    /* (overridden)                             */
    mdarray_fcomplex &allocate( const size_t naxisx[], size_t ndim, 
			      bool init_buf );

    /* setting of the initial value for .resize(), etc. */
    /* <overloaded>                                     */
    virtual mdarray_fcomplex &assign_default( fcomplex value );

    /* insert a blank section */
    /* (overridden)           */
    mdarray_fcomplex &insert( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_fcomplex &insert( size_t dim_index, ssize_t idx, size_t len );

    /* erase a section */
    /* (overridden)    */
    mdarray_fcomplex &erase( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_fcomplex &erase( size_t dim_index, ssize_t idx, size_t len );

    /* copy values between elements (without automatic resizing) */
    /* 移動 (バッファのサイズは変更しない)                       */
    /* (overridden)                                              */
    mdarray_fcomplex &move( ssize_t idx_src, size_t len, ssize_t idx_dst,
			   bool clr );				/* for 1-d */
    mdarray_fcomplex &move( size_t dim_index, 
    ...
    /* (overridden)                                           */
    mdarray_fcomplex &cpy( ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr );				/* for 1-d */
    mdarray_fcomplex &cpy( size_t dim_index, 
			  ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr );

    /* replace values between elements */
    /* (overridden)                    */
    mdarray_fcomplex &swap( ssize_t idx_src, size_t len, 
			  ssize_t idx_dst );			/* for 1-d */
    mdarray_fcomplex &swap( size_t dim_index, 
			   ssize_t idx_src, size_t len, ssize_t idx_dst );

    /* extract a section           */
    /* see also trimf() and trim() */
    /* (overridden)                */
    mdarray_fcomplex &crop( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_fcomplex &crop( size_t dim_index, ssize_t idx, size_t len );

    /* flip a section   */
    /* see also flipf() */
    /* (overridden)     */
    mdarray_fcomplex &flip( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_fcomplex &flip( size_t dim_index, ssize_t idx, size_t len );


    /* raise decimals to the next whole number in a float/double type value */
    /* (overridden)                                                         */
    mdarray_fcomplex &ceil();

    /* devalue decimals in a float/double type value */
    /* (overridden)                                  */
    mdarray_fcomplex &floor();

    /* round off decimals in a float/double type value */
    /* (overridden)                                    */
    mdarray_fcomplex &round();

    /* omit decimals in a float/double type value */
    /* (overridden)                               */
    mdarray_fcomplex &trunc();

    /* absolute value of all elements */
    /* (overridden)                   */
    mdarray_fcomplex &abs();
    ...
    */
    ...
    /* Flipping elements is supported */
    /* (overridden)                   */
    mdarray_fcomplex &trimf( const char *exp_fmt, ... );
    mdarray_fcomplex &vtrimf( const char *exp_fmt, va_list ap );

    /* flip elements in a section */
    /* (overridden)               */
    mdarray_fcomplex &flipf( const char *exp_fmt, ... );
    mdarray_fcomplex &vflipf( const char *exp_fmt, va_list ap );
    ...
    /* (overridden)                        */
    mdarray_fcomplex &cleanf( const char *exp_fmt, ... );
    mdarray_fcomplex &vcleanf( const char *exp_fmt, va_list ap );

    /* rewrite element values with a value in a section */
    /* (overridden)                                     */
    mdarray_fcomplex &fillf( double value, const char *exp_fmt, ... );
    mdarray_fcomplex &vfillf( double value, const char *exp_fmt, va_list ap );

    /* <overloaded>                                     */
    virtual mdarray_fcomplex &fillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_fcomplex *,void *),
        void *user_ptr, const char *exp_fmt, ... );
    virtual mdarray_fcomplex &vfillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_fcomplex *,void *),
        void *user_ptr, const char *exp_fmt, va_list ap );

    /* add a scalar value to element values in a section */
    /* (overridden)                                      */
    mdarray_fcomplex &addf( double value, 
			  const char *exp_fmt, ... );
    mdarray_fcomplex &vaddf( double value, 
			   const char *exp_fmt, va_list ap );

    /* subtract a scalar value from element values in a section */
    /* (overridden)                                             */
    mdarray_fcomplex &subtractf( double value, 
			       const char *exp_fmt, ... );
    mdarray_fcomplex &vsubtractf( double value, 
				const char *exp_fmt, va_list ap );

    /* multiply element values in a section by a scalar value */
    /* (overridden)                                           */
    mdarray_fcomplex &multiplyf( double value, 
			       const char *exp_fmt, ... );
    mdarray_fcomplex &vmultiplyf( double value, 
				const char *exp_fmt, va_list ap );

    /* divide element values in a section by a scalar value */
    /* (overridden)                                         */
    mdarray_fcomplex &dividef( double value, 
			     const char *exp_fmt, ... );
    mdarray_fcomplex &vdividef( double value, 
			      const char *exp_fmt, va_list ap );
    ...
    /* (overridden)                                                          */
    mdarray_fcomplex &pastef( const mdarray &src,
			    const char *exp_fmt, ... );
    mdarray_fcomplex &vpastef( const mdarray &src,
			     const char *exp_fmt, va_list ap );
    ...
    /*   8. user pointer                                                     */
    /* <overloaded>                                                          */
    virtual mdarray_fcomplex &pastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_fcomplex *,void *),
	void *user_ptr,
        const char *exp_fmt, ... );
    virtual mdarray_fcomplex &vpastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_fcomplex *,void *),
	void *user_ptr,
        const char *exp_fmt, va_list ap );
    ...
    /* add an array object */
    /* (overridden)        */
    mdarray_fcomplex &addf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_fcomplex &vaddf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* subtract an array object */
    /* (overridden)             */
    mdarray_fcomplex &subtractf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_fcomplex &vsubtractf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* multiply an array object */
    /* (overridden)             */
    mdarray_fcomplex &multiplyf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_fcomplex &vmultiplyf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* divide an array object */
    /* (overridden)           */
    mdarray_fcomplex &dividef( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_fcomplex &vdividef( const mdarray &src_img, const char *exp_fmt, va_list ap );
    ...
    */
    ...
    /* rewrite element values with a value in a section */
    /* (overridden)                                     */
    mdarray_fcomplex &fill( double value,
			 ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
			 ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
			 ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );

    /* <overloaded>                                     */
    virtual mdarray_fcomplex &fill_via_udf( double value,
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_fcomplex *,void *),
	void *user_ptr,
	ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
	ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
    ...
    /* add a scalar value to element values in a section */
    /* (overridden)                                      */
    mdarray_fcomplex &add( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* subtract a scalar value from element values in a section */
    /* (overridden)                                             */
    mdarray_fcomplex &subtract( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* multiply element values in a section by a scalar value */
    /* (overridden)                                           */
    mdarray_fcomplex &multiply( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* divide element values in a section by a scalar value */
    /* (overridden)                                         */
    mdarray_fcomplex &divide( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* paste up an array object */
    /* (overridden)             */
    mdarray_fcomplex &paste( const mdarray &src,
	ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* <overloaded>             */
    virtual mdarray_fcomplex &paste_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t,ssize_t,ssize_t,ssize_t,mdarray_fcomplex *,void *),
	void *user_ptr,
	ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );
    ...
    /* add an array object */
    /* (overridden)        */
    mdarray_fcomplex &add( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* subtract an array object */
    /* (overridden)             */
    mdarray_fcomplex &subtract( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* multiply an array object */
    /* (overridden)             */
    mdarray_fcomplex &multiply( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* divide an array object */
    /* (overridden)           */
    mdarray_fcomplex &divide( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );
    ...
    */
    ...
    /* <overloaded>                                                    */
    virtual mdarray_fcomplex &register_extptr( fcomplex **extptr_address );
    virtual mdarray_fcomplex &register_extptr_2d( fcomplex *const **extptr2d_address );
    virtual mdarray_fcomplex &register_extptr_3d( fcomplex *const *const **extptr3d_address );

    /* Acquire the specified element's address */
    virtual const fcomplex *carray() const;
    virtual const fcomplex *carray( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
    virtual fcomplex *array_ptr();
    virtual fcomplex *array_ptr( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF );
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const fcomplex *array_ptr() const;
    virtual const fcomplex *array_ptr( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
#endif
    virtual const fcomplex *array_ptr_cs() const;
    virtual const fcomplex *array_ptr_cs( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
    ...
    virtual fcomplex *const *array_ptr_2d( bool use );
    /* followings have no overhead. Execute .array_ptr_2d(true) before use. */
    virtual fcomplex *const *array_ptr_2d();
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const fcomplex *const *array_ptr_2d() const;
#endif
    virtual const fcomplex *const *array_ptr_2d_cs() const;
    ...
    /*        "use=false" when there is no requirement of referring         */
    /*        obtained address table.                                       */
    virtual fcomplex *const *const *array_ptr_3d( bool use );
    /* followings have no overhead. Execute .array_ptr_3d(true) before use. */
    virtual fcomplex *const *const *array_ptr_3d();
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const fcomplex *const *const *array_ptr_3d() const;
#endif
    virtual const fcomplex *const *const *array_ptr_3d_cs() const;
    ...
    */
    ...
    /* (overridden)                    */
    mdarray_fcomplex &reverse_endian( bool is_little_endian );
    /* (overridden)                    */
    mdarray_fcomplex &reverse_endian( bool is_little_endian, 
				    size_t begin, size_t length );

    /* acquisition of the initial value */
    virtual fcomplex default_value() const;
 ...
 *
 */
inline mdarray_fcomplex &mdarray_fcomplex::put( fcomplex value, ssize_t idx, size_t len )
{
 ...
 *
 */
inline mdarray_fcomplex &mdarray_fcomplex::put( fcomplex value,
				    size_t dim_index, ssize_t idx, size_t len )
{
 ...
 */
inline mdarray_fcomplex &mdarray_fcomplex::assign( dcomplex value,
 ...
 *
 */
inline mdarray_fcomplex &mdarray_fcomplex::assign( double value, 
				     ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
    this->mdarray::assign(value, idx0, idx1, idx2);
    return *this;
 ...
 *
 */
inline fcomplex &mdarray_fcomplex::operator[]( ssize_t idx0 )
{
    return ((0 <= idx0 && idx0 < (ssize_t)this->length()) ? 
	    ((fcomplex *)(this->data_ptr()))[idx0] :
	    this->at(idx0));
}
 ...
 *
 */
inline const fcomplex &mdarray_fcomplex::operator[]( ssize_t idx0 ) const
{
    return ((0 <= idx0 && idx0 < (ssize_t)this->length()) ? 
	    ((const fcomplex *)(this->data_ptr_cs()))[idx0] :
	    this->at_cs(idx0));
}
 ...
 *
 */
inline fcomplex &mdarray_fcomplex::operator()( ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
 ...
 *
 */
inline const fcomplex &mdarray_fcomplex::operator()( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
 ...
 *
 */
inline fcomplex &mdarray_fcomplex::at( ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
    ssize_t idx = this->get_idx_3d(idx0,idx1,idx2);
    if ( 0 <= idx ) {
	return ((fcomplex *)(this->data_ptr()))[idx];
    }
    else {
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const fcomplex &mdarray_fcomplex::at( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
    return this->at_cs(idx0, idx1, idx2);
}
#endif
 ...
 *
 */
inline const fcomplex &mdarray_fcomplex::at_cs( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
    ssize_t idx = this->get_idx_3d_cs(idx0,idx1,idx2);
    if ( 0 <= idx ) {
	return ((const fcomplex *)(this->data_ptr()))[idx];
    }
    else {
	fcomplex *p = (fcomplex *)(this->junk_rec);
	*p = NAN + NAN*I;
 ...
 *
 */
inline mdarray_fcomplex &mdarray_fcomplex::ceil()
{
    this->mdarray::ceil();
    return *this;
}
 ...
 *
 */
inline mdarray_fcomplex &mdarray_fcomplex::floor()
{
    this->mdarray::floor();
    return *this;
}
 ...
 *
 */
inline mdarray_fcomplex &mdarray_fcomplex::round()
{
    this->mdarray::round();
    return *this;
}
 ...
 *
 */
inline mdarray_fcomplex &mdarray_fcomplex::trunc()
{
    this->mdarray::trunc();
    return *this;
}
 ...
 *
 */
inline mdarray_fcomplex &mdarray_fcomplex::abs()
{
    this->mdarray::abs();
    return *this;
}
 ...
 *
 */
inline const fcomplex *mdarray_fcomplex::carray() const
{
    return (const fcomplex *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const fcomplex *mdarray_fcomplex::carray( ssize_t idx0, 
				     ssize_t idx1, ssize_t idx2 ) const
{
    return (const fcomplex *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *
 */
inline fcomplex *mdarray_fcomplex::array_ptr()
{
    return (fcomplex *)(this->data_ptr());
}
 ...
 *
 */
inline fcomplex *mdarray_fcomplex::array_ptr( ssize_t idx0, 
				  ssize_t idx1, ssize_t idx2 )
{
    return (fcomplex *)(this->data_ptr(idx0,idx1,idx2));
}
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const fcomplex *mdarray_fcomplex::array_ptr() const
{
    return (const fcomplex *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const fcomplex *mdarray_fcomplex::array_ptr( ssize_t idx0, 
					   ssize_t idx1, ssize_t idx2 ) const
{
    return (const fcomplex *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *
 */
inline const fcomplex *mdarray_fcomplex::array_ptr_cs() const
{
    return (const fcomplex *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const fcomplex *mdarray_fcomplex::array_ptr_cs( ssize_t idx0, 
					   ssize_t idx1, ssize_t idx2 ) const
{
    return (const fcomplex *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *             使用しない場合はfalse(機能off)．
 */
inline fcomplex *const *mdarray_fcomplex::array_ptr_2d( bool use )
{
    return (fcomplex *const *)(this->mdarray::data_ptr_2d(use));
}

/**
 * @brief  内部で生成された2次元配列用ポインタ配列のアドレスを取得
 */
inline fcomplex *const *mdarray_fcomplex::array_ptr_2d()
{
    return (fcomplex *const *)(this->mdarray::data_ptr_2d());
}
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const fcomplex *const *mdarray_fcomplex::array_ptr_2d() const
{
    return (const fcomplex *const *)(this->mdarray::data_ptr_2d_cs());
}
#endif
 ...
 * @brief  内部で生成された2次元配列用ポインタ配列のアドレスを取得 (読取専用)
 */
inline const fcomplex *const *mdarray_fcomplex::array_ptr_2d_cs() const
{
    return (const fcomplex *const *)(this->mdarray::data_ptr_2d_cs());
}
 ...
 *             使用しない場合はfalse(機能off)．
 */
inline fcomplex *const *const *mdarray_fcomplex::array_ptr_3d( bool use )
{
    return (fcomplex *const *const *)(this->mdarray::data_ptr_3d(use));
}

/**
 * @brief  内部で生成された3次元配列用ポインタ配列のアドレスを取得
 */
inline fcomplex *const *const *mdarray_fcomplex::array_ptr_3d()
{
    return (fcomplex *const *const *)(this->mdarray::data_ptr_3d());
}
 ...
 */
inline const fcomplex *const *const *mdarray_fcomplex::array_ptr_3d() const
{
    return (const fcomplex *const *const *)(this->mdarray::data_ptr_3d_cs());
}
#endif
 ...
 * @brief  内部で生成された3次元配列用ポインタ配列のアドレスを取得 (読取専用)
 */
inline const fcomplex *const *const *mdarray_fcomplex::array_ptr_3d_cs() const
{
    return (const fcomplex *const *const *)(this->mdarray::data_ptr_3d_cs());
}
 ...
 *
 */
inline fcomplex mdarray_fcomplex::default_value() const
{
    const fcomplex *p = (const fcomplex *)(this->default_value_ptr());
    if ( p == NULL ) return (0.0 + 0.0*I);
    else return *p;
}
...
#endif	/* _SLI__MDARRAY_FCOMPLEX_H */
