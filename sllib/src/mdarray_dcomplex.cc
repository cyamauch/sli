...
/**
 * @file   mdarray_dcomplex.cc
 * @brief  dcomplex型の多次元配列を扱う mdarray_dcomplex クラスのコード
 */

#define CLASS_NAME "mdarray_dcomplex"
 ...
 */
mdarray_dcomplex::mdarray_dcomplex()
{
    this->class_level_rec ++;
    this->mdarray::init(DCOMPLEX_ZT, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_dcomplex::mdarray_dcomplex( bool auto_r )
{
    this->class_level_rec ++;
    this->mdarray::init(DCOMPLEX_ZT, auto_r);
    return;
}
 ...
 *             ます．
 */
mdarray_dcomplex::mdarray_dcomplex( bool auto_r, dcomplex **extptr_address )
{
    this->class_level_rec ++;
    this->mdarray::init(DCOMPLEX_ZT, auto_r);
 ...
 *             ます．
 */
mdarray_dcomplex::mdarray_dcomplex( bool auto_r, dcomplex *const **extptr2d_address )
{
    this->class_level_rec ++;
    this->mdarray::init(DCOMPLEX_ZT, auto_r);
 ...
 *             ます．
 */
mdarray_dcomplex::mdarray_dcomplex( bool auto_r, dcomplex *const *const **extptr3d_address )
{
    this->class_level_rec ++;
    this->mdarray::init(DCOMPLEX_ZT, auto_r);
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_dcomplex::mdarray_dcomplex( bool auto_r, const size_t naxisx[], size_t ndim, bool init_buf )
{
    this->class_level_rec ++;
    this->mdarray::init(DCOMPLEX_ZT, auto_r, naxisx, ndim, init_buf);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
*/
mdarray_dcomplex::mdarray_dcomplex( bool auto_r, size_t naxis0 )
{
    const size_t naxisx[] = {naxis0};
    this->class_level_rec ++;
    this->mdarray::init(DCOMPLEX_ZT, auto_r, naxisx, 1, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_dcomplex::mdarray_dcomplex( bool auto_r, size_t naxis0, size_t naxis1 )
{
    const size_t naxisx[] = {naxis0, naxis1};
    this->class_level_rec ++;
    this->mdarray::init(DCOMPLEX_ZT, auto_r, naxisx, 2, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_dcomplex::mdarray_dcomplex( bool auto_r, size_t naxis0, size_t naxis1, size_t naxis2 )
{
    const size_t naxisx[] = {naxis0, naxis1, naxis2};
    this->class_level_rec ++;
    this->mdarray::init(DCOMPLEX_ZT, auto_r, naxisx, 3, true);
    return;
}
 ...
 */
mdarray_dcomplex::mdarray_dcomplex( bool auto_r, size_t naxis0, size_t naxis1, size_t naxis2,
			      const dcomplex *const *const vals[] )
{
    this->class_level_rec ++;
    this->init(auto_r, naxis0, naxis1, naxis2, vals);
    return;
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_dcomplex::mdarray_dcomplex( bool auto_r, const char *dim_info,
			      dcomplex v0, ... )
{
    va_list ap;
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_dcomplex::mdarray_dcomplex( const mdarray_dcomplex &obj )
{
    this->class_level_rec ++;
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::operator=(const mdarray &obj)
{
    debug_report("(const mdarray &obj)");
    if ( &obj == this ) return *this;

    if ( obj.size_type() == DCOMPLEX_ZT ) {
	this->mdarray::init(obj);
    }
    else {
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::operator=(dcomplex v)
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::operator=(double v)
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::operator=(long long v)
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::operator=(long v)
{
    debug_report("(long v)");
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::operator=(int v)
{
    debug_report("(int v)");
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::init()
{
    debug_report("()");
    this->mdarray::init();
    return *this;
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::init( bool auto_resize )
{
    this->mdarray::init();
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::init( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf )
{
    this->mdarray::init(DCOMPLEX_ZT, auto_resize, naxisx, ndim, init_buf);
    return *this;
}
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::init( bool auto_resize, size_t naxis0 )
{
    const size_t naxisx[] = {naxis0};
    this->mdarray::init(DCOMPLEX_ZT, auto_resize, naxisx, 1, true);
    return *this;
}
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::init( bool auto_resize, size_t naxis0, size_t naxis1 )
{
    const size_t naxisx[] = {naxis0, naxis1};
    this->mdarray::init(DCOMPLEX_ZT, auto_resize, naxisx, 2, true);
    return *this;
}
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 )
{
    const size_t naxisx[] = {naxis0, naxis1, naxis2};
    this->mdarray::init(DCOMPLEX_ZT, auto_resize, naxisx, 3, true);
    return *this;
}
 ...
 *          3次元までしかサポートしていません.
 */
size_t mdarray_dcomplex::parse_dim_info( const char *dim_info )
{
    size_t i;
    tarray_tstring arr0;
    this->dinfo_dlen[0] = 0;
...
{
    const size_t naxisx[] = {naxis0};
    this->mdarray::init(DCOMPLEX_ZT, auto_resize, naxisx, 1, false);
...
{
    const size_t naxisx[] = {naxis0, naxis1};
    this->mdarray::init(DCOMPLEX_ZT, auto_resize, naxisx, 2, false);
    this->mdarray::putdata((const void *)vals, this->byte_length());
    return *this;
}
...
{
    const size_t naxisx[] = {naxis0, naxis1, naxis2};
    this->mdarray::init(DCOMPLEX_ZT, auto_resize, naxisx, 3, false);
    this->mdarray::putdata((const void *)vals, this->byte_length());
    return *this;
}
 ...
 * @throw   内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_dcomplex &mdarray_dcomplex::init( bool auto_resize, const char *dim_info, dcomplex v0, ... )
{
    va_list ap;
    va_start(ap, v0);
    try {
 ...
 * @throw   内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_dcomplex &mdarray_dcomplex::vinit( bool auto_resize, const char *dim_info, dcomplex v0, va_list ap )
{
    size_t ndim = this->parse_dim_info(dim_info);
    if ( ndim < 1 ) {
	this->mdarray::init(DCOMPLEX_ZT, auto_resize);
    }
    else {
	size_t i;
	this->mdarray::init(DCOMPLEX_ZT, auto_resize, this->dinfo_dlen, ndim, true);
	i = 0;
	if ( i < this->length() ) this->dx(i) = v0;
	i++;
	for ( ; i < this->length() ; i++ ) {
	    this->dx(i) = va_arg(ap,dcomplex);
	}
    }
    return *this;
}
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::init( const mdarray &obj )
{
    debug_report("( const mdarray &obj )");
 ...
 *            
 */
mdarray_dcomplex &mdarray_dcomplex::init_properties( const mdarray &src_obj )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::set_auto_resize( bool tf )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::set_auto_init( bool tf )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::set_rounding( bool tf )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::set_alloc_strategy( const char *strategy )
{
...
{
    mdarray_dcomplex *this_p = (mdarray_dcomplex *)p;
    dcomplex v0 = *((const dcomplex *)v0p);
    *((dcomplex *)v1p) = (*(this_p->convert_func_rec))(v0, this_p->convert_user_ptr_rec);
}
*/

/*
mdarray_dcomplex &mdarray_dcomplex::convert( dcomplex (*func)(dcomplex,void *),
				       void *user_ptr )
{
    this->convert_func_rec = func;
    this->convert_user_ptr_rec = user_ptr;
    this->mdarray::convert(DCOMPLEX_ZT, &fnc_for_convert, (void *)this);
    return *this;
}
*/
 ...
 * @throw      内部バッファの確保に失敗した場合
 */
mdarray_dcomplex &mdarray_dcomplex::convert_via_udf( void (*func)(const dcomplex *,dcomplex *,size_t,int,void *),
				       void *user_ptr )
{
    this->mdarray::convert_via_udf(DCOMPLEX_ZT,
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::swap( mdarray &sobj )
{
 ...
 *  dest には，mdarray_dcomplex クラスのオブジェクトあるいは mdarray クラスの
 ...
 *
 */
ssize_t mdarray_dcomplex::copy( mdarray *dest ) const
{
 ...
 * @deprecated 非推奨．<br>
 * ssize_t mdarray_dcomplex::copy( mdarray *dest ) const <br>
 * をお使いください．
 */
ssize_t mdarray_dcomplex::copy( mdarray &dest ) const
{
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_dcomplex &mdarray_dcomplex::cut( mdarray *dest )
{
    debug_report("( mdarray *dest )");
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::transpose_xy()
{
 ...
 * @note  高速なアルゴリズムを使用しています．
 */
mdarray_dcomplex &mdarray_dcomplex::transpose_xyz2zxy()
{
 ...
 * 
 */
mdarray_dcomplex &mdarray_dcomplex::rotate_xy( int angle )
{
 ...
 *
 */
ssize_t mdarray_dcomplex::get_elements( dcomplex *dest_buf, size_t elem_size, 
 ...
 *
 */
ssize_t mdarray_dcomplex::put_elements( const dcomplex *src_buf, size_t elem_size,
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::increase_dim()
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::decrease_dim()
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::resize( size_t len )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::resize( size_t dim_index, size_t len )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::resize( const mdarray &src )
{
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::resize_1d( size_t x_len )
{
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::resize_2d( size_t x_len, size_t y_len )
{
 ...
 *  します．
 */
mdarray_dcomplex &mdarray_dcomplex::resize_3d( size_t x_len, size_t y_len, size_t z_len )
{
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::resize( const size_t naxisx[], size_t ndim, bool init_buf )
{
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_dcomplex &mdarray_dcomplex::resizef( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_dcomplex &mdarray_dcomplex::vresizef( const char *exp_fmt, va_list ap )
{
    this->mdarray::vresizef(exp_fmt,ap);
    return *this;
}
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::resizeby( ssize_t len )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::resizeby( size_t dim_index, ssize_t len )
{
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::resizeby_1d( ssize_t x_len )
{
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::resizeby_2d( ssize_t x_len, ssize_t y_len )
{
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::resizeby_3d(ssize_t x_len, ssize_t y_len, ssize_t z_len)
{
 ...
 * @throw     内部バッファの確保に失敗した場合
 */
mdarray_dcomplex &mdarray_dcomplex::resizeby( const ssize_t naxisx_rel[], size_t ndim, 
			    bool init_buf )
{
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_dcomplex &mdarray_dcomplex::resizebyf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_dcomplex &mdarray_dcomplex::vresizebyf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vresizebyf(exp_fmt,ap);
    return *this;
}
 ...
 * @throw     内部バッファの確保に失敗した場合
 */
mdarray_dcomplex &mdarray_dcomplex::reallocate( const size_t naxisx[], size_t ndim, bool init_buf )
{
 ...
 * @throw    内部バッファの確保に失敗した場合
 */
mdarray_dcomplex &mdarray_dcomplex::allocate( const size_t naxisx[], size_t ndim, bool init_buf )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::assign_default( dcomplex value )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::insert( ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::insert( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::erase( ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::erase( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::move( ssize_t idx_src, size_t len, ssize_t idx_dst,
			   bool clr )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::move( size_t dim_index, 
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::cpy( ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::cpy( size_t dim_index, 
			  ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::swap( ssize_t idx_src, size_t len, ssize_t idx_dst )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::swap( size_t dim_index, 
		      ssize_t idx_src, size_t len, ssize_t idx_dst )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::crop( ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::crop( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 * @deprecated 未実装です.
 */
mdarray_dcomplex &mdarray_dcomplex::cropf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @deprecated 未実装です.
 */
mdarray_dcomplex &mdarray_dcomplex::vcropf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vcropf(exp_fmt,ap);
    return *this;
}
 ...
 * @return    自身の参照
 */
mdarray_dcomplex &mdarray_dcomplex::flip( ssize_t idx, size_t len )
{
 ...
 * @return    自身の参照
 */
mdarray_dcomplex &mdarray_dcomplex::flip( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
ssize_t mdarray_dcomplex::copyf( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
ssize_t mdarray_dcomplex::vcopyf( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 * @deprecated  未実装
 */
ssize_t mdarray_dcomplex::convertf_copy( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @deprecated  未実装
 */
ssize_t mdarray_dcomplex::vconvertf_copy( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_dcomplex &mdarray_dcomplex::trimf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_dcomplex &mdarray_dcomplex::vtrimf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vtrimf(exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::flipf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  任意の次元(複数も可)で配列の並びを反転 (IDLの記法)
 */
mdarray_dcomplex &mdarray_dcomplex::vflipf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vflipf(exp_fmt, ap);
    return *this;
}
 ...
 */
ssize_t mdarray_dcomplex::transposef_xy_copy( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @brief  (x,y)のトランスポーズを行なった配列を取得 (IDLの記法)
 */
ssize_t mdarray_dcomplex::vtransposef_xy_copy( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 */
ssize_t mdarray_dcomplex::transposef_xyz2zxy_copy( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @brief  (x,y,z)→(z,x,y)のトランスポーズを行なった配列を取得 (IDLの記法)
 */
ssize_t mdarray_dcomplex::vtransposef_xyz2zxy_copy( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::cleanf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列をデフォルト値でパディング (IDLの記法)
 */
mdarray_dcomplex &mdarray_dcomplex::vcleanf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vcleanf(exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::fillf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を指定されたスカラー値で書き換え (IDLの記法)
 */
mdarray_dcomplex &mdarray_dcomplex::vfillf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vfillf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::fillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_dcomplex *,void *),
 ...
 * @brief  自身の配列をスカラー値で書き換え (ユーザ関数経由・IDLの記法)
 */
mdarray_dcomplex &mdarray_dcomplex::vfillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_dcomplex *,void *),
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::addf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたスカラー値で加算 (IDLの記法)
 */
mdarray_dcomplex &mdarray_dcomplex::vaddf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vaddf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::subtractf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を，指定されたスカラー値で減算 (IDLの記法)
 */
mdarray_dcomplex &mdarray_dcomplex::vsubtractf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vsubtractf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::multiplyf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたスカラー値を乗算 (IDLの記法)
 */
mdarray_dcomplex &mdarray_dcomplex::vmultiplyf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vmultiplyf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::dividef( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を，指定されたスカラー値で除算 (IDLの記法)
 */
mdarray_dcomplex &mdarray_dcomplex::vdividef( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vdividef(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::pastef( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に指定されたオブジェクトの配列を貼り付け (IDLの記法)
 */
mdarray_dcomplex &mdarray_dcomplex::vpastef( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vpastef(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::pastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_dcomplex *,void *),
	void *user_ptr,
        const char *exp_fmt, ... )
{
 ...
 * @brief  自身の配列に指定された配列を貼り付け (ユーザ関数経由・IDLの記法)
 */
mdarray_dcomplex &mdarray_dcomplex::vpastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_dcomplex *,void *),
	void *user_ptr,
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::addf( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたオブジェクトの配列を加算 (IDLの記法)
 */
mdarray_dcomplex &mdarray_dcomplex::vaddf( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vaddf(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::subtractf( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief 自身の配列を，指定されたオブジェクトの配列で減算 (IDLの記法)
 */
mdarray_dcomplex &mdarray_dcomplex::vsubtractf( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vsubtractf(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::multiplyf( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたオブジェクトの配列を乗算 (IDLの記法)
 */
mdarray_dcomplex &mdarray_dcomplex::vmultiplyf( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vmultiplyf(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::dividef( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を，指定されたオブジェクトの配列で除算 (IDLの記法)
 */
mdarray_dcomplex &mdarray_dcomplex::vdividef( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vdividef(src, exp_fmt, ap);
    return *this;
}
 ...
 *
 */
ssize_t mdarray_dcomplex::copy( mdarray *dest,
 ...
 * @deprecated  未実装
 */
ssize_t mdarray_dcomplex::convert_copy( mdarray *dest,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::move_from(ssize_t col_idx, size_t col_len,
					  ssize_t row_idx, size_t row_len, 
 ...
 */
mdarray_dcomplex &mdarray_dcomplex::move_to( 
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_dcomplex &mdarray_dcomplex::trim( ssize_t col_idx, size_t col_len,
				      ssize_t row_idx, size_t row_len, 
				      ssize_t layer_idx, size_t layer_len )
{
 ...
 * @return    自身の参照
 */
mdarray_dcomplex &mdarray_dcomplex::flip_cols( ssize_t col_idx, size_t col_len,
					  ssize_t row_idx, size_t row_len, 
					  ssize_t layer_idx, size_t layer_len )
{
 ...
 * @return    自身の参照
 */
mdarray_dcomplex &mdarray_dcomplex::flip_rows( ssize_t col_idx, size_t col_len,
					  ssize_t row_idx, size_t row_len, 
					  ssize_t layer_idx, size_t layer_len )
{
 ...
 */
ssize_t mdarray_dcomplex::transpose_xy_copy( mdarray *dest,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 */
ssize_t mdarray_dcomplex::transpose_xyz2zxy_copy( mdarray *dest,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 */
ssize_t mdarray_dcomplex::rotate_xy_copy( mdarray *dest, int angle,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::clean( ssize_t col_index, size_t col_size,
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::fill( double value, 
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::fill_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_dcomplex *,void *),
	void *user_ptr,
	ssize_t col_index, size_t col_size,
	ssize_t row_index, size_t row_size,
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::add( double value, 
		    ssize_t col_index, size_t col_size,
		    ssize_t row_index, size_t row_size,
		    ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::subtract( double value, 
				       ssize_t col_index, size_t col_size,
				       ssize_t row_index, size_t row_size,
				       ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::multiply( double value, 
		    ssize_t col_index, size_t col_size,
		    ssize_t row_index, size_t row_size,
		    ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::divide( double value, 
				       ssize_t col_index, size_t col_size,
				       ssize_t row_index, size_t row_size,
				       ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::paste( const mdarray &src,
	ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::paste_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t,ssize_t,ssize_t,ssize_t,mdarray_dcomplex *,void *),
	void *user_ptr,
	ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::add( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::subtract( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::multiply( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::divide( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *             ます．
 */
mdarray_dcomplex &mdarray_dcomplex::register_extptr( dcomplex **extptr_address )
{
    this->mdarray::register_extptr((void *)extptr_address);
    return *this;
}
 ...
 *             ます．
 */
mdarray_dcomplex &mdarray_dcomplex::register_extptr_2d( dcomplex *const **extptr2d_address )
{
    this->mdarray::register_extptr_2d((void *)extptr2d_address);
    return *this;
}
 ...
 *             ます．
 */
mdarray_dcomplex &mdarray_dcomplex::register_extptr_3d( dcomplex *const *const **extptr3d_address )
{
    this->mdarray::register_extptr_3d((void *)extptr3d_address);
    return *this;
}
 ...
 *
 */
mdarray_dcomplex &mdarray_dcomplex::reverse_endian( bool is_little_endian )
{
 ...
 * 
 * @return  型種別 (固定値: dcomplex)
 * @note    このメンバ関数はprotectedです．
 */
ssize_t mdarray_dcomplex::default_size_type()
{
    return DCOMPLEX_ZT;
}
 ...
 * 
 * @param   sz_type 型種別
 * @return  受け入れ可能な型(dcomplex)なら真
 * @note    このメンバ関数はprotectedです．
 */
bool mdarray_dcomplex::is_acceptable_size_type( ssize_t sz_type )
{
    if ( sz_type == DCOMPLEX_ZT ) return true;
    else return false;
}
