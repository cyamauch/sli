...
#ifndef _SLI__MDARRAY_INT64_H
#define _SLI__MDARRAY_INT64_H 1

/**
 * @file   mdarray_int64.h
 * @brief  int64_t型の多次元配列を扱う mdarray_int64 クラスのヘッダファイル
 */
...
/*
 * sli::mdarray_int64 is an inherited class of sli::mdarray, and is a 
...
/**
 * @class  sli::mdarray_int64
 * @brief  int64_t型の多次元配列を扱うためのクラス
 *
 *   mdarray_int64クラスは，int64_t型の多次元配列を IDL や Python のように
 ...
 * 
 * @note  mdarray_int64クラスは mdarray(基底クラス) を継承しています．<br>
 *        SIMD命令(SSE2)により，基本的な部分が高速化されています．
 * @author  Chisato YAMAUCHI
 * @date  2013-04-01 00:00:00
 */

  class mdarray_int64 : public mdarray
  {

  public:
    /* constructor                                                           */
    /* The mdarray_int64 class has two kinds of operating modes:            */
    ...
    mdarray_int64();
    mdarray_int64( bool auto_resize );
    mdarray_int64( bool auto_resize, int64_t **extptr_address );
    mdarray_int64( bool auto_resize, int64_t *const **extptr2d_address );
    mdarray_int64( bool auto_resize, int64_t *const *const **extptr3d_address );
    mdarray_int64( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf );
    mdarray_int64( bool auto_resize, size_t naxis0 );
    mdarray_int64( bool auto_resize, size_t naxis0, size_t naxis1 );
    mdarray_int64( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 );
    mdarray_int64( bool auto_resize, size_t naxis0, 
		   const int64_t vals[] );
    mdarray_int64( bool auto_resize, size_t naxis0, size_t naxis1,
		   const int64_t vals[] );
...
#if 0
    mdarray_int64( bool auto_resize, const char *dim_info, int64_t v0, ... );
#endif
    mdarray_int64( const mdarray_int64 &obj );


    /* --------------------------------------------------------------------- */

    /* `virtual' がついてるものはオーバーライドではなくオーバーロード     */
    /*   mdarray_int64 &operator=(const mdarray_int64 &obj);            */
    /* が隠れて存在する事に注意 (演算子 = だけは，特別な規則があるらしい) */

    /* substitute an array (copy the attribute, too)                      */
    virtual mdarray_int64 &operator=(const mdarray &obj);

    /* (overridden) */
    mdarray_int64 &operator+=(const mdarray &obj);
    mdarray_int64 &operator-=(const mdarray &obj);
    mdarray_int64 &operator*=(const mdarray &obj);
    mdarray_int64 &operator/=(const mdarray &obj);

    /* (overridden) */
    mdarray_int64 &operator=(dcomplex v);
    mdarray_int64 &operator=(double v);
    mdarray_int64 &operator=(long long v);
    mdarray_int64 &operator=(long v);
    mdarray_int64 &operator=(int v);
    mdarray_int64 &operator+=(dcomplex v);
    mdarray_int64 &operator+=(double v);
    mdarray_int64 &operator+=(long long v);
    mdarray_int64 &operator+=(long v);
    ...
    */
    ...
    /* <overloaded>                */
    virtual mdarray_int64 &init( bool auto_resize );
    virtual mdarray_int64 &init( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf );
    virtual mdarray_int64 &init( bool auto_resize, size_t naxis0 );
    virtual mdarray_int64 &init( bool auto_resize, size_t naxis0, size_t naxis1 );
    virtual mdarray_int64 &init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 );
    virtual mdarray_int64 &init( bool auto_resize, size_t naxis0, 
				 const int64_t vals[] );
    virtual mdarray_int64 &init( bool auto_resize, size_t naxis0, size_t naxis1,
				 const int64_t vals[] );
    ...
    virtual mdarray_int64 &init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2,
				 const int64_t *const *const vals[] );
#if 0
    virtual mdarray_int64 &init( bool auto_resize, const char *dim_info,
				 int64_t v0, ... );
    virtual mdarray_int64 &vinit( bool auto_resize, const char *dim_info,
				  int64_t v0, va_list );
#endif
    /*  mdarray_int64 &init( const mdarray &obj ); が隠れている */
    /*  (↑mdarrayクラスのポインタ経由で呼び出し可能)            */

    /* (overridden)                                           */
    mdarray_int64 &init( const mdarray &obj );

    /* copy properties (auto_resize, auto_init, and rounding) */
    /* (overridden)                                           */
    mdarray_int64 &init_properties( const mdarray &src_obj );

    /* setting of the resize mode */
    /* (overridden)               */
    mdarray_int64 &set_auto_resize( bool tf );

    /* setting of the initialize mode */
    /* (overridden)                   */
    mdarray_int64 &set_auto_init( bool tf );

    /* setting of the rounding off possibility */
    /* (overridden)                            */
    mdarray_int64 &set_rounding( bool tf );

    /* setting of strategy of memory allocation */
    /* "auto", "min" and "pow" can be set.      */
    /* (overridden)                             */
    mdarray_int64 &set_alloc_strategy( const char *strategy );

    /* convert the value of the full array element */
    /* <overloaded>                                */
    virtual mdarray_int64 &convert_via_udf(
		void (*func)(const int64_t *,int64_t *,size_t,int,void *),
		void *user_ptr );

    /* swap contents between self and another objects */
    /* (overridden)                 */
    mdarray_int64 &swap( mdarray &sobj );
    ...
    /* (overridden)                             */
    mdarray_int64 &cut( mdarray *dest );

    /* interchange rows and columns */
    /* (overridden)                 */
    mdarray_int64 &transpose_xy();

    /* interchange xyz to zxy */
    /* (overridden)           */
    mdarray_int64 &transpose_xyz2zxy();

    /* rotate image                                              */
    /*   angle: 90,-90, or 180                                   */
    /*          (anticlockwise when image is bottom-left origin) */
    /* (overridden)                                              */
    mdarray_int64 &rotate_xy( int angle );
    ...
    */
    ...
    /* (overridden)                                          */
    mdarray_int64 &assign( dcomplex value,
			    ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF,
			    ssize_t idx2 = MDARRAY_INDEF );
    mdarray_int64 &assign( double value, 
			    ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF,
			    ssize_t idx2 = MDARRAY_INDEF );

    /* a reference to the specified value of the element (1 dimension) */
    virtual int64_t &operator[]( ssize_t idx0 );
    virtual const int64_t &operator[]( ssize_t idx0 ) const;

    /* a reference to the specified value of the element (1-3 dimensions) */
    virtual int64_t &operator()( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				ssize_t idx2 = MDARRAY_INDEF);
    virtual const int64_t &operator()( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				ssize_t idx2 = MDARRAY_INDEF) const;

    /* a reference to the specified value of the element (1-3 dimensions) */
    virtual int64_t &at( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
			  ssize_t idx2 = MDARRAY_INDEF);
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const int64_t &at( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				 ssize_t idx2 = MDARRAY_INDEF) const;
#endif
    virtual const int64_t &at_cs( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				 ssize_t idx2 = MDARRAY_INDEF) const;
    ...
    /* <overloaded>                                */
    virtual mdarray_int64 &put( int64_t value, ssize_t idx, size_t len );
    virtual mdarray_int64 &put( int64_t value,
				size_t dim_index, ssize_t idx, size_t len );

    /* copy the array stored in object into the programmer's buffer. */
    /* <overloaded>                                                  */
    virtual ssize_t get_elements( int64_t *dest_buf, size_t elem_size, 
				ssize_t idx0 = 0, ssize_t idx1 = MDARRAY_INDEF,
				ssize_t idx2 = MDARRAY_INDEF ) const;

    /* copy the array in the programmer's buffer into object's buffer. */
    /* <overloaded>                                                    */
    virtual ssize_t put_elements( const int64_t *src_buf, size_t elem_size,
				ssize_t idx0 = 0, ssize_t idx1 = MDARRAY_INDEF,
				ssize_t idx2 = MDARRAY_INDEF );
    ...
    /* (overridden)                      */
    mdarray_int64 &increase_dim();

    /* reduction of the dimension number */
    /* (overridden)                      */
    mdarray_int64 &decrease_dim();

    /* change the length of the array */
    /* (overridden)                   */
    mdarray_int64 &resize( size_t len );
    mdarray_int64 &resize( size_t dim_index, size_t len );
    mdarray_int64 &resize( const mdarray &src );

    /* change the length of the 1-d array */
    /* (overridden)                       */
    mdarray_int64 &resize_1d( size_t x_len );

    /* change the length of the 2-d array */
    /* (overridden)                       */
    mdarray_int64 &resize_2d( size_t x_len, size_t y_len );

    /* change the length of the 3-d array */
    /* (overridden)                       */
    mdarray_int64 &resize_3d( size_t x_len, size_t y_len, size_t z_len );

    /* change the length of the array (supports n-dim) */
    /* (overridden)                                    */
    mdarray_int64 &resize( const size_t naxisx[], size_t ndim, 
			    bool init_buf );
    ...
    /* (overridden)                                                   */
    mdarray_int64 &resizef( const char *exp_fmt, ... );
    mdarray_int64 &vresizef( const char *exp_fmt, va_list ap );

    /* change the length of the array relatively */
    /* (overridden)                              */
    mdarray_int64 &resizeby( ssize_t len );			/* for 1-d */
    mdarray_int64 &resizeby( size_t dim_index, ssize_t len );

    /* change the length of the 1-d array relatively */
    /* (overridden)                                  */
    mdarray_int64 &resizeby_1d( ssize_t x_len );

    /* change the length of the 2-d array relatively */
    /* (overridden)                                  */
    mdarray_int64 &resizeby_2d( ssize_t x_len, ssize_t y_len );

    /* change the length of the 3-d array relatively */
    /* (overridden)                                  */
    mdarray_int64 &resizeby_3d(ssize_t x_len, ssize_t y_len, ssize_t z_len);
    ...
    /* (overridden)                                                         */
    mdarray_int64 &resizeby( const ssize_t naxisx_rel[], size_t ndim, 
			       bool init_buf );
    ...
    /* length of first dimension.                                      */
    /* (overridden)                                                    */
    mdarray_int64 &resizebyf( const char *exp_fmt, ... );
    mdarray_int64 &vresizebyf( const char *exp_fmt, va_list ap );

    /* change length of array without adjusting buffer contents */
    /* (overridden)                                             */
    mdarray_int64 &reallocate( const size_t naxisx[], size_t ndim, 
				bool init_buf );

    /* free current buffer and alloc new memory */
    /* (overridden)                             */
    mdarray_int64 &allocate( const size_t naxisx[], size_t ndim, 
			      bool init_buf );

    /* setting of the initial value for .resize(), etc. */
    /* <overloaded>                                     */
    virtual mdarray_int64 &assign_default( int64_t value );

    /* insert a blank section */
    /* (overridden)           */
    mdarray_int64 &insert( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_int64 &insert( size_t dim_index, ssize_t idx, size_t len );

    /* erase a section */
    /* (overridden)    */
    mdarray_int64 &erase( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_int64 &erase( size_t dim_index, ssize_t idx, size_t len );

    /* copy values between elements (without automatic resizing) */
    /* 移動 (バッファのサイズは変更しない)                       */
    /* (overridden)                                              */
    mdarray_int64 &move( ssize_t idx_src, size_t len, ssize_t idx_dst,
			   bool clr );				/* for 1-d */
    mdarray_int64 &move( size_t dim_index, 
    ...
    /* (overridden)                                           */
    mdarray_int64 &cpy( ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr );				/* for 1-d */
    mdarray_int64 &cpy( size_t dim_index, 
			  ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr );

    /* replace values between elements */
    /* (overridden)                    */
    mdarray_int64 &swap( ssize_t idx_src, size_t len, 
			  ssize_t idx_dst );			/* for 1-d */
    mdarray_int64 &swap( size_t dim_index, 
			   ssize_t idx_src, size_t len, ssize_t idx_dst );

    /* extract a section           */
    /* see also trimf() and trim() */
    /* (overridden)                */
    mdarray_int64 &crop( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_int64 &crop( size_t dim_index, ssize_t idx, size_t len );

    /* flip a section   */
    /* see also flipf() */
    /* (overridden)     */
    mdarray_int64 &flip( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_int64 &flip( size_t dim_index, ssize_t idx, size_t len );
    ...
    */
    ...
    /* Flipping elements is supported */
    /* (overridden)                   */
    mdarray_int64 &trimf( const char *exp_fmt, ... );
    mdarray_int64 &vtrimf( const char *exp_fmt, va_list ap );

    /* flip elements in a section */
    /* (overridden)               */
    mdarray_int64 &flipf( const char *exp_fmt, ... );
    mdarray_int64 &vflipf( const char *exp_fmt, va_list ap );
    ...
    /* (overridden)                        */
    mdarray_int64 &cleanf( const char *exp_fmt, ... );
    mdarray_int64 &vcleanf( const char *exp_fmt, va_list ap );

    /* rewrite element values with a value in a section */
    /* (overridden)                                     */
    mdarray_int64 &fillf( double value, const char *exp_fmt, ... );
    mdarray_int64 &vfillf( double value, const char *exp_fmt, va_list ap );

    /* <overloaded>                                     */
    virtual mdarray_int64 &fillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_int64 *,void *),
        void *user_ptr, const char *exp_fmt, ... );
    virtual mdarray_int64 &vfillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_int64 *,void *),
        void *user_ptr, const char *exp_fmt, va_list ap );

    /* add a scalar value to element values in a section */
    /* (overridden)                                      */
    mdarray_int64 &addf( double value, 
			  const char *exp_fmt, ... );
    mdarray_int64 &vaddf( double value, 
			   const char *exp_fmt, va_list ap );

    /* subtract a scalar value from element values in a section */
    /* (overridden)                                             */
    mdarray_int64 &subtractf( double value, 
			       const char *exp_fmt, ... );
    mdarray_int64 &vsubtractf( double value, 
				const char *exp_fmt, va_list ap );

    /* multiply element values in a section by a scalar value */
    /* (overridden)                                           */
    mdarray_int64 &multiplyf( double value, 
			       const char *exp_fmt, ... );
    mdarray_int64 &vmultiplyf( double value, 
				const char *exp_fmt, va_list ap );

    /* divide element values in a section by a scalar value */
    /* (overridden)                                         */
    mdarray_int64 &dividef( double value, 
			     const char *exp_fmt, ... );
    mdarray_int64 &vdividef( double value, 
			      const char *exp_fmt, va_list ap );
    ...
    /* (overridden)                                                          */
    mdarray_int64 &pastef( const mdarray &src,
			    const char *exp_fmt, ... );
    mdarray_int64 &vpastef( const mdarray &src,
			     const char *exp_fmt, va_list ap );
    ...
    /*   8. user pointer                                                     */
    /* <overloaded>                                                          */
    virtual mdarray_int64 &pastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_int64 *,void *),
	void *user_ptr,
        const char *exp_fmt, ... );
    virtual mdarray_int64 &vpastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_int64 *,void *),
	void *user_ptr,
        const char *exp_fmt, va_list ap );
    ...
    /* add an array object */
    /* (overridden)        */
    mdarray_int64 &addf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_int64 &vaddf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* subtract an array object */
    /* (overridden)             */
    mdarray_int64 &subtractf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_int64 &vsubtractf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* multiply an array object */
    /* (overridden)             */
    mdarray_int64 &multiplyf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_int64 &vmultiplyf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* divide an array object */
    /* (overridden)           */
    mdarray_int64 &dividef( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_int64 &vdividef( const mdarray &src_img, const char *exp_fmt, va_list ap );
    ...
    */
    ...
    /* rewrite element values with a value in a section */
    /* (overridden)                                     */
    mdarray_int64 &fill( double value,
			 ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
			 ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
			 ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );

    /* <overloaded>                                     */
    virtual mdarray_int64 &fill_via_udf( double value,
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_int64 *,void *),
	void *user_ptr,
	ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
	ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
    ...
    /* add a scalar value to element values in a section */
    /* (overridden)                                      */
    mdarray_int64 &add( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* subtract a scalar value from element values in a section */
    /* (overridden)                                             */
    mdarray_int64 &subtract( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* multiply element values in a section by a scalar value */
    /* (overridden)                                           */
    mdarray_int64 &multiply( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* divide element values in a section by a scalar value */
    /* (overridden)                                         */
    mdarray_int64 &divide( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* paste up an array object */
    /* (overridden)             */
    mdarray_int64 &paste( const mdarray &src,
	ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* <overloaded>             */
    virtual mdarray_int64 &paste_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t,ssize_t,ssize_t,ssize_t,mdarray_int64 *,void *),
	void *user_ptr,
	ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );
    ...
    /* add an array object */
    /* (overridden)        */
    mdarray_int64 &add( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* subtract an array object */
    /* (overridden)             */
    mdarray_int64 &subtract( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* multiply an array object */
    /* (overridden)             */
    mdarray_int64 &multiply( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* divide an array object */
    /* (overridden)           */
    mdarray_int64 &divide( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );
    ...
    */
    ...
    /* <overloaded>                                                    */
    virtual mdarray_int64 &register_extptr( int64_t **extptr_address );
    virtual mdarray_int64 &register_extptr_2d( int64_t *const **extptr2d_address );
    virtual mdarray_int64 &register_extptr_3d( int64_t *const *const **extptr3d_address );

    /* Acquire the specified element's address */
    virtual const int64_t *carray() const;
    virtual const int64_t *carray( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
    virtual int64_t *array_ptr();
    virtual int64_t *array_ptr( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF );
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const int64_t *array_ptr() const;
    virtual const int64_t *array_ptr( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
#endif
    virtual const int64_t *array_ptr_cs() const;
    virtual const int64_t *array_ptr_cs( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
    ...
    virtual int64_t *const *array_ptr_2d( bool use );
    /* followings have no overhead. Execute .array_ptr_2d(true) before use. */
    virtual int64_t *const *array_ptr_2d();
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const int64_t *const *array_ptr_2d() const;
#endif
    virtual const int64_t *const *array_ptr_2d_cs() const;
    ...
    /*        "use=false" when there is no requirement of referring         */
    /*        obtained address table.                                       */
    virtual int64_t *const *const *array_ptr_3d( bool use );
    /* followings have no overhead. Execute .array_ptr_3d(true) before use. */
    virtual int64_t *const *const *array_ptr_3d();
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const int64_t *const *const *array_ptr_3d() const;
#endif
    virtual const int64_t *const *const *array_ptr_3d_cs() const;
    ...
    */
    ...
    /* (overridden)                    */
    mdarray_int64 &reverse_endian( bool is_little_endian );
    /* (overridden)                    */
    mdarray_int64 &reverse_endian( bool is_little_endian, 
				    size_t begin, size_t length );

    /* acquisition of the initial value */
    virtual int64_t default_value() const;
 ...
 *
 */
inline mdarray_int64 &mdarray_int64::put( int64_t value, ssize_t idx, size_t len )
{
 ...
 *
 */
inline mdarray_int64 &mdarray_int64::put( int64_t value,
				    size_t dim_index, ssize_t idx, size_t len )
{
 ...
 */
inline mdarray_int64 &mdarray_int64::assign( dcomplex value,
 ...
 *
 */
inline mdarray_int64 &mdarray_int64::assign( double value, 
				     ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
    this->mdarray::assign(value, idx0, idx1, idx2);
    return *this;
 ...
 *
 */
inline int64_t &mdarray_int64::operator[]( ssize_t idx0 )
{
    return ((0 <= idx0 && idx0 < (ssize_t)this->length()) ? 
	    ((int64_t *)(this->data_ptr()))[idx0] :
	    this->at(idx0));
}
 ...
 *
 */
inline const int64_t &mdarray_int64::operator[]( ssize_t idx0 ) const
{
    return ((0 <= idx0 && idx0 < (ssize_t)this->length()) ? 
	    ((const int64_t *)(this->data_ptr_cs()))[idx0] :
	    this->at_cs(idx0));
}
 ...
 *
 */
inline int64_t &mdarray_int64::operator()( ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
 ...
 *
 */
inline const int64_t &mdarray_int64::operator()( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
 ...
 *
 */
inline int64_t &mdarray_int64::at( ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
    ssize_t idx = this->get_idx_3d(idx0,idx1,idx2);
    if ( 0 <= idx ) {
	return ((int64_t *)(this->data_ptr()))[idx];
    }
    else {
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const int64_t &mdarray_int64::at( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
    return this->at_cs(idx0, idx1, idx2);
}
#endif
 ...
 *
 */
inline const int64_t &mdarray_int64::at_cs( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
    ssize_t idx = this->get_idx_3d_cs(idx0,idx1,idx2);
    if ( 0 <= idx ) {
	return ((const int64_t *)(this->data_ptr()))[idx];
    }
    else {
	int64_t *p = (int64_t *)(this->junk_rec);
	*p = INDEF_INT64;
 ...
 *
 */
inline mdarray_int64 &mdarray_int64::ceil()
{
    this->mdarray::ceil();
    return *this;
}
 ...
 *
 */
inline mdarray_int64 &mdarray_int64::floor()
{
    this->mdarray::floor();
    return *this;
}
 ...
 *
 */
inline mdarray_int64 &mdarray_int64::round()
{
    this->mdarray::round();
    return *this;
}
 ...
 *
 */
inline mdarray_int64 &mdarray_int64::trunc()
{
    this->mdarray::trunc();
    return *this;
}
 ...
 *
 */
inline mdarray_int64 &mdarray_int64::abs()
{
    this->mdarray::abs();
    return *this;
}
 ...
 *
 */
inline const int64_t *mdarray_int64::carray() const
{
    return (const int64_t *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const int64_t *mdarray_int64::carray( ssize_t idx0, 
				     ssize_t idx1, ssize_t idx2 ) const
{
    return (const int64_t *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *
 */
inline int64_t *mdarray_int64::array_ptr()
{
    return (int64_t *)(this->data_ptr());
}
 ...
 *
 */
inline int64_t *mdarray_int64::array_ptr( ssize_t idx0, 
				  ssize_t idx1, ssize_t idx2 )
{
    return (int64_t *)(this->data_ptr(idx0,idx1,idx2));
}
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const int64_t *mdarray_int64::array_ptr() const
{
    return (const int64_t *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const int64_t *mdarray_int64::array_ptr( ssize_t idx0, 
					   ssize_t idx1, ssize_t idx2 ) const
{
    return (const int64_t *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *
 */
inline const int64_t *mdarray_int64::array_ptr_cs() const
{
    return (const int64_t *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const int64_t *mdarray_int64::array_ptr_cs( ssize_t idx0, 
					   ssize_t idx1, ssize_t idx2 ) const
{
    return (const int64_t *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *             使用しない場合はfalse(機能off)．
 */
inline int64_t *const *mdarray_int64::array_ptr_2d( bool use )
{
    return (int64_t *const *)(this->mdarray::data_ptr_2d(use));
}

/**
 * @brief  内部で生成された2次元配列用ポインタ配列のアドレスを取得
 */
inline int64_t *const *mdarray_int64::array_ptr_2d()
{
    return (int64_t *const *)(this->mdarray::data_ptr_2d());
}
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const int64_t *const *mdarray_int64::array_ptr_2d() const
{
    return (const int64_t *const *)(this->mdarray::data_ptr_2d_cs());
}
#endif
 ...
 * @brief  内部で生成された2次元配列用ポインタ配列のアドレスを取得 (読取専用)
 */
inline const int64_t *const *mdarray_int64::array_ptr_2d_cs() const
{
    return (const int64_t *const *)(this->mdarray::data_ptr_2d_cs());
}
 ...
 *             使用しない場合はfalse(機能off)．
 */
inline int64_t *const *const *mdarray_int64::array_ptr_3d( bool use )
{
    return (int64_t *const *const *)(this->mdarray::data_ptr_3d(use));
}

/**
 * @brief  内部で生成された3次元配列用ポインタ配列のアドレスを取得
 */
inline int64_t *const *const *mdarray_int64::array_ptr_3d()
{
    return (int64_t *const *const *)(this->mdarray::data_ptr_3d());
}
 ...
 */
inline const int64_t *const *const *mdarray_int64::array_ptr_3d() const
{
    return (const int64_t *const *const *)(this->mdarray::data_ptr_3d_cs());
}
#endif
 ...
 * @brief  内部で生成された3次元配列用ポインタ配列のアドレスを取得 (読取専用)
 */
inline const int64_t *const *const *mdarray_int64::array_ptr_3d_cs() const
{
    return (const int64_t *const *const *)(this->mdarray::data_ptr_3d_cs());
}
 ...
 *
 */
inline int64_t mdarray_int64::default_value() const
{
    const int64_t *p = (const int64_t *)(this->default_value_ptr());
    if ( p == NULL ) return 0;
    else return *p;
}
