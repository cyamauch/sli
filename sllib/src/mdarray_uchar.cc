...
/**
 * @file   mdarray_uchar.cc
 * @brief  unsigned char型の多次元配列を扱う mdarray_uchar クラスのコード
 */

#define CLASS_NAME "mdarray_uchar"
 ...
 */
mdarray_uchar::mdarray_uchar()
{
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)UCHAR_ZT, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_uchar::mdarray_uchar( bool auto_r )
{
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)UCHAR_ZT, auto_r);
    return;
}
 ...
 *             ます．
 */
mdarray_uchar::mdarray_uchar( bool auto_r, unsigned char **extptr_address )
{
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)UCHAR_ZT, auto_r);
 ...
 *             ます．
 */
mdarray_uchar::mdarray_uchar( bool auto_r, unsigned char *const **extptr2d_address )
{
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)UCHAR_ZT, auto_r);
 ...
 *             ます．
 */
mdarray_uchar::mdarray_uchar( bool auto_r, unsigned char *const *const **extptr3d_address )
{
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)UCHAR_ZT, auto_r);
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_uchar::mdarray_uchar( bool auto_r, const size_t naxisx[], size_t ndim, bool init_buf )
{
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)UCHAR_ZT, auto_r, naxisx, ndim, init_buf);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
*/
mdarray_uchar::mdarray_uchar( bool auto_r, size_t naxis0 )
{
    const size_t naxisx[] = {naxis0};
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)UCHAR_ZT, auto_r, naxisx, 1, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_uchar::mdarray_uchar( bool auto_r, size_t naxis0, size_t naxis1 )
{
    const size_t naxisx[] = {naxis0, naxis1};
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)UCHAR_ZT, auto_r, naxisx, 2, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_uchar::mdarray_uchar( bool auto_r, size_t naxis0, size_t naxis1, size_t naxis2 )
{
    const size_t naxisx[] = {naxis0, naxis1, naxis2};
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)UCHAR_ZT, auto_r, naxisx, 3, true);
    return;
}
 ...
 */
mdarray_uchar::mdarray_uchar( bool auto_r, size_t naxis0, size_t naxis1, size_t naxis2,
			      const unsigned char *const *const vals[] )
{
    this->class_level_rec ++;
    this->init(auto_r, naxis0, naxis1, naxis2, vals);
    return;
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_uchar::mdarray_uchar( bool auto_r, const char *dim_info,
			      int v0, ... )
{
    va_list ap;
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_uchar::mdarray_uchar( const mdarray_uchar &obj )
{
    this->class_level_rec ++;
 ...
 *
 */
mdarray_uchar &mdarray_uchar::operator=(const mdarray &obj)
{
    debug_report("(const mdarray &obj)");
    if ( &obj == this ) return *this;

    if ( obj.size_type() == (ssize_t)UCHAR_ZT ) {
	this->mdarray::init(obj);
    }
    else {
 ...
 *
 */
mdarray_uchar &mdarray_uchar::operator=(dcomplex v)
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::operator=(double v)
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::operator=(long long v)
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::operator=(long v)
{
    debug_report("(long v)");
 ...
 *
 */
mdarray_uchar &mdarray_uchar::operator=(int v)
{
    debug_report("(int v)");
 ...
 *
 */
mdarray_uchar &mdarray_uchar::init()
{
    debug_report("()");
    this->mdarray::init();
    return *this;
 ...
 *
 */
mdarray_uchar &mdarray_uchar::init( bool auto_resize )
{
    this->mdarray::init();
 ...
 *
 */
mdarray_uchar &mdarray_uchar::init( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf )
{
    this->mdarray::init((ssize_t)UCHAR_ZT, auto_resize, naxisx, ndim, init_buf);
    return *this;
}
 ...
 *
 */
mdarray_uchar &mdarray_uchar::init( bool auto_resize, size_t naxis0 )
{
    const size_t naxisx[] = {naxis0};
    this->mdarray::init((ssize_t)UCHAR_ZT, auto_resize, naxisx, 1, true);
    return *this;
}
 ...
 *
 */
mdarray_uchar &mdarray_uchar::init( bool auto_resize, size_t naxis0, size_t naxis1 )
{
    const size_t naxisx[] = {naxis0, naxis1};
    this->mdarray::init((ssize_t)UCHAR_ZT, auto_resize, naxisx, 2, true);
    return *this;
}
 ...
 *
 */
mdarray_uchar &mdarray_uchar::init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 )
{
    const size_t naxisx[] = {naxis0, naxis1, naxis2};
    this->mdarray::init((ssize_t)UCHAR_ZT, auto_resize, naxisx, 3, true);
    return *this;
}
 ...
 *          3次元までしかサポートしていません.
 */
size_t mdarray_uchar::parse_dim_info( const char *dim_info )
{
    size_t i;
    tarray_tstring arr0;
    this->dinfo_dlen[0] = 0;
...
{
    const size_t naxisx[] = {naxis0};
    this->mdarray::init((ssize_t)UCHAR_ZT, auto_resize, naxisx, 1, false);
...
{
    const size_t naxisx[] = {naxis0, naxis1};
    this->mdarray::init((ssize_t)UCHAR_ZT, auto_resize, naxisx, 2, false);
    this->mdarray::putdata((const void *)vals, this->byte_length());
    return *this;
}
...
{
    const size_t naxisx[] = {naxis0, naxis1, naxis2};
    this->mdarray::init((ssize_t)UCHAR_ZT, auto_resize, naxisx, 3, false);
    this->mdarray::putdata((const void *)vals, this->byte_length());
    return *this;
}
 ...
 * @throw   内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_uchar &mdarray_uchar::init( bool auto_resize, const char *dim_info, int v0, ... )
{
    va_list ap;
    va_start(ap, v0);
    try {
 ...
 * @throw   内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_uchar &mdarray_uchar::vinit( bool auto_resize, const char *dim_info, int v0, va_list ap )
{
    size_t ndim = this->parse_dim_info(dim_info);
    if ( ndim < 1 ) {
	this->mdarray::init((ssize_t)UCHAR_ZT, auto_resize);
    }
    else {
	size_t i;
	this->mdarray::init((ssize_t)UCHAR_ZT, auto_resize, this->dinfo_dlen, ndim, true);
	i = 0;
	if ( i < this->length() ) this->c(i) = v0;
	i++;
	for ( ; i < this->length() ; i++ ) {
	    this->c(i) = va_arg(ap,int);
	}
    }
    return *this;
}
 ...
 *
 */
mdarray_uchar &mdarray_uchar::init( const mdarray &obj )
{
    debug_report("( const mdarray &obj )");
 ...
 *            
 */
mdarray_uchar &mdarray_uchar::init_properties( const mdarray &src_obj )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::set_auto_resize( bool tf )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::set_auto_init( bool tf )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::set_rounding( bool tf )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::set_alloc_strategy( const char *strategy )
{
...
{
    mdarray_uchar *this_p = (mdarray_uchar *)p;
    unsigned char v0 = *((const unsigned char *)v0p);
    *((unsigned char *)v1p) = (*(this_p->convert_func_rec))(v0, this_p->convert_user_ptr_rec);
}
*/

/*
mdarray_uchar &mdarray_uchar::convert( unsigned char (*func)(unsigned char,void *),
				       void *user_ptr )
{
    this->convert_func_rec = func;
    this->convert_user_ptr_rec = user_ptr;
    this->mdarray::convert((ssize_t)UCHAR_ZT, &fnc_for_convert, (void *)this);
    return *this;
}
*/
 ...
 * @throw      内部バッファの確保に失敗した場合
 */
mdarray_uchar &mdarray_uchar::convert_via_udf( void (*func)(const unsigned char *,unsigned char *,size_t,int,void *),
				       void *user_ptr )
{
    this->mdarray::convert_via_udf((ssize_t)UCHAR_ZT,
 ...
 */
mdarray_uchar &mdarray_uchar::swap( mdarray &sobj )
{
 ...
 *  dest には，mdarray_uchar クラスのオブジェクトあるいは mdarray クラスの
 ...
 *
 */
ssize_t mdarray_uchar::copy( mdarray *dest ) const
{
 ...
 * @deprecated 非推奨．<br>
 * ssize_t mdarray_uchar::copy( mdarray *dest ) const <br>
 * をお使いください．
 */
ssize_t mdarray_uchar::copy( mdarray &dest ) const
{
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_uchar &mdarray_uchar::cut( mdarray *dest )
{
    debug_report("( mdarray *dest )");
 ...
 */
mdarray_uchar &mdarray_uchar::transpose_xy()
{
 ...
 * @note  高速なアルゴリズムを使用しています．
 */
mdarray_uchar &mdarray_uchar::transpose_xyz2zxy()
{
 ...
 * 
 */
mdarray_uchar &mdarray_uchar::rotate_xy( int angle )
{
 ...
 *
 */
ssize_t mdarray_uchar::get_elements( unsigned char *dest_buf, size_t elem_size, 
 ...
 *
 */
ssize_t mdarray_uchar::put_elements( const unsigned char *src_buf, size_t elem_size,
 ...
 *
 */
mdarray_uchar &mdarray_uchar::increase_dim()
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::decrease_dim()
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::resize( size_t len )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::resize( size_t dim_index, size_t len )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::resize( const mdarray &src )
{
 ...
 */
mdarray_uchar &mdarray_uchar::resize_1d( size_t x_len )
{
 ...
 */
mdarray_uchar &mdarray_uchar::resize_2d( size_t x_len, size_t y_len )
{
 ...
 *  します．
 */
mdarray_uchar &mdarray_uchar::resize_3d( size_t x_len, size_t y_len, size_t z_len )
{
 ...
 */
mdarray_uchar &mdarray_uchar::resize( const size_t naxisx[], size_t ndim, bool init_buf )
{
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_uchar &mdarray_uchar::resizef( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_uchar &mdarray_uchar::vresizef( const char *exp_fmt, va_list ap )
{
    this->mdarray::vresizef(exp_fmt,ap);
    return *this;
}
 ...
 *
 */
mdarray_uchar &mdarray_uchar::resizeby( ssize_t len )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::resizeby( size_t dim_index, ssize_t len )
{
 ...
 */
mdarray_uchar &mdarray_uchar::resizeby_1d( ssize_t x_len )
{
 ...
 */
mdarray_uchar &mdarray_uchar::resizeby_2d( ssize_t x_len, ssize_t y_len )
{
 ...
 */
mdarray_uchar &mdarray_uchar::resizeby_3d(ssize_t x_len, ssize_t y_len, ssize_t z_len)
{
 ...
 * @throw     内部バッファの確保に失敗した場合
 */
mdarray_uchar &mdarray_uchar::resizeby( const ssize_t naxisx_rel[], size_t ndim, 
			    bool init_buf )
{
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_uchar &mdarray_uchar::resizebyf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_uchar &mdarray_uchar::vresizebyf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vresizebyf(exp_fmt,ap);
    return *this;
}
 ...
 * @throw     内部バッファの確保に失敗した場合
 */
mdarray_uchar &mdarray_uchar::reallocate( const size_t naxisx[], size_t ndim, bool init_buf )
{
 ...
 * @throw    内部バッファの確保に失敗した場合
 */
mdarray_uchar &mdarray_uchar::allocate( const size_t naxisx[], size_t ndim, bool init_buf )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::assign_default( unsigned char value )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::insert( ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::insert( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::erase( ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::erase( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::move( ssize_t idx_src, size_t len, ssize_t idx_dst,
			   bool clr )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::move( size_t dim_index, 
 ...
 *
 */
mdarray_uchar &mdarray_uchar::cpy( ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::cpy( size_t dim_index, 
			  ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::swap( ssize_t idx_src, size_t len, ssize_t idx_dst )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::swap( size_t dim_index, 
		      ssize_t idx_src, size_t len, ssize_t idx_dst )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::crop( ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::crop( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 * @deprecated 未実装です.
 */
mdarray_uchar &mdarray_uchar::cropf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @deprecated 未実装です.
 */
mdarray_uchar &mdarray_uchar::vcropf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vcropf(exp_fmt,ap);
    return *this;
}
 ...
 * @return    自身の参照
 */
mdarray_uchar &mdarray_uchar::flip( ssize_t idx, size_t len )
{
 ...
 * @return    自身の参照
 */
mdarray_uchar &mdarray_uchar::flip( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
ssize_t mdarray_uchar::copyf( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
ssize_t mdarray_uchar::vcopyf( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 * @deprecated  未実装
 */
ssize_t mdarray_uchar::convertf_copy( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @deprecated  未実装
 */
ssize_t mdarray_uchar::vconvertf_copy( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_uchar &mdarray_uchar::trimf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_uchar &mdarray_uchar::vtrimf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vtrimf(exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_uchar &mdarray_uchar::flipf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  任意の次元(複数も可)で配列の並びを反転 (IDLの記法)
 */
mdarray_uchar &mdarray_uchar::vflipf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vflipf(exp_fmt, ap);
    return *this;
}
 ...
 */
ssize_t mdarray_uchar::transposef_xy_copy( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @brief  (x,y)のトランスポーズを行なった配列を取得 (IDLの記法)
 */
ssize_t mdarray_uchar::vtransposef_xy_copy( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 */
ssize_t mdarray_uchar::transposef_xyz2zxy_copy( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @brief  (x,y,z)→(z,x,y)のトランスポーズを行なった配列を取得 (IDLの記法)
 */
ssize_t mdarray_uchar::vtransposef_xyz2zxy_copy( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 */
mdarray_uchar &mdarray_uchar::cleanf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列をデフォルト値でパディング (IDLの記法)
 */
mdarray_uchar &mdarray_uchar::vcleanf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vcleanf(exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_uchar &mdarray_uchar::fillf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を指定されたスカラー値で書き換え (IDLの記法)
 */
mdarray_uchar &mdarray_uchar::vfillf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vfillf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_uchar &mdarray_uchar::fillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_uchar *,void *),
 ...
 * @brief  自身の配列をスカラー値で書き換え (ユーザ関数経由・IDLの記法)
 */
mdarray_uchar &mdarray_uchar::vfillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_uchar *,void *),
 ...
 */
mdarray_uchar &mdarray_uchar::addf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたスカラー値で加算 (IDLの記法)
 */
mdarray_uchar &mdarray_uchar::vaddf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vaddf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_uchar &mdarray_uchar::subtractf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を，指定されたスカラー値で減算 (IDLの記法)
 */
mdarray_uchar &mdarray_uchar::vsubtractf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vsubtractf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_uchar &mdarray_uchar::multiplyf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたスカラー値を乗算 (IDLの記法)
 */
mdarray_uchar &mdarray_uchar::vmultiplyf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vmultiplyf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_uchar &mdarray_uchar::dividef( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を，指定されたスカラー値で除算 (IDLの記法)
 */
mdarray_uchar &mdarray_uchar::vdividef( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vdividef(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_uchar &mdarray_uchar::pastef( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に指定されたオブジェクトの配列を貼り付け (IDLの記法)
 */
mdarray_uchar &mdarray_uchar::vpastef( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vpastef(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_uchar &mdarray_uchar::pastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_uchar *,void *),
	void *user_ptr,
        const char *exp_fmt, ... )
{
 ...
 * @brief  自身の配列に指定された配列を貼り付け (ユーザ関数経由・IDLの記法)
 */
mdarray_uchar &mdarray_uchar::vpastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_uchar *,void *),
	void *user_ptr,
 ...
 */
mdarray_uchar &mdarray_uchar::addf( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたオブジェクトの配列を加算 (IDLの記法)
 */
mdarray_uchar &mdarray_uchar::vaddf( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vaddf(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_uchar &mdarray_uchar::subtractf( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief 自身の配列を，指定されたオブジェクトの配列で減算 (IDLの記法)
 */
mdarray_uchar &mdarray_uchar::vsubtractf( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vsubtractf(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_uchar &mdarray_uchar::multiplyf( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたオブジェクトの配列を乗算 (IDLの記法)
 */
mdarray_uchar &mdarray_uchar::vmultiplyf( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vmultiplyf(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_uchar &mdarray_uchar::dividef( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を，指定されたオブジェクトの配列で除算 (IDLの記法)
 */
mdarray_uchar &mdarray_uchar::vdividef( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vdividef(src, exp_fmt, ap);
    return *this;
}
 ...
 *
 */
ssize_t mdarray_uchar::copy( mdarray *dest,
 ...
 * @deprecated  未実装
 */
ssize_t mdarray_uchar::convert_copy( mdarray *dest,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 */
mdarray_uchar &mdarray_uchar::move_from(ssize_t col_idx, size_t col_len,
					  ssize_t row_idx, size_t row_len, 
 ...
 */
mdarray_uchar &mdarray_uchar::move_to( 
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_uchar &mdarray_uchar::trim( ssize_t col_idx, size_t col_len,
				      ssize_t row_idx, size_t row_len, 
				      ssize_t layer_idx, size_t layer_len )
{
 ...
 * @return    自身の参照
 */
mdarray_uchar &mdarray_uchar::flip_cols( ssize_t col_idx, size_t col_len,
					  ssize_t row_idx, size_t row_len, 
					  ssize_t layer_idx, size_t layer_len )
{
 ...
 * @return    自身の参照
 */
mdarray_uchar &mdarray_uchar::flip_rows( ssize_t col_idx, size_t col_len,
					  ssize_t row_idx, size_t row_len, 
					  ssize_t layer_idx, size_t layer_len )
{
 ...
 */
ssize_t mdarray_uchar::transpose_xy_copy( mdarray *dest,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 */
ssize_t mdarray_uchar::transpose_xyz2zxy_copy( mdarray *dest,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 */
ssize_t mdarray_uchar::rotate_xy_copy( mdarray *dest, int angle,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::clean( ssize_t col_index, size_t col_size,
 ...
 *
 */
mdarray_uchar &mdarray_uchar::fill( double value, 
 ...
 *
 */
mdarray_uchar &mdarray_uchar::fill_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_uchar *,void *),
	void *user_ptr,
	ssize_t col_index, size_t col_size,
	ssize_t row_index, size_t row_size,
 ...
 *
 */
mdarray_uchar &mdarray_uchar::add( double value, 
		    ssize_t col_index, size_t col_size,
		    ssize_t row_index, size_t row_size,
		    ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::subtract( double value, 
				       ssize_t col_index, size_t col_size,
				       ssize_t row_index, size_t row_size,
				       ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::multiply( double value, 
		    ssize_t col_index, size_t col_size,
		    ssize_t row_index, size_t row_size,
		    ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::divide( double value, 
				       ssize_t col_index, size_t col_size,
				       ssize_t row_index, size_t row_size,
				       ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::paste( const mdarray &src,
	ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::paste_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t,ssize_t,ssize_t,ssize_t,mdarray_uchar *,void *),
	void *user_ptr,
	ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::add( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::subtract( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::multiply( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_uchar &mdarray_uchar::divide( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *             ます．
 */
mdarray_uchar &mdarray_uchar::register_extptr( unsigned char **extptr_address )
{
    this->mdarray::register_extptr((void *)extptr_address);
    return *this;
}
 ...
 *             ます．
 */
mdarray_uchar &mdarray_uchar::register_extptr_2d( unsigned char *const **extptr2d_address )
{
    this->mdarray::register_extptr_2d((void *)extptr2d_address);
    return *this;
}
 ...
 *             ます．
 */
mdarray_uchar &mdarray_uchar::register_extptr_3d( unsigned char *const *const **extptr3d_address )
{
    this->mdarray::register_extptr_3d((void *)extptr3d_address);
    return *this;
}
 ...
 *
 */
mdarray_uchar &mdarray_uchar::reverse_endian( bool is_little_endian )
{
 ...
 * 
 * @return  型種別 (固定値: unsigned char)
 * @note    このメンバ関数はprotectedです．
 */
ssize_t mdarray_uchar::default_size_type()
{
    return (ssize_t)UCHAR_ZT;
}
 ...
 * 
 * @param   sz_type 型種別
 * @return  受け入れ可能な型(unsigned char)なら真
 * @note    このメンバ関数はprotectedです．
 */
bool mdarray_uchar::is_acceptable_size_type( ssize_t sz_type )
{
    if ( sz_type == (ssize_t)UCHAR_ZT ) return true;
    else return false;
}
