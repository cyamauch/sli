...
#ifndef _SLI__MDARRAY_DCOMPLEX_H
#define _SLI__MDARRAY_DCOMPLEX_H 1

/**
 * @file   mdarray_dcomplex.h
 * @brief  dcomplex型の多次元配列を扱う mdarray_dcomplex クラスのヘッダファイル
 */
...
/*
 * sli::mdarray_dcomplex is an inherited class of sli::mdarray, and is a 
...
/**
 * @class  sli::mdarray_dcomplex
 * @brief  dcomplex型の多次元配列を扱うためのクラス
 *
 *   mdarray_dcomplexクラスは，dcomplex型の多次元配列を IDL や Python のように
 ...
 * 
 * @note  mdarray_dcomplexクラスは mdarray(基底クラス) を継承しています．<br>
 *        SIMD命令(SSE2)により，基本的な部分が高速化されています．
 * @author  Chisato YAMAUCHI
 * @date  2013-04-01 00:00:00
 */

  class mdarray_dcomplex : public mdarray
  {

  public:
    /* constructor                                                           */
    /* The mdarray_dcomplex class has two kinds of operating modes:            */
    ...
    mdarray_dcomplex();
    mdarray_dcomplex( bool auto_resize );
    mdarray_dcomplex( bool auto_resize, dcomplex **extptr_address );
    mdarray_dcomplex( bool auto_resize, dcomplex *const **extptr2d_address );
    mdarray_dcomplex( bool auto_resize, dcomplex *const *const **extptr3d_address );
    mdarray_dcomplex( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf );
    mdarray_dcomplex( bool auto_resize, size_t naxis0 );
    mdarray_dcomplex( bool auto_resize, size_t naxis0, size_t naxis1 );
    mdarray_dcomplex( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 );
    mdarray_dcomplex( bool auto_resize, size_t naxis0, 
		   const dcomplex vals[] );
    mdarray_dcomplex( bool auto_resize, size_t naxis0, size_t naxis1,
		   const dcomplex vals[] );
...
#if 0
    mdarray_dcomplex( bool auto_resize, const char *dim_info, dcomplex v0, ... );
#endif
    mdarray_dcomplex( const mdarray_dcomplex &obj );


    /* --------------------------------------------------------------------- */

    /* `virtual' がついてるものはオーバーライドではなくオーバーロード     */
    /*   mdarray_dcomplex &operator=(const mdarray_dcomplex &obj);            */
    /* が隠れて存在する事に注意 (演算子 = だけは，特別な規則があるらしい) */

    /* substitute an array (copy the attribute, too)                      */
    virtual mdarray_dcomplex &operator=(const mdarray &obj);

    /* (overridden) */
    mdarray_dcomplex &operator+=(const mdarray &obj);
    mdarray_dcomplex &operator-=(const mdarray &obj);
    mdarray_dcomplex &operator*=(const mdarray &obj);
    mdarray_dcomplex &operator/=(const mdarray &obj);

    /* (overridden) */
    mdarray_dcomplex &operator=(dcomplex v);
    mdarray_dcomplex &operator=(double v);
    mdarray_dcomplex &operator=(long long v);
    mdarray_dcomplex &operator=(long v);
    mdarray_dcomplex &operator=(int v);
    mdarray_dcomplex &operator+=(dcomplex v);
    mdarray_dcomplex &operator+=(double v);
    mdarray_dcomplex &operator+=(long long v);
    mdarray_dcomplex &operator+=(long v);
    ...
    */
    ...
    /* (overridden)                */
    mdarray_dcomplex &init();

    /* <overloaded>                */
    virtual mdarray_dcomplex &init( bool auto_resize );
    virtual mdarray_dcomplex &init( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf );
    virtual mdarray_dcomplex &init( bool auto_resize, size_t naxis0 );
    virtual mdarray_dcomplex &init( bool auto_resize, size_t naxis0, size_t naxis1 );
    virtual mdarray_dcomplex &init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 );
    virtual mdarray_dcomplex &init( bool auto_resize, size_t naxis0, 
				 const dcomplex vals[] );
    virtual mdarray_dcomplex &init( bool auto_resize, size_t naxis0, size_t naxis1,
				 const dcomplex vals[] );
    ...
    virtual mdarray_dcomplex &init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2,
				 const dcomplex *const *const vals[] );
#if 0
    virtual mdarray_dcomplex &init( bool auto_resize, const char *dim_info,
				 dcomplex v0, ... );
    virtual mdarray_dcomplex &vinit( bool auto_resize, const char *dim_info,
				  dcomplex v0, va_list );
#endif
    /*  mdarray_dcomplex &init( const mdarray &obj ); が隠れている */
    /*  (↑mdarrayクラスのポインタ経由で呼び出し可能)            */

    /* (overridden)                                           */
    mdarray_dcomplex &init( const mdarray &obj );

    /* copy properties (auto_resize, auto_init, and rounding) */
    /* (overridden)                                           */
    mdarray_dcomplex &init_properties( const mdarray &src_obj );

    /* setting of the resize mode */
    /* (overridden)               */
    mdarray_dcomplex &set_auto_resize( bool tf );

    /* setting of the initialize mode */
    /* (overridden)                   */
    mdarray_dcomplex &set_auto_init( bool tf );

    /* setting of the rounding off possibility */
    /* (overridden)                            */
    mdarray_dcomplex &set_rounding( bool tf );

    /* setting of strategy of memory allocation */
    /* "auto", "min" and "pow" can be set.      */
    /* (overridden)                             */
    mdarray_dcomplex &set_alloc_strategy( const char *strategy );

    /* convert the value of the full array element */
    /* <overloaded>                                */
    virtual mdarray_dcomplex &convert_via_udf(
		void (*func)(const dcomplex *,dcomplex *,size_t,int,void *),
		void *user_ptr );

    /* swap contents between self and another objects */
    /* (overridden)                 */
    mdarray_dcomplex &swap( mdarray &sobj );
    ...
    /* (overridden)                             */
    mdarray_dcomplex &cut( mdarray *dest );

    /* interchange rows and columns */
    /* (overridden)                 */
    mdarray_dcomplex &transpose_xy();

    /* interchange xyz to zxy */
    /* (overridden)           */
    mdarray_dcomplex &transpose_xyz2zxy();

    /* rotate image                                              */
    /*   angle: 90,-90, or 180                                   */
    /*          (anticlockwise when image is bottom-left origin) */
    /* (overridden)                                              */
    mdarray_dcomplex &rotate_xy( int angle );
    ...
    */
    ...
    /* (overridden)                                          */
    mdarray_dcomplex &assign( dcomplex value,
			    ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF,
			    ssize_t idx2 = MDARRAY_INDEF );
    mdarray_dcomplex &assign( double value, 
			    ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF,
			    ssize_t idx2 = MDARRAY_INDEF );

    /* a reference to the specified value of the element (1 dimension) */
    virtual dcomplex &operator[]( ssize_t idx0 );
    virtual const dcomplex &operator[]( ssize_t idx0 ) const;

    /* a reference to the specified value of the element (1-3 dimensions) */
    virtual dcomplex &operator()( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				ssize_t idx2 = MDARRAY_INDEF);
    virtual const dcomplex &operator()( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				ssize_t idx2 = MDARRAY_INDEF) const;

    /* a reference to the specified value of the element (1-3 dimensions) */
    virtual dcomplex &at( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
			  ssize_t idx2 = MDARRAY_INDEF);
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const dcomplex &at( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				 ssize_t idx2 = MDARRAY_INDEF) const;
#endif
    virtual const dcomplex &at_cs( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				 ssize_t idx2 = MDARRAY_INDEF) const;
    ...
    /* <overloaded>                                */
    virtual mdarray_dcomplex &put( dcomplex value, ssize_t idx, size_t len );
    virtual mdarray_dcomplex &put( dcomplex value,
				size_t dim_index, ssize_t idx, size_t len );

    /* copy the array stored in object into the programmer's buffer. */
    /* <overloaded>                                                  */
    virtual ssize_t get_elements( dcomplex *dest_buf, size_t elem_size, 
				ssize_t idx0 = 0, ssize_t idx1 = MDARRAY_INDEF,
				ssize_t idx2 = MDARRAY_INDEF ) const;

    /* copy the array in the programmer's buffer into object's buffer. */
    /* <overloaded>                                                    */
    virtual ssize_t put_elements( const dcomplex *src_buf, size_t elem_size,
				ssize_t idx0 = 0, ssize_t idx1 = MDARRAY_INDEF,
				ssize_t idx2 = MDARRAY_INDEF );
    ...
    /* (overridden)                      */
    mdarray_dcomplex &increase_dim();

    /* reduction of the dimension number */
    /* (overridden)                      */
    mdarray_dcomplex &decrease_dim();

    /* change the length of the array */
    /* (overridden)                   */
    mdarray_dcomplex &resize( size_t len );
    mdarray_dcomplex &resize( size_t dim_index, size_t len );
    mdarray_dcomplex &resize( const mdarray &src );

    /* change the length of the 1-d array */
    /* (overridden)                       */
    mdarray_dcomplex &resize_1d( size_t x_len );

    /* change the length of the 2-d array */
    /* (overridden)                       */
    mdarray_dcomplex &resize_2d( size_t x_len, size_t y_len );

    /* change the length of the 3-d array */
    /* (overridden)                       */
    mdarray_dcomplex &resize_3d( size_t x_len, size_t y_len, size_t z_len );

    /* change the length of the array (supports n-dim) */
    /* (overridden)                                    */
    mdarray_dcomplex &resize( const size_t naxisx[], size_t ndim, 
			    bool init_buf );
    ...
    /* (overridden)                                                   */
    mdarray_dcomplex &resizef( const char *exp_fmt, ... );
    mdarray_dcomplex &vresizef( const char *exp_fmt, va_list ap );

    /* change the length of the array relatively */
    /* (overridden)                              */
    mdarray_dcomplex &resizeby( ssize_t len );			/* for 1-d */
    mdarray_dcomplex &resizeby( size_t dim_index, ssize_t len );

    /* change the length of the 1-d array relatively */
    /* (overridden)                                  */
    mdarray_dcomplex &resizeby_1d( ssize_t x_len );

    /* change the length of the 2-d array relatively */
    /* (overridden)                                  */
    mdarray_dcomplex &resizeby_2d( ssize_t x_len, ssize_t y_len );

    /* change the length of the 3-d array relatively */
    /* (overridden)                                  */
    mdarray_dcomplex &resizeby_3d(ssize_t x_len, ssize_t y_len, ssize_t z_len);
    ...
    /* (overridden)                                                         */
    mdarray_dcomplex &resizeby( const ssize_t naxisx_rel[], size_t ndim, 
			       bool init_buf );
    ...
    /* length of first dimension.                                      */
    /* (overridden)                                                    */
    mdarray_dcomplex &resizebyf( const char *exp_fmt, ... );
    mdarray_dcomplex &vresizebyf( const char *exp_fmt, va_list ap );

    /* change length of array without adjusting buffer contents */
    /* (overridden)                                             */
    mdarray_dcomplex &reallocate( const size_t naxisx[], size_t ndim, 
				bool init_buf );

    /* free current buffer and alloc new memory */
    /* (overridden)                             */
    mdarray_dcomplex &allocate( const size_t naxisx[], size_t ndim, 
			      bool init_buf );

    /* setting of the initial value for .resize(), etc. */
    /* <overloaded>                                     */
    virtual mdarray_dcomplex &assign_default( dcomplex value );

    /* insert a blank section */
    /* (overridden)           */
    mdarray_dcomplex &insert( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_dcomplex &insert( size_t dim_index, ssize_t idx, size_t len );

    /* erase a section */
    /* (overridden)    */
    mdarray_dcomplex &erase( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_dcomplex &erase( size_t dim_index, ssize_t idx, size_t len );

    /* copy values between elements (without automatic resizing) */
    /* 移動 (バッファのサイズは変更しない)                       */
    /* (overridden)                                              */
    mdarray_dcomplex &move( ssize_t idx_src, size_t len, ssize_t idx_dst,
			   bool clr );				/* for 1-d */
    mdarray_dcomplex &move( size_t dim_index, 
    ...
    /* (overridden)                                           */
    mdarray_dcomplex &cpy( ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr );				/* for 1-d */
    mdarray_dcomplex &cpy( size_t dim_index, 
			  ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr );

    /* replace values between elements */
    /* (overridden)                    */
    mdarray_dcomplex &swap( ssize_t idx_src, size_t len, 
			  ssize_t idx_dst );			/* for 1-d */
    mdarray_dcomplex &swap( size_t dim_index, 
			   ssize_t idx_src, size_t len, ssize_t idx_dst );

    /* extract a section           */
    /* see also trimf() and trim() */
    /* (overridden)                */
    mdarray_dcomplex &crop( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_dcomplex &crop( size_t dim_index, ssize_t idx, size_t len );

    /* flip a section   */
    /* see also flipf() */
    /* (overridden)     */
    mdarray_dcomplex &flip( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_dcomplex &flip( size_t dim_index, ssize_t idx, size_t len );


    /* raise decimals to the next whole number in a float/double type value */
    /* (overridden)                                                         */
    mdarray_dcomplex &ceil();

    /* devalue decimals in a float/double type value */
    /* (overridden)                                  */
    mdarray_dcomplex &floor();

    /* round off decimals in a float/double type value */
    /* (overridden)                                    */
    mdarray_dcomplex &round();

    /* omit decimals in a float/double type value */
    /* (overridden)                               */
    mdarray_dcomplex &trunc();

    /* absolute value of all elements */
    /* (overridden)                   */
    mdarray_dcomplex &abs();
    ...
    */
    ...
    /* Flipping elements is supported */
    /* (overridden)                   */
    mdarray_dcomplex &trimf( const char *exp_fmt, ... );
    mdarray_dcomplex &vtrimf( const char *exp_fmt, va_list ap );

    /* flip elements in a section */
    /* (overridden)               */
    mdarray_dcomplex &flipf( const char *exp_fmt, ... );
    mdarray_dcomplex &vflipf( const char *exp_fmt, va_list ap );
    ...
    /* (overridden)                        */
    mdarray_dcomplex &cleanf( const char *exp_fmt, ... );
    mdarray_dcomplex &vcleanf( const char *exp_fmt, va_list ap );

    /* rewrite element values with a value in a section */
    /* (overridden)                                     */
    mdarray_dcomplex &fillf( double value, const char *exp_fmt, ... );
    mdarray_dcomplex &vfillf( double value, const char *exp_fmt, va_list ap );

    /* <overloaded>                                     */
    virtual mdarray_dcomplex &fillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_dcomplex *,void *),
        void *user_ptr, const char *exp_fmt, ... );
    virtual mdarray_dcomplex &vfillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_dcomplex *,void *),
        void *user_ptr, const char *exp_fmt, va_list ap );

    /* add a scalar value to element values in a section */
    /* (overridden)                                      */
    mdarray_dcomplex &addf( double value, 
			  const char *exp_fmt, ... );
    mdarray_dcomplex &vaddf( double value, 
			   const char *exp_fmt, va_list ap );

    /* subtract a scalar value from element values in a section */
    /* (overridden)                                             */
    mdarray_dcomplex &subtractf( double value, 
			       const char *exp_fmt, ... );
    mdarray_dcomplex &vsubtractf( double value, 
				const char *exp_fmt, va_list ap );

    /* multiply element values in a section by a scalar value */
    /* (overridden)                                           */
    mdarray_dcomplex &multiplyf( double value, 
			       const char *exp_fmt, ... );
    mdarray_dcomplex &vmultiplyf( double value, 
				const char *exp_fmt, va_list ap );

    /* divide element values in a section by a scalar value */
    /* (overridden)                                         */
    mdarray_dcomplex &dividef( double value, 
			     const char *exp_fmt, ... );
    mdarray_dcomplex &vdividef( double value, 
			      const char *exp_fmt, va_list ap );
    ...
    /* (overridden)                                                          */
    mdarray_dcomplex &pastef( const mdarray &src,
			    const char *exp_fmt, ... );
    mdarray_dcomplex &vpastef( const mdarray &src,
			     const char *exp_fmt, va_list ap );
    ...
    /*   8. user pointer                                                     */
    /* <overloaded>                                                          */
    virtual mdarray_dcomplex &pastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_dcomplex *,void *),
	void *user_ptr,
        const char *exp_fmt, ... );
    virtual mdarray_dcomplex &vpastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_dcomplex *,void *),
	void *user_ptr,
        const char *exp_fmt, va_list ap );
    ...
    /* add an array object */
    /* (overridden)        */
    mdarray_dcomplex &addf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_dcomplex &vaddf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* subtract an array object */
    /* (overridden)             */
    mdarray_dcomplex &subtractf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_dcomplex &vsubtractf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* multiply an array object */
    /* (overridden)             */
    mdarray_dcomplex &multiplyf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_dcomplex &vmultiplyf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* divide an array object */
    /* (overridden)           */
    mdarray_dcomplex &dividef( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_dcomplex &vdividef( const mdarray &src_img, const char *exp_fmt, va_list ap );
    ...
    */
    ...
    /* rewrite element values with a value in a section */
    /* (overridden)                                     */
    mdarray_dcomplex &fill( double value,
			 ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
			 ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
			 ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );

    /* <overloaded>                                     */
    virtual mdarray_dcomplex &fill_via_udf( double value,
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_dcomplex *,void *),
	void *user_ptr,
	ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
	ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
    ...
    /* add a scalar value to element values in a section */
    /* (overridden)                                      */
    mdarray_dcomplex &add( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* subtract a scalar value from element values in a section */
    /* (overridden)                                             */
    mdarray_dcomplex &subtract( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* multiply element values in a section by a scalar value */
    /* (overridden)                                           */
    mdarray_dcomplex &multiply( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* divide element values in a section by a scalar value */
    /* (overridden)                                         */
    mdarray_dcomplex &divide( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* paste up an array object */
    /* (overridden)             */
    mdarray_dcomplex &paste( const mdarray &src,
	ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* <overloaded>             */
    virtual mdarray_dcomplex &paste_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t,ssize_t,ssize_t,ssize_t,mdarray_dcomplex *,void *),
	void *user_ptr,
	ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );
    ...
    /* add an array object */
    /* (overridden)        */
    mdarray_dcomplex &add( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* subtract an array object */
    /* (overridden)             */
    mdarray_dcomplex &subtract( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* multiply an array object */
    /* (overridden)             */
    mdarray_dcomplex &multiply( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* divide an array object */
    /* (overridden)           */
    mdarray_dcomplex &divide( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );
    ...
    */
    ...
    /* <overloaded>                                                    */
    virtual mdarray_dcomplex &register_extptr( dcomplex **extptr_address );
    virtual mdarray_dcomplex &register_extptr_2d( dcomplex *const **extptr2d_address );
    virtual mdarray_dcomplex &register_extptr_3d( dcomplex *const *const **extptr3d_address );

    /* Acquire the specified element's address */
    virtual const dcomplex *carray() const;
    virtual const dcomplex *carray( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
    virtual dcomplex *array_ptr();
    virtual dcomplex *array_ptr( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF );
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const dcomplex *array_ptr() const;
    virtual const dcomplex *array_ptr( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
#endif
    virtual const dcomplex *array_ptr_cs() const;
    virtual const dcomplex *array_ptr_cs( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
    ...
    virtual dcomplex *const *array_ptr_2d( bool use );
    /* followings have no overhead. Execute .array_ptr_2d(true) before use. */
    virtual dcomplex *const *array_ptr_2d();
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const dcomplex *const *array_ptr_2d() const;
#endif
    virtual const dcomplex *const *array_ptr_2d_cs() const;
    ...
    /*        "use=false" when there is no requirement of referring         */
    /*        obtained address table.                                       */
    virtual dcomplex *const *const *array_ptr_3d( bool use );
    /* followings have no overhead. Execute .array_ptr_3d(true) before use. */
    virtual dcomplex *const *const *array_ptr_3d();
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const dcomplex *const *const *array_ptr_3d() const;
#endif
    virtual const dcomplex *const *const *array_ptr_3d_cs() const;
    ...
    */
    ...
    /* (overridden)                    */
    mdarray_dcomplex &reverse_endian( bool is_little_endian );
    /* (overridden)                    */
    mdarray_dcomplex &reverse_endian( bool is_little_endian, 
				    size_t begin, size_t length );

    /* acquisition of the initial value */
    virtual dcomplex default_value() const;
 ...
 *
 */
inline mdarray_dcomplex &mdarray_dcomplex::put( dcomplex value, ssize_t idx, size_t len )
{
 ...
 *
 */
inline mdarray_dcomplex &mdarray_dcomplex::put( dcomplex value,
				    size_t dim_index, ssize_t idx, size_t len )
{
 ...
 */
inline mdarray_dcomplex &mdarray_dcomplex::assign( dcomplex value,
 ...
 *
 */
inline mdarray_dcomplex &mdarray_dcomplex::assign( double value, 
				     ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
    this->mdarray::assign(value, idx0, idx1, idx2);
    return *this;
 ...
 *
 */
inline dcomplex &mdarray_dcomplex::operator[]( ssize_t idx0 )
{
    return ((0 <= idx0 && idx0 < (ssize_t)this->length()) ? 
	    ((dcomplex *)(this->data_ptr()))[idx0] :
	    this->at(idx0));
}
 ...
 *
 */
inline const dcomplex &mdarray_dcomplex::operator[]( ssize_t idx0 ) const
{
    return ((0 <= idx0 && idx0 < (ssize_t)this->length()) ? 
	    ((const dcomplex *)(this->data_ptr_cs()))[idx0] :
	    this->at_cs(idx0));
}
 ...
 *
 */
inline dcomplex &mdarray_dcomplex::operator()( ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
 ...
 *
 */
inline const dcomplex &mdarray_dcomplex::operator()( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
 ...
 *
 */
inline dcomplex &mdarray_dcomplex::at( ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
    ssize_t idx = this->get_idx_3d(idx0,idx1,idx2);
    if ( 0 <= idx ) {
	return ((dcomplex *)(this->data_ptr()))[idx];
    }
    else {
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const dcomplex &mdarray_dcomplex::at( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
    return this->at_cs(idx0, idx1, idx2);
}
#endif
 ...
 *
 */
inline const dcomplex &mdarray_dcomplex::at_cs( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
    ssize_t idx = this->get_idx_3d_cs(idx0,idx1,idx2);
    if ( 0 <= idx ) {
	return ((const dcomplex *)(this->data_ptr()))[idx];
    }
    else {
	dcomplex *p = (dcomplex *)(this->junk_rec);
	*p = NAN + NAN*I;
 ...
 *
 */
inline mdarray_dcomplex &mdarray_dcomplex::ceil()
{
    this->mdarray::ceil();
    return *this;
}
 ...
 *
 */
inline mdarray_dcomplex &mdarray_dcomplex::floor()
{
    this->mdarray::floor();
    return *this;
}
 ...
 *
 */
inline mdarray_dcomplex &mdarray_dcomplex::round()
{
    this->mdarray::round();
    return *this;
}
 ...
 *
 */
inline mdarray_dcomplex &mdarray_dcomplex::trunc()
{
    this->mdarray::trunc();
    return *this;
}
 ...
 *
 */
inline mdarray_dcomplex &mdarray_dcomplex::abs()
{
    this->mdarray::abs();
    return *this;
}
 ...
 *
 */
inline const dcomplex *mdarray_dcomplex::carray() const
{
    return (const dcomplex *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const dcomplex *mdarray_dcomplex::carray( ssize_t idx0, 
				     ssize_t idx1, ssize_t idx2 ) const
{
    return (const dcomplex *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *
 */
inline dcomplex *mdarray_dcomplex::array_ptr()
{
    return (dcomplex *)(this->data_ptr());
}
 ...
 *
 */
inline dcomplex *mdarray_dcomplex::array_ptr( ssize_t idx0, 
				  ssize_t idx1, ssize_t idx2 )
{
    return (dcomplex *)(this->data_ptr(idx0,idx1,idx2));
}
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const dcomplex *mdarray_dcomplex::array_ptr() const
{
    return (const dcomplex *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const dcomplex *mdarray_dcomplex::array_ptr( ssize_t idx0, 
					   ssize_t idx1, ssize_t idx2 ) const
{
    return (const dcomplex *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *
 */
inline const dcomplex *mdarray_dcomplex::array_ptr_cs() const
{
    return (const dcomplex *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const dcomplex *mdarray_dcomplex::array_ptr_cs( ssize_t idx0, 
					   ssize_t idx1, ssize_t idx2 ) const
{
    return (const dcomplex *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *             使用しない場合はfalse(機能off)．
 */
inline dcomplex *const *mdarray_dcomplex::array_ptr_2d( bool use )
{
    return (dcomplex *const *)(this->mdarray::data_ptr_2d(use));
}

/**
 * @brief  内部で生成された2次元配列用ポインタ配列のアドレスを取得
 */
inline dcomplex *const *mdarray_dcomplex::array_ptr_2d()
{
    return (dcomplex *const *)(this->mdarray::data_ptr_2d());
}
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const dcomplex *const *mdarray_dcomplex::array_ptr_2d() const
{
    return (const dcomplex *const *)(this->mdarray::data_ptr_2d_cs());
}
#endif
 ...
 * @brief  内部で生成された2次元配列用ポインタ配列のアドレスを取得 (読取専用)
 */
inline const dcomplex *const *mdarray_dcomplex::array_ptr_2d_cs() const
{
    return (const dcomplex *const *)(this->mdarray::data_ptr_2d_cs());
}
 ...
 *             使用しない場合はfalse(機能off)．
 */
inline dcomplex *const *const *mdarray_dcomplex::array_ptr_3d( bool use )
{
    return (dcomplex *const *const *)(this->mdarray::data_ptr_3d(use));
}

/**
 * @brief  内部で生成された3次元配列用ポインタ配列のアドレスを取得
 */
inline dcomplex *const *const *mdarray_dcomplex::array_ptr_3d()
{
    return (dcomplex *const *const *)(this->mdarray::data_ptr_3d());
}
 ...
 */
inline const dcomplex *const *const *mdarray_dcomplex::array_ptr_3d() const
{
    return (const dcomplex *const *const *)(this->mdarray::data_ptr_3d_cs());
}
#endif
 ...
 * @brief  内部で生成された3次元配列用ポインタ配列のアドレスを取得 (読取専用)
 */
inline const dcomplex *const *const *mdarray_dcomplex::array_ptr_3d_cs() const
{
    return (const dcomplex *const *const *)(this->mdarray::data_ptr_3d_cs());
}
 ...
 *
 */
inline dcomplex mdarray_dcomplex::default_value() const
{
    const dcomplex *p = (const dcomplex *)(this->default_value_ptr());
...
#endif	/* _SLI__MDARRAY_DCOMPLEX_H */
