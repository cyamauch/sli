...
/**
 * @file   mdarray_int64.cc
 * @brief  int64_t型の多次元配列を扱う mdarray_int64 クラスのコード
 */

#define CLASS_NAME "mdarray_int64"
 ...
 */
mdarray_int64::mdarray_int64()
{
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)INT64_ZT, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int64::mdarray_int64( bool auto_r )
{
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)INT64_ZT, auto_r);
    return;
}
 ...
 *             ます．
 */
mdarray_int64::mdarray_int64( bool auto_r, int64_t **extptr_address )
{
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)INT64_ZT, auto_r);
 ...
 *             ます．
 */
mdarray_int64::mdarray_int64( bool auto_r, int64_t *const **extptr2d_address )
{
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)INT64_ZT, auto_r);
 ...
 *             ます．
 */
mdarray_int64::mdarray_int64( bool auto_r, int64_t *const *const **extptr3d_address )
{
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)INT64_ZT, auto_r);
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int64::mdarray_int64( bool auto_r, const size_t naxisx[], size_t ndim, bool init_buf )
{
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)INT64_ZT, auto_r, naxisx, ndim, init_buf);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
*/
mdarray_int64::mdarray_int64( bool auto_r, size_t naxis0 )
{
    const size_t naxisx[] = {naxis0};
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)INT64_ZT, auto_r, naxisx, 1, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int64::mdarray_int64( bool auto_r, size_t naxis0, size_t naxis1 )
{
    const size_t naxisx[] = {naxis0, naxis1};
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)INT64_ZT, auto_r, naxisx, 2, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int64::mdarray_int64( bool auto_r, size_t naxis0, size_t naxis1, size_t naxis2 )
{
    const size_t naxisx[] = {naxis0, naxis1, naxis2};
    this->class_level_rec ++;
    this->mdarray::init((ssize_t)INT64_ZT, auto_r, naxisx, 3, true);
    return;
}
 ...
 */
mdarray_int64::mdarray_int64( bool auto_r, size_t naxis0, size_t naxis1, size_t naxis2,
			      const int64_t *const *const vals[] )
{
    this->class_level_rec ++;
    this->init(auto_r, naxis0, naxis1, naxis2, vals);
    return;
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int64::mdarray_int64( bool auto_r, const char *dim_info,
			      int64_t v0, ... )
{
    va_list ap;
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int64::mdarray_int64( const mdarray_int64 &obj )
{
    this->class_level_rec ++;
 ...
 *
 */
mdarray_int64 &mdarray_int64::operator=(const mdarray &obj)
{
    debug_report("(const mdarray &obj)");
    if ( &obj == this ) return *this;

    if ( obj.size_type() == (ssize_t)INT64_ZT ) {
	this->mdarray::init(obj);
    }
    else {
 ...
 *
 */
mdarray_int64 &mdarray_int64::operator=(dcomplex v)
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::operator=(double v)
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::operator=(long long v)
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::operator=(long v)
{
    debug_report("(long v)");
 ...
 *
 */
mdarray_int64 &mdarray_int64::operator=(int v)
{
    debug_report("(int v)");
 ...
 *
 */
mdarray_int64 &mdarray_int64::init()
{
    debug_report("()");
    this->mdarray::init();
    return *this;
 ...
 *
 */
mdarray_int64 &mdarray_int64::init( bool auto_resize )
{
    this->mdarray::init();
 ...
 *
 */
mdarray_int64 &mdarray_int64::init( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf )
{
    this->mdarray::init((ssize_t)INT64_ZT, auto_resize, naxisx, ndim, init_buf);
    return *this;
}
 ...
 *
 */
mdarray_int64 &mdarray_int64::init( bool auto_resize, size_t naxis0 )
{
    const size_t naxisx[] = {naxis0};
    this->mdarray::init((ssize_t)INT64_ZT, auto_resize, naxisx, 1, true);
    return *this;
}
 ...
 *
 */
mdarray_int64 &mdarray_int64::init( bool auto_resize, size_t naxis0, size_t naxis1 )
{
    const size_t naxisx[] = {naxis0, naxis1};
    this->mdarray::init((ssize_t)INT64_ZT, auto_resize, naxisx, 2, true);
    return *this;
}
 ...
 *
 */
mdarray_int64 &mdarray_int64::init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 )
{
    const size_t naxisx[] = {naxis0, naxis1, naxis2};
    this->mdarray::init((ssize_t)INT64_ZT, auto_resize, naxisx, 3, true);
    return *this;
}
 ...
 *          3次元までしかサポートしていません.
 */
size_t mdarray_int64::parse_dim_info( const char *dim_info )
{
    size_t i;
    tarray_tstring arr0;
    this->dinfo_dlen[0] = 0;
...
{
    const size_t naxisx[] = {naxis0};
    this->mdarray::init((ssize_t)INT64_ZT, auto_resize, naxisx, 1, false);
...
{
    const size_t naxisx[] = {naxis0, naxis1};
    this->mdarray::init((ssize_t)INT64_ZT, auto_resize, naxisx, 2, false);
    this->mdarray::putdata((const void *)vals, this->byte_length());
    return *this;
}
...
{
    const size_t naxisx[] = {naxis0, naxis1, naxis2};
    this->mdarray::init((ssize_t)INT64_ZT, auto_resize, naxisx, 3, false);
    this->mdarray::putdata((const void *)vals, this->byte_length());
    return *this;
}
 ...
 * @throw   内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int64 &mdarray_int64::init( bool auto_resize, const char *dim_info, int64_t v0, ... )
{
    va_list ap;
    va_start(ap, v0);
    try {
 ...
 * @throw   内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int64 &mdarray_int64::vinit( bool auto_resize, const char *dim_info, int64_t v0, va_list ap )
{
    size_t ndim = this->parse_dim_info(dim_info);
    if ( ndim < 1 ) {
	this->mdarray::init((ssize_t)INT64_ZT, auto_resize);
    }
    else {
	size_t i;
	this->mdarray::init((ssize_t)INT64_ZT, auto_resize, this->dinfo_dlen, ndim, true);
	i = 0;
	if ( i < this->length() ) this->i64(i) = v0;
	i++;
	for ( ; i < this->length() ; i++ ) {
	    this->i64(i) = va_arg(ap,int64_t);
	}
    }
    return *this;
}
 ...
 *
 */
mdarray_int64 &mdarray_int64::init( const mdarray &obj )
{
    debug_report("( const mdarray &obj )");
 ...
 *            
 */
mdarray_int64 &mdarray_int64::init_properties( const mdarray &src_obj )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::set_auto_resize( bool tf )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::set_auto_init( bool tf )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::set_rounding( bool tf )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::set_alloc_strategy( const char *strategy )
{
...
{
    mdarray_int64 *this_p = (mdarray_int64 *)p;
    int64_t v0 = *((const int64_t *)v0p);
    *((int64_t *)v1p) = (*(this_p->convert_func_rec))(v0, this_p->convert_user_ptr_rec);
}
*/

/*
mdarray_int64 &mdarray_int64::convert( int64_t (*func)(int64_t,void *),
				       void *user_ptr )
{
    this->convert_func_rec = func;
    this->convert_user_ptr_rec = user_ptr;
    this->mdarray::convert((ssize_t)INT64_ZT, &fnc_for_convert, (void *)this);
    return *this;
}
*/
 ...
 * @throw      内部バッファの確保に失敗した場合
 */
mdarray_int64 &mdarray_int64::convert_via_udf( void (*func)(const int64_t *,int64_t *,size_t,int,void *),
				       void *user_ptr )
{
    this->mdarray::convert_via_udf((ssize_t)INT64_ZT,
 ...
 */
mdarray_int64 &mdarray_int64::swap( mdarray &sobj )
{
 ...
 *  dest には，mdarray_int64 クラスのオブジェクトあるいは mdarray クラスの
 ...
 *
 */
ssize_t mdarray_int64::copy( mdarray *dest ) const
{
 ...
 * @deprecated 非推奨．<br>
 * ssize_t mdarray_int64::copy( mdarray *dest ) const <br>
 * をお使いください．
 */
ssize_t mdarray_int64::copy( mdarray &dest ) const
{
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int64 &mdarray_int64::cut( mdarray *dest )
{
    debug_report("( mdarray *dest )");
 ...
 */
mdarray_int64 &mdarray_int64::transpose_xy()
{
 ...
 * @note  高速なアルゴリズムを使用しています．
 */
mdarray_int64 &mdarray_int64::transpose_xyz2zxy()
{
 ...
 * 
 */
mdarray_int64 &mdarray_int64::rotate_xy( int angle )
{
 ...
 *
 */
ssize_t mdarray_int64::get_elements( int64_t *dest_buf, size_t elem_size, 
 ...
 *
 */
ssize_t mdarray_int64::put_elements( const int64_t *src_buf, size_t elem_size,
 ...
 *
 */
mdarray_int64 &mdarray_int64::increase_dim()
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::decrease_dim()
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::resize( size_t len )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::resize( size_t dim_index, size_t len )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::resize( const mdarray &src )
{
 ...
 */
mdarray_int64 &mdarray_int64::resize_1d( size_t x_len )
{
 ...
 */
mdarray_int64 &mdarray_int64::resize_2d( size_t x_len, size_t y_len )
{
 ...
 *  します．
 */
mdarray_int64 &mdarray_int64::resize_3d( size_t x_len, size_t y_len, size_t z_len )
{
 ...
 */
mdarray_int64 &mdarray_int64::resize( const size_t naxisx[], size_t ndim, bool init_buf )
{
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_int64 &mdarray_int64::resizef( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_int64 &mdarray_int64::vresizef( const char *exp_fmt, va_list ap )
{
    this->mdarray::vresizef(exp_fmt,ap);
    return *this;
}
 ...
 *
 */
mdarray_int64 &mdarray_int64::resizeby( ssize_t len )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::resizeby( size_t dim_index, ssize_t len )
{
 ...
 */
mdarray_int64 &mdarray_int64::resizeby_1d( ssize_t x_len )
{
 ...
 */
mdarray_int64 &mdarray_int64::resizeby_2d( ssize_t x_len, ssize_t y_len )
{
 ...
 */
mdarray_int64 &mdarray_int64::resizeby_3d(ssize_t x_len, ssize_t y_len, ssize_t z_len)
{
 ...
 * @throw     内部バッファの確保に失敗した場合
 */
mdarray_int64 &mdarray_int64::resizeby( const ssize_t naxisx_rel[], size_t ndim, 
			    bool init_buf )
{
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_int64 &mdarray_int64::resizebyf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_int64 &mdarray_int64::vresizebyf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vresizebyf(exp_fmt,ap);
    return *this;
}
 ...
 * @throw     内部バッファの確保に失敗した場合
 */
mdarray_int64 &mdarray_int64::reallocate( const size_t naxisx[], size_t ndim, bool init_buf )
{
 ...
 * @throw    内部バッファの確保に失敗した場合
 */
mdarray_int64 &mdarray_int64::allocate( const size_t naxisx[], size_t ndim, bool init_buf )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::assign_default( int64_t value )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::insert( ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::insert( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::erase( ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::erase( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::move( ssize_t idx_src, size_t len, ssize_t idx_dst,
			   bool clr )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::move( size_t dim_index, 
 ...
 *
 */
mdarray_int64 &mdarray_int64::cpy( ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::cpy( size_t dim_index, 
			  ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::swap( ssize_t idx_src, size_t len, ssize_t idx_dst )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::swap( size_t dim_index, 
		      ssize_t idx_src, size_t len, ssize_t idx_dst )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::crop( ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::crop( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 * @deprecated 未実装です.
 */
mdarray_int64 &mdarray_int64::cropf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @deprecated 未実装です.
 */
mdarray_int64 &mdarray_int64::vcropf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vcropf(exp_fmt,ap);
    return *this;
}
 ...
 * @return    自身の参照
 */
mdarray_int64 &mdarray_int64::flip( ssize_t idx, size_t len )
{
 ...
 * @return    自身の参照
 */
mdarray_int64 &mdarray_int64::flip( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
ssize_t mdarray_int64::copyf( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
ssize_t mdarray_int64::vcopyf( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 * @deprecated  未実装
 */
ssize_t mdarray_int64::convertf_copy( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @deprecated  未実装
 */
ssize_t mdarray_int64::vconvertf_copy( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int64 &mdarray_int64::trimf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int64 &mdarray_int64::vtrimf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vtrimf(exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int64 &mdarray_int64::flipf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  任意の次元(複数も可)で配列の並びを反転 (IDLの記法)
 */
mdarray_int64 &mdarray_int64::vflipf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vflipf(exp_fmt, ap);
    return *this;
}
 ...
 */
ssize_t mdarray_int64::transposef_xy_copy( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @brief  (x,y)のトランスポーズを行なった配列を取得 (IDLの記法)
 */
ssize_t mdarray_int64::vtransposef_xy_copy( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 */
ssize_t mdarray_int64::transposef_xyz2zxy_copy( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @brief  (x,y,z)→(z,x,y)のトランスポーズを行なった配列を取得 (IDLの記法)
 */
ssize_t mdarray_int64::vtransposef_xyz2zxy_copy( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 */
mdarray_int64 &mdarray_int64::cleanf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列をデフォルト値でパディング (IDLの記法)
 */
mdarray_int64 &mdarray_int64::vcleanf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vcleanf(exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int64 &mdarray_int64::fillf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を指定されたスカラー値で書き換え (IDLの記法)
 */
mdarray_int64 &mdarray_int64::vfillf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vfillf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int64 &mdarray_int64::fillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_int64 *,void *),
 ...
 * @brief  自身の配列をスカラー値で書き換え (ユーザ関数経由・IDLの記法)
 */
mdarray_int64 &mdarray_int64::vfillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_int64 *,void *),
 ...
 */
mdarray_int64 &mdarray_int64::addf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたスカラー値で加算 (IDLの記法)
 */
mdarray_int64 &mdarray_int64::vaddf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vaddf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int64 &mdarray_int64::subtractf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を，指定されたスカラー値で減算 (IDLの記法)
 */
mdarray_int64 &mdarray_int64::vsubtractf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vsubtractf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int64 &mdarray_int64::multiplyf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたスカラー値を乗算 (IDLの記法)
 */
mdarray_int64 &mdarray_int64::vmultiplyf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vmultiplyf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int64 &mdarray_int64::dividef( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を，指定されたスカラー値で除算 (IDLの記法)
 */
mdarray_int64 &mdarray_int64::vdividef( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vdividef(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int64 &mdarray_int64::pastef( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に指定されたオブジェクトの配列を貼り付け (IDLの記法)
 */
mdarray_int64 &mdarray_int64::vpastef( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vpastef(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int64 &mdarray_int64::pastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_int64 *,void *),
	void *user_ptr,
        const char *exp_fmt, ... )
{
 ...
 * @brief  自身の配列に指定された配列を貼り付け (ユーザ関数経由・IDLの記法)
 */
mdarray_int64 &mdarray_int64::vpastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_int64 *,void *),
	void *user_ptr,
 ...
 */
mdarray_int64 &mdarray_int64::addf( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたオブジェクトの配列を加算 (IDLの記法)
 */
mdarray_int64 &mdarray_int64::vaddf( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vaddf(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int64 &mdarray_int64::subtractf( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief 自身の配列を，指定されたオブジェクトの配列で減算 (IDLの記法)
 */
mdarray_int64 &mdarray_int64::vsubtractf( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vsubtractf(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int64 &mdarray_int64::multiplyf( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたオブジェクトの配列を乗算 (IDLの記法)
 */
mdarray_int64 &mdarray_int64::vmultiplyf( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vmultiplyf(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_int64 &mdarray_int64::dividef( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を，指定されたオブジェクトの配列で除算 (IDLの記法)
 */
mdarray_int64 &mdarray_int64::vdividef( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vdividef(src, exp_fmt, ap);
    return *this;
}
 ...
 *
 */
ssize_t mdarray_int64::copy( mdarray *dest,
 ...
 * @deprecated  未実装
 */
ssize_t mdarray_int64::convert_copy( mdarray *dest,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 */
mdarray_int64 &mdarray_int64::move_from(ssize_t col_idx, size_t col_len,
					  ssize_t row_idx, size_t row_len, 
 ...
 */
mdarray_int64 &mdarray_int64::move_to( 
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_int64 &mdarray_int64::trim( ssize_t col_idx, size_t col_len,
				      ssize_t row_idx, size_t row_len, 
				      ssize_t layer_idx, size_t layer_len )
{
 ...
 * @return    自身の参照
 */
mdarray_int64 &mdarray_int64::flip_cols( ssize_t col_idx, size_t col_len,
					  ssize_t row_idx, size_t row_len, 
					  ssize_t layer_idx, size_t layer_len )
{
 ...
 * @return    自身の参照
 */
mdarray_int64 &mdarray_int64::flip_rows( ssize_t col_idx, size_t col_len,
					  ssize_t row_idx, size_t row_len, 
					  ssize_t layer_idx, size_t layer_len )
{
 ...
 */
ssize_t mdarray_int64::transpose_xy_copy( mdarray *dest,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 */
ssize_t mdarray_int64::transpose_xyz2zxy_copy( mdarray *dest,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 */
ssize_t mdarray_int64::rotate_xy_copy( mdarray *dest, int angle,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::clean( ssize_t col_index, size_t col_size,
 ...
 *
 */
mdarray_int64 &mdarray_int64::fill( double value, 
 ...
 *
 */
mdarray_int64 &mdarray_int64::fill_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_int64 *,void *),
	void *user_ptr,
	ssize_t col_index, size_t col_size,
	ssize_t row_index, size_t row_size,
 ...
 *
 */
mdarray_int64 &mdarray_int64::add( double value, 
		    ssize_t col_index, size_t col_size,
		    ssize_t row_index, size_t row_size,
		    ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::subtract( double value, 
				       ssize_t col_index, size_t col_size,
				       ssize_t row_index, size_t row_size,
				       ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::multiply( double value, 
		    ssize_t col_index, size_t col_size,
		    ssize_t row_index, size_t row_size,
		    ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::divide( double value, 
				       ssize_t col_index, size_t col_size,
				       ssize_t row_index, size_t row_size,
				       ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::paste( const mdarray &src,
	ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::paste_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t,ssize_t,ssize_t,ssize_t,mdarray_int64 *,void *),
	void *user_ptr,
	ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::add( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::subtract( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::multiply( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_int64 &mdarray_int64::divide( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *             ます．
 */
mdarray_int64 &mdarray_int64::register_extptr( int64_t **extptr_address )
{
    this->mdarray::register_extptr((void *)extptr_address);
    return *this;
}
 ...
 *             ます．
 */
mdarray_int64 &mdarray_int64::register_extptr_2d( int64_t *const **extptr2d_address )
{
    this->mdarray::register_extptr_2d((void *)extptr2d_address);
    return *this;
}
 ...
 *             ます．
 */
mdarray_int64 &mdarray_int64::register_extptr_3d( int64_t *const *const **extptr3d_address )
{
    this->mdarray::register_extptr_3d((void *)extptr3d_address);
    return *this;
}
 ...
 *
 */
mdarray_int64 &mdarray_int64::reverse_endian( bool is_little_endian )
{
 ...
 * 
 * @return  型種別 (固定値: int64_t)
 * @note    このメンバ関数はprotectedです．
 */
ssize_t mdarray_int64::default_size_type()
{
    return (ssize_t)INT64_ZT;
}
 ...
 * 
 * @param   sz_type 型種別
 * @return  受け入れ可能な型(int64_t)なら真
 * @note    このメンバ関数はprotectedです．
 */
bool mdarray_int64::is_acceptable_size_type( ssize_t sz_type )
{
    if ( sz_type == (ssize_t)INT64_ZT ) return true;
    else return false;
}
