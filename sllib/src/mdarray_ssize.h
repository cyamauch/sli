...
#ifndef _SLI__MDARRAY_SSIZE_H
#define _SLI__MDARRAY_SSIZE_H 1

/**
 * @file   mdarray_ssize.h
 * @brief  ssize_t型の多次元配列を扱う mdarray_ssize クラスのヘッダファイル
 */
...
/*
 * sli::mdarray_ssize is an inherited class of sli::mdarray, and is a 
...
/**
 * @class  sli::mdarray_ssize
 * @brief  ssize_t型の多次元配列を扱うためのクラス
 *
 *   mdarray_ssizeクラスは，ssize_t型の多次元配列を IDL や Python のように
 ...
 * 
 * @note  mdarray_ssizeクラスは mdarray(基底クラス) を継承しています．<br>
 *        SIMD命令(SSE2)により，基本的な部分が高速化されています．
 * @author  Chisato YAMAUCHI
 * @date  2013-04-01 00:00:00
 */

  class mdarray_ssize : public mdarray
  {

  public:
    /* constructor                                                           */
    /* The mdarray_ssize class has two kinds of operating modes:            */
    ...
    mdarray_ssize();
    mdarray_ssize( bool auto_resize );
    mdarray_ssize( bool auto_resize, ssize_t **extptr_address );
    mdarray_ssize( bool auto_resize, ssize_t *const **extptr2d_address );
    mdarray_ssize( bool auto_resize, ssize_t *const *const **extptr3d_address );
    mdarray_ssize( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf );
    mdarray_ssize( bool auto_resize, size_t naxis0 );
    mdarray_ssize( bool auto_resize, size_t naxis0, size_t naxis1 );
    mdarray_ssize( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 );
    mdarray_ssize( bool auto_resize, size_t naxis0, 
		   const ssize_t vals[] );
    mdarray_ssize( bool auto_resize, size_t naxis0, size_t naxis1,
		   const ssize_t vals[] );
...
#if 0
    mdarray_ssize( bool auto_resize, const char *dim_info, ssize_t v0, ... );
#endif
    mdarray_ssize( const mdarray_ssize &obj );


    /* --------------------------------------------------------------------- */

    /* `virtual' がついてるものはオーバーライドではなくオーバーロード     */
    /*   mdarray_ssize &operator=(const mdarray_ssize &obj);            */
    /* が隠れて存在する事に注意 (演算子 = だけは，特別な規則があるらしい) */

    /* substitute an array (copy the attribute, too)                      */
    virtual mdarray_ssize &operator=(const mdarray &obj);

    /* (overridden) */
    mdarray_ssize &operator+=(const mdarray &obj);
    mdarray_ssize &operator-=(const mdarray &obj);
    mdarray_ssize &operator*=(const mdarray &obj);
    mdarray_ssize &operator/=(const mdarray &obj);

    /* (overridden) */
    mdarray_ssize &operator=(dcomplex v);
    mdarray_ssize &operator=(double v);
    mdarray_ssize &operator=(long long v);
    mdarray_ssize &operator=(long v);
    mdarray_ssize &operator=(int v);
    mdarray_ssize &operator+=(dcomplex v);
    mdarray_ssize &operator+=(double v);
    mdarray_ssize &operator+=(long long v);
    mdarray_ssize &operator+=(long v);
    ...
    */
    ...
    /* <overloaded>                */
    virtual mdarray_ssize &init( bool auto_resize );
    virtual mdarray_ssize &init( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf );
    virtual mdarray_ssize &init( bool auto_resize, size_t naxis0 );
    virtual mdarray_ssize &init( bool auto_resize, size_t naxis0, size_t naxis1 );
    virtual mdarray_ssize &init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 );
    virtual mdarray_ssize &init( bool auto_resize, size_t naxis0, 
				 const ssize_t vals[] );
    virtual mdarray_ssize &init( bool auto_resize, size_t naxis0, size_t naxis1,
				 const ssize_t vals[] );
    ...
    virtual mdarray_ssize &init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2,
				 const ssize_t *const *const vals[] );
#if 0
    virtual mdarray_ssize &init( bool auto_resize, const char *dim_info,
				 ssize_t v0, ... );
    virtual mdarray_ssize &vinit( bool auto_resize, const char *dim_info,
				  ssize_t v0, va_list );
#endif
    /*  mdarray_ssize &init( const mdarray &obj ); が隠れている */
    /*  (↑mdarrayクラスのポインタ経由で呼び出し可能)            */

    /* (overridden)                                           */
    mdarray_ssize &init( const mdarray &obj );

    /* copy properties (auto_resize, auto_init, and rounding) */
    /* (overridden)                                           */
    mdarray_ssize &init_properties( const mdarray &src_obj );

    /* setting of the resize mode */
    /* (overridden)               */
    mdarray_ssize &set_auto_resize( bool tf );

    /* setting of the initialize mode */
    /* (overridden)                   */
    mdarray_ssize &set_auto_init( bool tf );

    /* setting of the rounding off possibility */
    /* (overridden)                            */
    mdarray_ssize &set_rounding( bool tf );

    /* setting of strategy of memory allocation */
    /* "auto", "min" and "pow" can be set.      */
    /* (overridden)                             */
    mdarray_ssize &set_alloc_strategy( const char *strategy );

    /* convert the value of the full array element */
    /* <overloaded>                                */
    virtual mdarray_ssize &convert_via_udf(
		void (*func)(const ssize_t *,ssize_t *,size_t,int,void *),
		void *user_ptr );

    /* swap contents between self and another objects */
    /* (overridden)                 */
    mdarray_ssize &swap( mdarray &sobj );
    ...
    /* (overridden)                             */
    mdarray_ssize &cut( mdarray *dest );

    /* interchange rows and columns */
    /* (overridden)                 */
    mdarray_ssize &transpose_xy();

    /* interchange xyz to zxy */
    /* (overridden)           */
    mdarray_ssize &transpose_xyz2zxy();

    /* rotate image                                              */
    /*   angle: 90,-90, or 180                                   */
    /*          (anticlockwise when image is bottom-left origin) */
    /* (overridden)                                              */
    mdarray_ssize &rotate_xy( int angle );
    ...
    */
    ...
    /* (overridden)                                          */
    mdarray_ssize &assign( dcomplex value,
			    ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF,
			    ssize_t idx2 = MDARRAY_INDEF );
    mdarray_ssize &assign( double value, 
			    ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF,
			    ssize_t idx2 = MDARRAY_INDEF );

    /* a reference to the specified value of the element (1 dimension) */
    virtual ssize_t &operator[]( ssize_t idx0 );
    virtual const ssize_t &operator[]( ssize_t idx0 ) const;

    /* a reference to the specified value of the element (1-3 dimensions) */
    virtual ssize_t &operator()( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				ssize_t idx2 = MDARRAY_INDEF);
    virtual const ssize_t &operator()( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				ssize_t idx2 = MDARRAY_INDEF) const;

    /* a reference to the specified value of the element (1-3 dimensions) */
    virtual ssize_t &at( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
			  ssize_t idx2 = MDARRAY_INDEF);
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const ssize_t &at( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				 ssize_t idx2 = MDARRAY_INDEF) const;
#endif
    virtual const ssize_t &at_cs( ssize_t idx0, ssize_t idx1 = MDARRAY_INDEF, 
				 ssize_t idx2 = MDARRAY_INDEF) const;
    ...
    /* <overloaded>                                */
    virtual mdarray_ssize &put( ssize_t value, ssize_t idx, size_t len );
    virtual mdarray_ssize &put( ssize_t value,
				size_t dim_index, ssize_t idx, size_t len );

    /* copy the array stored in object into the programmer's buffer. */
    /* <overloaded>                                                  */
    virtual ssize_t get_elements( ssize_t *dest_buf, size_t elem_size, 
				ssize_t idx0 = 0, ssize_t idx1 = MDARRAY_INDEF,
				ssize_t idx2 = MDARRAY_INDEF ) const;

    /* copy the array in the programmer's buffer into object's buffer. */
    /* <overloaded>                                                    */
    virtual ssize_t put_elements( const ssize_t *src_buf, size_t elem_size,
				ssize_t idx0 = 0, ssize_t idx1 = MDARRAY_INDEF,
				ssize_t idx2 = MDARRAY_INDEF );
    ...
    /* (overridden)                      */
    mdarray_ssize &increase_dim();

    /* reduction of the dimension number */
    /* (overridden)                      */
    mdarray_ssize &decrease_dim();

    /* change the length of the array */
    /* (overridden)                   */
    mdarray_ssize &resize( size_t len );
    mdarray_ssize &resize( size_t dim_index, size_t len );
    mdarray_ssize &resize( const mdarray &src );

    /* change the length of the 1-d array */
    /* (overridden)                       */
    mdarray_ssize &resize_1d( size_t x_len );

    /* change the length of the 2-d array */
    /* (overridden)                       */
    mdarray_ssize &resize_2d( size_t x_len, size_t y_len );

    /* change the length of the 3-d array */
    /* (overridden)                       */
    mdarray_ssize &resize_3d( size_t x_len, size_t y_len, size_t z_len );

    /* change the length of the array (supports n-dim) */
    /* (overridden)                                    */
    mdarray_ssize &resize( const size_t naxisx[], size_t ndim, 
			    bool init_buf );
    ...
    /* (overridden)                                                   */
    mdarray_ssize &resizef( const char *exp_fmt, ... );
    mdarray_ssize &vresizef( const char *exp_fmt, va_list ap );

    /* change the length of the array relatively */
    /* (overridden)                              */
    mdarray_ssize &resizeby( ssize_t len );			/* for 1-d */
    mdarray_ssize &resizeby( size_t dim_index, ssize_t len );

    /* change the length of the 1-d array relatively */
    /* (overridden)                                  */
    mdarray_ssize &resizeby_1d( ssize_t x_len );

    /* change the length of the 2-d array relatively */
    /* (overridden)                                  */
    mdarray_ssize &resizeby_2d( ssize_t x_len, ssize_t y_len );

    /* change the length of the 3-d array relatively */
    /* (overridden)                                  */
    mdarray_ssize &resizeby_3d(ssize_t x_len, ssize_t y_len, ssize_t z_len);
    ...
    /* (overridden)                                                         */
    mdarray_ssize &resizeby( const ssize_t naxisx_rel[], size_t ndim, 
			       bool init_buf );
    ...
    /* length of first dimension.                                      */
    /* (overridden)                                                    */
    mdarray_ssize &resizebyf( const char *exp_fmt, ... );
    mdarray_ssize &vresizebyf( const char *exp_fmt, va_list ap );

    /* change length of array without adjusting buffer contents */
    /* (overridden)                                             */
    mdarray_ssize &reallocate( const size_t naxisx[], size_t ndim, 
				bool init_buf );

    /* free current buffer and alloc new memory */
    /* (overridden)                             */
    mdarray_ssize &allocate( const size_t naxisx[], size_t ndim, 
			      bool init_buf );

    /* setting of the initial value for .resize(), etc. */
    /* <overloaded>                                     */
    virtual mdarray_ssize &assign_default( ssize_t value );

    /* insert a blank section */
    /* (overridden)           */
    mdarray_ssize &insert( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_ssize &insert( size_t dim_index, ssize_t idx, size_t len );

    /* erase a section */
    /* (overridden)    */
    mdarray_ssize &erase( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_ssize &erase( size_t dim_index, ssize_t idx, size_t len );

    /* copy values between elements (without automatic resizing) */
    /* 移動 (バッファのサイズは変更しない)                       */
    /* (overridden)                                              */
    mdarray_ssize &move( ssize_t idx_src, size_t len, ssize_t idx_dst,
			   bool clr );				/* for 1-d */
    mdarray_ssize &move( size_t dim_index, 
    ...
    /* (overridden)                                           */
    mdarray_ssize &cpy( ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr );				/* for 1-d */
    mdarray_ssize &cpy( size_t dim_index, 
			  ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr );

    /* replace values between elements */
    /* (overridden)                    */
    mdarray_ssize &swap( ssize_t idx_src, size_t len, 
			  ssize_t idx_dst );			/* for 1-d */
    mdarray_ssize &swap( size_t dim_index, 
			   ssize_t idx_src, size_t len, ssize_t idx_dst );

    /* extract a section           */
    /* see also trimf() and trim() */
    /* (overridden)                */
    mdarray_ssize &crop( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_ssize &crop( size_t dim_index, ssize_t idx, size_t len );

    /* flip a section   */
    /* see also flipf() */
    /* (overridden)     */
    mdarray_ssize &flip( ssize_t idx, size_t len );		/* for 1-d */
    mdarray_ssize &flip( size_t dim_index, ssize_t idx, size_t len );
    ...
    */
    ...
    /* Flipping elements is supported */
    /* (overridden)                   */
    mdarray_ssize &trimf( const char *exp_fmt, ... );
    mdarray_ssize &vtrimf( const char *exp_fmt, va_list ap );

    /* flip elements in a section */
    /* (overridden)               */
    mdarray_ssize &flipf( const char *exp_fmt, ... );
    mdarray_ssize &vflipf( const char *exp_fmt, va_list ap );
    ...
    /* (overridden)                        */
    mdarray_ssize &cleanf( const char *exp_fmt, ... );
    mdarray_ssize &vcleanf( const char *exp_fmt, va_list ap );

    /* rewrite element values with a value in a section */
    /* (overridden)                                     */
    mdarray_ssize &fillf( double value, const char *exp_fmt, ... );
    mdarray_ssize &vfillf( double value, const char *exp_fmt, va_list ap );

    /* <overloaded>                                     */
    virtual mdarray_ssize &fillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_ssize *,void *),
        void *user_ptr, const char *exp_fmt, ... );
    virtual mdarray_ssize &vfillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_ssize *,void *),
        void *user_ptr, const char *exp_fmt, va_list ap );

    /* add a scalar value to element values in a section */
    /* (overridden)                                      */
    mdarray_ssize &addf( double value, 
			  const char *exp_fmt, ... );
    mdarray_ssize &vaddf( double value, 
			   const char *exp_fmt, va_list ap );

    /* subtract a scalar value from element values in a section */
    /* (overridden)                                             */
    mdarray_ssize &subtractf( double value, 
			       const char *exp_fmt, ... );
    mdarray_ssize &vsubtractf( double value, 
				const char *exp_fmt, va_list ap );

    /* multiply element values in a section by a scalar value */
    /* (overridden)                                           */
    mdarray_ssize &multiplyf( double value, 
			       const char *exp_fmt, ... );
    mdarray_ssize &vmultiplyf( double value, 
				const char *exp_fmt, va_list ap );

    /* divide element values in a section by a scalar value */
    /* (overridden)                                         */
    mdarray_ssize &dividef( double value, 
			     const char *exp_fmt, ... );
    mdarray_ssize &vdividef( double value, 
			      const char *exp_fmt, va_list ap );
    ...
    /* (overridden)                                                          */
    mdarray_ssize &pastef( const mdarray &src,
			    const char *exp_fmt, ... );
    mdarray_ssize &vpastef( const mdarray &src,
			     const char *exp_fmt, va_list ap );
    ...
    /*   8. user pointer                                                     */
    /* <overloaded>                                                          */
    virtual mdarray_ssize &pastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_ssize *,void *),
	void *user_ptr,
        const char *exp_fmt, ... );
    virtual mdarray_ssize &vpastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_ssize *,void *),
	void *user_ptr,
        const char *exp_fmt, va_list ap );
    ...
    /* add an array object */
    /* (overridden)        */
    mdarray_ssize &addf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_ssize &vaddf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* subtract an array object */
    /* (overridden)             */
    mdarray_ssize &subtractf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_ssize &vsubtractf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* multiply an array object */
    /* (overridden)             */
    mdarray_ssize &multiplyf( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_ssize &vmultiplyf( const mdarray &src_img, const char *exp_fmt, va_list ap );

    /* divide an array object */
    /* (overridden)           */
    mdarray_ssize &dividef( const mdarray &src_img, const char *exp_fmt, ... );
    mdarray_ssize &vdividef( const mdarray &src_img, const char *exp_fmt, va_list ap );
    ...
    */
    ...
    /* rewrite element values with a value in a section */
    /* (overridden)                                     */
    mdarray_ssize &fill( double value,
			 ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
			 ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
			 ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );

    /* <overloaded>                                     */
    virtual mdarray_ssize &fill_via_udf( double value,
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_ssize *,void *),
	void *user_ptr,
	ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
	ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
    ...
    /* add a scalar value to element values in a section */
    /* (overridden)                                      */
    mdarray_ssize &add( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* subtract a scalar value from element values in a section */
    /* (overridden)                                             */
    mdarray_ssize &subtract( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* multiply element values in a section by a scalar value */
    /* (overridden)                                           */
    mdarray_ssize &multiply( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* divide element values in a section by a scalar value */
    /* (overridden)                                         */
    mdarray_ssize &divide( double value, 
		    ssize_t col_index = 0, size_t col_size = MDARRAY_ALL,
		    ssize_t row_index = 0, size_t row_size = MDARRAY_ALL,
		    ssize_t layer_index = 0, size_t layer_size = MDARRAY_ALL );
    ...
    /* paste up an array object */
    /* (overridden)             */
    mdarray_ssize &paste( const mdarray &src,
	ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* <overloaded>             */
    virtual mdarray_ssize &paste_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t,ssize_t,ssize_t,ssize_t,mdarray_ssize *,void *),
	void *user_ptr,
	ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );
    ...
    /* add an array object */
    /* (overridden)        */
    mdarray_ssize &add( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* subtract an array object */
    /* (overridden)             */
    mdarray_ssize &subtract( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* multiply an array object */
    /* (overridden)             */
    mdarray_ssize &multiply( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );

    /* divide an array object */
    /* (overridden)           */
    mdarray_ssize &divide( const mdarray &src_img,
	  ssize_t dest_col = 0, ssize_t dest_row = 0, ssize_t dest_layer = 0 );
    ...
    */
    ...
    /* <overloaded>                                                    */
    virtual mdarray_ssize &register_extptr( ssize_t **extptr_address );
    virtual mdarray_ssize &register_extptr_2d( ssize_t *const **extptr2d_address );
    virtual mdarray_ssize &register_extptr_3d( ssize_t *const *const **extptr3d_address );

    /* Acquire the specified element's address */
    virtual const ssize_t *carray() const;
    virtual const ssize_t *carray( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
    virtual ssize_t *array_ptr();
    virtual ssize_t *array_ptr( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF );
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const ssize_t *array_ptr() const;
    virtual const ssize_t *array_ptr( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
#endif
    virtual const ssize_t *array_ptr_cs() const;
    virtual const ssize_t *array_ptr_cs( ssize_t idx0, 
	    ssize_t idx1 = MDARRAY_INDEF, ssize_t idx2 = MDARRAY_INDEF ) const;
    ...
    virtual ssize_t *const *array_ptr_2d( bool use );
    /* followings have no overhead. Execute .array_ptr_2d(true) before use. */
    virtual ssize_t *const *array_ptr_2d();
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const ssize_t *const *array_ptr_2d() const;
#endif
    virtual const ssize_t *const *array_ptr_2d_cs() const;
    ...
    /*        "use=false" when there is no requirement of referring         */
    /*        obtained address table.                                       */
    virtual ssize_t *const *const *array_ptr_3d( bool use );
    /* followings have no overhead. Execute .array_ptr_3d(true) before use. */
    virtual ssize_t *const *const *array_ptr_3d();
#ifdef SLI__OVERLOAD_CONST_AT
    virtual const ssize_t *const *const *array_ptr_3d() const;
#endif
    virtual const ssize_t *const *const *array_ptr_3d_cs() const;
    ...
    */
    ...
    /* (overridden)                    */
    mdarray_ssize &reverse_endian( bool is_little_endian );
    /* (overridden)                    */
    mdarray_ssize &reverse_endian( bool is_little_endian, 
				    size_t begin, size_t length );

    /* acquisition of the initial value */
    virtual ssize_t default_value() const;
 ...
 *
 */
inline mdarray_ssize &mdarray_ssize::put( ssize_t value, ssize_t idx, size_t len )
{
 ...
 *
 */
inline mdarray_ssize &mdarray_ssize::put( ssize_t value,
				    size_t dim_index, ssize_t idx, size_t len )
{
 ...
 */
inline mdarray_ssize &mdarray_ssize::assign( dcomplex value,
 ...
 *
 */
inline mdarray_ssize &mdarray_ssize::assign( double value, 
				     ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
    this->mdarray::assign(value, idx0, idx1, idx2);
    return *this;
 ...
 *
 */
inline ssize_t &mdarray_ssize::operator[]( ssize_t idx0 )
{
    return ((0 <= idx0 && idx0 < (ssize_t)this->length()) ? 
	    ((ssize_t *)(this->data_ptr()))[idx0] :
	    this->at(idx0));
}
 ...
 *
 */
inline const ssize_t &mdarray_ssize::operator[]( ssize_t idx0 ) const
{
    return ((0 <= idx0 && idx0 < (ssize_t)this->length()) ? 
	    ((const ssize_t *)(this->data_ptr_cs()))[idx0] :
	    this->at_cs(idx0));
}
 ...
 *
 */
inline ssize_t &mdarray_ssize::operator()( ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
 ...
 *
 */
inline const ssize_t &mdarray_ssize::operator()( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
 ...
 *
 */
inline ssize_t &mdarray_ssize::at( ssize_t idx0, ssize_t idx1, ssize_t idx2 )
{
    ssize_t idx = this->get_idx_3d(idx0,idx1,idx2);
    if ( 0 <= idx ) {
	return ((ssize_t *)(this->data_ptr()))[idx];
    }
    else {
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const ssize_t &mdarray_ssize::at( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
    return this->at_cs(idx0, idx1, idx2);
}
#endif
 ...
 *
 */
inline const ssize_t &mdarray_ssize::at_cs( ssize_t idx0, ssize_t idx1, ssize_t idx2 ) const
{
    ssize_t idx = this->get_idx_3d_cs(idx0,idx1,idx2);
    if ( 0 <= idx ) {
	return ((const ssize_t *)(this->data_ptr()))[idx];
    }
    else {
	ssize_t *p = (ssize_t *)(this->junk_rec);
	*p = 0;
 ...
 *
 */
inline mdarray_ssize &mdarray_ssize::ceil()
{
    this->mdarray::ceil();
    return *this;
}
 ...
 *
 */
inline mdarray_ssize &mdarray_ssize::floor()
{
    this->mdarray::floor();
    return *this;
}
 ...
 *
 */
inline mdarray_ssize &mdarray_ssize::round()
{
    this->mdarray::round();
    return *this;
}
 ...
 *
 */
inline mdarray_ssize &mdarray_ssize::trunc()
{
    this->mdarray::trunc();
    return *this;
}
 ...
 *
 */
inline mdarray_ssize &mdarray_ssize::abs()
{
    this->mdarray::abs();
    return *this;
}
 ...
 *
 */
inline const ssize_t *mdarray_ssize::carray() const
{
    return (const ssize_t *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const ssize_t *mdarray_ssize::carray( ssize_t idx0, 
				     ssize_t idx1, ssize_t idx2 ) const
{
    return (const ssize_t *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *
 */
inline ssize_t *mdarray_ssize::array_ptr()
{
    return (ssize_t *)(this->data_ptr());
}
 ...
 *
 */
inline ssize_t *mdarray_ssize::array_ptr( ssize_t idx0, 
				  ssize_t idx1, ssize_t idx2 )
{
    return (ssize_t *)(this->data_ptr(idx0,idx1,idx2));
}
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const ssize_t *mdarray_ssize::array_ptr() const
{
    return (const ssize_t *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const ssize_t *mdarray_ssize::array_ptr( ssize_t idx0, 
					   ssize_t idx1, ssize_t idx2 ) const
{
    return (const ssize_t *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *
 */
inline const ssize_t *mdarray_ssize::array_ptr_cs() const
{
    return (const ssize_t *)(this->data_ptr_cs());
}
 ...
 *
 */
inline const ssize_t *mdarray_ssize::array_ptr_cs( ssize_t idx0, 
					   ssize_t idx1, ssize_t idx2 ) const
{
    return (const ssize_t *)(this->data_ptr_cs(idx0,idx1,idx2));
}
 ...
 *             使用しない場合はfalse(機能off)．
 */
inline ssize_t *const *mdarray_ssize::array_ptr_2d( bool use )
{
    return (ssize_t *const *)(this->mdarray::data_ptr_2d(use));
}

/**
 * @brief  内部で生成された2次元配列用ポインタ配列のアドレスを取得
 */
inline ssize_t *const *mdarray_ssize::array_ptr_2d()
{
    return (ssize_t *const *)(this->mdarray::data_ptr_2d());
}
 ...
 */
#ifdef SLI__OVERLOAD_CONST_AT
inline const ssize_t *const *mdarray_ssize::array_ptr_2d() const
{
    return (const ssize_t *const *)(this->mdarray::data_ptr_2d_cs());
}
#endif
 ...
 * @brief  内部で生成された2次元配列用ポインタ配列のアドレスを取得 (読取専用)
 */
inline const ssize_t *const *mdarray_ssize::array_ptr_2d_cs() const
{
    return (const ssize_t *const *)(this->mdarray::data_ptr_2d_cs());
}
 ...
 *             使用しない場合はfalse(機能off)．
 */
inline ssize_t *const *const *mdarray_ssize::array_ptr_3d( bool use )
{
    return (ssize_t *const *const *)(this->mdarray::data_ptr_3d(use));
}

/**
 * @brief  内部で生成された3次元配列用ポインタ配列のアドレスを取得
 */
inline ssize_t *const *const *mdarray_ssize::array_ptr_3d()
{
    return (ssize_t *const *const *)(this->mdarray::data_ptr_3d());
}
 ...
 */
inline const ssize_t *const *const *mdarray_ssize::array_ptr_3d() const
{
    return (const ssize_t *const *const *)(this->mdarray::data_ptr_3d_cs());
}
#endif
 ...
 * @brief  内部で生成された3次元配列用ポインタ配列のアドレスを取得 (読取専用)
 */
inline const ssize_t *const *const *mdarray_ssize::array_ptr_3d_cs() const
{
    return (const ssize_t *const *const *)(this->mdarray::data_ptr_3d_cs());
}
 ...
 *
 */
inline ssize_t mdarray_ssize::default_value() const
{
    const ssize_t *p = (const ssize_t *)(this->default_value_ptr());
    if ( p == NULL ) return 0;
    else return *p;
}
