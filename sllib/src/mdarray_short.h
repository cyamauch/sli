 ...
 * @brief  short型の多次元配列を扱う mdarray_short クラスのヘッダファイル
 */
 ...
 * @brief  short型の多次元配列を扱うためのクラス
 *
 *   mdarray_shortクラスは，short型の多次元配列を IDL や Python のように
 ...
 * 
 * @note  mdarray_shortクラスは mdarray(基底クラス) を継承しています．<br>
  ...
  public:
    ...
    */
    ...
    virtual mdarray_short &vinit( bool auto_resize, const char *dim_info,
				  int v0, va_list );
#endif
    /*  mdarray_short &init( const mdarray &obj ); が隠れている */
