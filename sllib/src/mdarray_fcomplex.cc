...
/**
 * @file   mdarray_fcomplex.cc
 * @brief  fcomplex型の多次元配列を扱う mdarray_fcomplex クラスのコード
 */

#define CLASS_NAME "mdarray_fcomplex"
 ...
 */
mdarray_fcomplex::mdarray_fcomplex()
{
    this->class_level_rec ++;
    this->mdarray::init(FCOMPLEX_ZT, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_fcomplex::mdarray_fcomplex( bool auto_r )
{
    this->class_level_rec ++;
    this->mdarray::init(FCOMPLEX_ZT, auto_r);
    return;
}
 ...
 *             ます．
 */
mdarray_fcomplex::mdarray_fcomplex( bool auto_r, fcomplex **extptr_address )
{
    this->class_level_rec ++;
    this->mdarray::init(FCOMPLEX_ZT, auto_r);
 ...
 *             ます．
 */
mdarray_fcomplex::mdarray_fcomplex( bool auto_r, fcomplex *const **extptr2d_address )
{
    this->class_level_rec ++;
    this->mdarray::init(FCOMPLEX_ZT, auto_r);
 ...
 *             ます．
 */
mdarray_fcomplex::mdarray_fcomplex( bool auto_r, fcomplex *const *const **extptr3d_address )
{
    this->class_level_rec ++;
    this->mdarray::init(FCOMPLEX_ZT, auto_r);
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_fcomplex::mdarray_fcomplex( bool auto_r, const size_t naxisx[], size_t ndim, bool init_buf )
{
    this->class_level_rec ++;
    this->mdarray::init(FCOMPLEX_ZT, auto_r, naxisx, ndim, init_buf);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
*/
mdarray_fcomplex::mdarray_fcomplex( bool auto_r, size_t naxis0 )
{
    const size_t naxisx[] = {naxis0};
    this->class_level_rec ++;
    this->mdarray::init(FCOMPLEX_ZT, auto_r, naxisx, 1, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_fcomplex::mdarray_fcomplex( bool auto_r, size_t naxis0, size_t naxis1 )
{
    const size_t naxisx[] = {naxis0, naxis1};
    this->class_level_rec ++;
    this->mdarray::init(FCOMPLEX_ZT, auto_r, naxisx, 2, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_fcomplex::mdarray_fcomplex( bool auto_r, size_t naxis0, size_t naxis1, size_t naxis2 )
{
    const size_t naxisx[] = {naxis0, naxis1, naxis2};
    this->class_level_rec ++;
    this->mdarray::init(FCOMPLEX_ZT, auto_r, naxisx, 3, true);
    return;
}
 ...
 */
mdarray_fcomplex::mdarray_fcomplex( bool auto_r, size_t naxis0, size_t naxis1, size_t naxis2,
			      const fcomplex *const *const vals[] )
{
    this->class_level_rec ++;
    this->init(auto_r, naxis0, naxis1, naxis2, vals);
    return;
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_fcomplex::mdarray_fcomplex( bool auto_r, const char *dim_info,
			      fcomplex v0, ... )
{
    va_list ap;
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_fcomplex::mdarray_fcomplex( const mdarray_fcomplex &obj )
{
    this->class_level_rec ++;
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::operator=(const mdarray &obj)
{
    debug_report("(const mdarray &obj)");
    if ( &obj == this ) return *this;

    if ( obj.size_type() == FCOMPLEX_ZT ) {
	this->mdarray::init(obj);
    }
    else {
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::operator=(dcomplex v)
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::operator=(double v)
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::operator=(long long v)
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::operator=(long v)
{
    debug_report("(long v)");
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::operator=(int v)
{
    debug_report("(int v)");
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::init()
{
    debug_report("()");
    this->mdarray::init();
    return *this;
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::init( bool auto_resize )
{
    this->mdarray::init();
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::init( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf )
{
    this->mdarray::init(FCOMPLEX_ZT, auto_resize, naxisx, ndim, init_buf);
    return *this;
}
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::init( bool auto_resize, size_t naxis0 )
{
    const size_t naxisx[] = {naxis0};
    this->mdarray::init(FCOMPLEX_ZT, auto_resize, naxisx, 1, true);
    return *this;
}
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::init( bool auto_resize, size_t naxis0, size_t naxis1 )
{
    const size_t naxisx[] = {naxis0, naxis1};
    this->mdarray::init(FCOMPLEX_ZT, auto_resize, naxisx, 2, true);
    return *this;
}
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 )
{
    const size_t naxisx[] = {naxis0, naxis1, naxis2};
    this->mdarray::init(FCOMPLEX_ZT, auto_resize, naxisx, 3, true);
    return *this;
}
 ...
 *          3次元までしかサポートしていません.
 */
size_t mdarray_fcomplex::parse_dim_info( const char *dim_info )
{
    size_t i;
    tarray_tstring arr0;
    this->dinfo_dlen[0] = 0;
...
{
    const size_t naxisx[] = {naxis0};
    this->mdarray::init(FCOMPLEX_ZT, auto_resize, naxisx, 1, false);
...
{
    const size_t naxisx[] = {naxis0, naxis1};
    this->mdarray::init(FCOMPLEX_ZT, auto_resize, naxisx, 2, false);
    this->mdarray::putdata((const void *)vals, this->byte_length());
    return *this;
}
...
{
    const size_t naxisx[] = {naxis0, naxis1, naxis2};
    this->mdarray::init(FCOMPLEX_ZT, auto_resize, naxisx, 3, false);
    this->mdarray::putdata((const void *)vals, this->byte_length());
    return *this;
}
 ...
 * @throw   内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_fcomplex &mdarray_fcomplex::init( bool auto_resize, const char *dim_info, fcomplex v0, ... )
{
    va_list ap;
    va_start(ap, v0);
    try {
 ...
 * @throw   内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_fcomplex &mdarray_fcomplex::vinit( bool auto_resize, const char *dim_info, fcomplex v0, va_list ap )
{
    size_t ndim = this->parse_dim_info(dim_info);
    if ( ndim < 1 ) {
	this->mdarray::init(FCOMPLEX_ZT, auto_resize);
    }
    else {
	size_t i;
	this->mdarray::init(FCOMPLEX_ZT, auto_resize, this->dinfo_dlen, ndim, true);
	i = 0;
	if ( i < this->length() ) this->fx(i) = v0;
	i++;
	for ( ; i < this->length() ; i++ ) {
	    this->fx(i) = va_arg(ap,fcomplex);
	}
    }
    return *this;
}
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::init( const mdarray &obj )
{
    debug_report("( const mdarray &obj )");
 ...
 *            
 */
mdarray_fcomplex &mdarray_fcomplex::init_properties( const mdarray &src_obj )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::set_auto_resize( bool tf )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::set_auto_init( bool tf )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::set_rounding( bool tf )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::set_alloc_strategy( const char *strategy )
{
...
{
    mdarray_fcomplex *this_p = (mdarray_fcomplex *)p;
    fcomplex v0 = *((const fcomplex *)v0p);
    *((fcomplex *)v1p) = (*(this_p->convert_func_rec))(v0, this_p->convert_user_ptr_rec);
}
*/

/*
mdarray_fcomplex &mdarray_fcomplex::convert( fcomplex (*func)(fcomplex,void *),
				       void *user_ptr )
{
    this->convert_func_rec = func;
    this->convert_user_ptr_rec = user_ptr;
    this->mdarray::convert(FCOMPLEX_ZT, &fnc_for_convert, (void *)this);
    return *this;
}
*/
 ...
 * @throw      内部バッファの確保に失敗した場合
 */
mdarray_fcomplex &mdarray_fcomplex::convert_via_udf( void (*func)(const fcomplex *,fcomplex *,size_t,int,void *),
				       void *user_ptr )
{
    this->mdarray::convert_via_udf(FCOMPLEX_ZT,
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::swap( mdarray &sobj )
{
 ...
 *  dest には，mdarray_fcomplex クラスのオブジェクトあるいは mdarray クラスの
 ...
 *
 */
ssize_t mdarray_fcomplex::copy( mdarray *dest ) const
{
 ...
 * @deprecated 非推奨．<br>
 * ssize_t mdarray_fcomplex::copy( mdarray *dest ) const <br>
 * をお使いください．
 */
ssize_t mdarray_fcomplex::copy( mdarray &dest ) const
{
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_fcomplex &mdarray_fcomplex::cut( mdarray *dest )
{
    debug_report("( mdarray *dest )");
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::transpose_xy()
{
 ...
 * @note  高速なアルゴリズムを使用しています．
 */
mdarray_fcomplex &mdarray_fcomplex::transpose_xyz2zxy()
{
 ...
 * 
 */
mdarray_fcomplex &mdarray_fcomplex::rotate_xy( int angle )
{
 ...
 *
 */
ssize_t mdarray_fcomplex::get_elements( fcomplex *dest_buf, size_t elem_size, 
 ...
 *
 */
ssize_t mdarray_fcomplex::put_elements( const fcomplex *src_buf, size_t elem_size,
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::increase_dim()
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::decrease_dim()
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::resize( size_t len )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::resize( size_t dim_index, size_t len )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::resize( const mdarray &src )
{
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::resize_1d( size_t x_len )
{
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::resize_2d( size_t x_len, size_t y_len )
{
 ...
 *  します．
 */
mdarray_fcomplex &mdarray_fcomplex::resize_3d( size_t x_len, size_t y_len, size_t z_len )
{
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::resize( const size_t naxisx[], size_t ndim, bool init_buf )
{
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_fcomplex &mdarray_fcomplex::resizef( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_fcomplex &mdarray_fcomplex::vresizef( const char *exp_fmt, va_list ap )
{
    this->mdarray::vresizef(exp_fmt,ap);
    return *this;
}
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::resizeby( ssize_t len )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::resizeby( size_t dim_index, ssize_t len )
{
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::resizeby_1d( ssize_t x_len )
{
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::resizeby_2d( ssize_t x_len, ssize_t y_len )
{
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::resizeby_3d(ssize_t x_len, ssize_t y_len, ssize_t z_len)
{
 ...
 * @throw     内部バッファの確保に失敗した場合
 */
mdarray_fcomplex &mdarray_fcomplex::resizeby( const ssize_t naxisx_rel[], size_t ndim, 
			    bool init_buf )
{
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_fcomplex &mdarray_fcomplex::resizebyf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_fcomplex &mdarray_fcomplex::vresizebyf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vresizebyf(exp_fmt,ap);
    return *this;
}
 ...
 * @throw     内部バッファの確保に失敗した場合
 */
mdarray_fcomplex &mdarray_fcomplex::reallocate( const size_t naxisx[], size_t ndim, bool init_buf )
{
 ...
 * @throw    内部バッファの確保に失敗した場合
 */
mdarray_fcomplex &mdarray_fcomplex::allocate( const size_t naxisx[], size_t ndim, bool init_buf )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::assign_default( fcomplex value )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::insert( ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::insert( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::erase( ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::erase( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::move( ssize_t idx_src, size_t len, ssize_t idx_dst,
			   bool clr )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::move( size_t dim_index, 
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::cpy( ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::cpy( size_t dim_index, 
			  ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::swap( ssize_t idx_src, size_t len, ssize_t idx_dst )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::swap( size_t dim_index, 
		      ssize_t idx_src, size_t len, ssize_t idx_dst )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::crop( ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::crop( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 * @deprecated 未実装です.
 */
mdarray_fcomplex &mdarray_fcomplex::cropf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @deprecated 未実装です.
 */
mdarray_fcomplex &mdarray_fcomplex::vcropf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vcropf(exp_fmt,ap);
    return *this;
}
 ...
 * @return    自身の参照
 */
mdarray_fcomplex &mdarray_fcomplex::flip( ssize_t idx, size_t len )
{
 ...
 * @return    自身の参照
 */
mdarray_fcomplex &mdarray_fcomplex::flip( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
ssize_t mdarray_fcomplex::copyf( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
ssize_t mdarray_fcomplex::vcopyf( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 * @deprecated  未実装
 */
ssize_t mdarray_fcomplex::convertf_copy( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @deprecated  未実装
 */
ssize_t mdarray_fcomplex::vconvertf_copy( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_fcomplex &mdarray_fcomplex::trimf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_fcomplex &mdarray_fcomplex::vtrimf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vtrimf(exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::flipf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  任意の次元(複数も可)で配列の並びを反転 (IDLの記法)
 */
mdarray_fcomplex &mdarray_fcomplex::vflipf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vflipf(exp_fmt, ap);
    return *this;
}
 ...
 */
ssize_t mdarray_fcomplex::transposef_xy_copy( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @brief  (x,y)のトランスポーズを行なった配列を取得 (IDLの記法)
 */
ssize_t mdarray_fcomplex::vtransposef_xy_copy( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 */
ssize_t mdarray_fcomplex::transposef_xyz2zxy_copy( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @brief  (x,y,z)→(z,x,y)のトランスポーズを行なった配列を取得 (IDLの記法)
 */
ssize_t mdarray_fcomplex::vtransposef_xyz2zxy_copy( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::cleanf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列をデフォルト値でパディング (IDLの記法)
 */
mdarray_fcomplex &mdarray_fcomplex::vcleanf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vcleanf(exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::fillf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を指定されたスカラー値で書き換え (IDLの記法)
 */
mdarray_fcomplex &mdarray_fcomplex::vfillf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vfillf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::fillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_fcomplex *,void *),
 ...
 * @brief  自身の配列をスカラー値で書き換え (ユーザ関数経由・IDLの記法)
 */
mdarray_fcomplex &mdarray_fcomplex::vfillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_fcomplex *,void *),
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::addf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたスカラー値で加算 (IDLの記法)
 */
mdarray_fcomplex &mdarray_fcomplex::vaddf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vaddf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::subtractf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を，指定されたスカラー値で減算 (IDLの記法)
 */
mdarray_fcomplex &mdarray_fcomplex::vsubtractf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vsubtractf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::multiplyf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたスカラー値を乗算 (IDLの記法)
 */
mdarray_fcomplex &mdarray_fcomplex::vmultiplyf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vmultiplyf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::dividef( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を，指定されたスカラー値で除算 (IDLの記法)
 */
mdarray_fcomplex &mdarray_fcomplex::vdividef( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vdividef(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::pastef( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に指定されたオブジェクトの配列を貼り付け (IDLの記法)
 */
mdarray_fcomplex &mdarray_fcomplex::vpastef( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vpastef(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::pastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_fcomplex *,void *),
	void *user_ptr,
        const char *exp_fmt, ... )
{
 ...
 * @brief  自身の配列に指定された配列を貼り付け (ユーザ関数経由・IDLの記法)
 */
mdarray_fcomplex &mdarray_fcomplex::vpastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_fcomplex *,void *),
	void *user_ptr,
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::addf( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたオブジェクトの配列を加算 (IDLの記法)
 */
mdarray_fcomplex &mdarray_fcomplex::vaddf( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vaddf(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::subtractf( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief 自身の配列を，指定されたオブジェクトの配列で減算 (IDLの記法)
 */
mdarray_fcomplex &mdarray_fcomplex::vsubtractf( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vsubtractf(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::multiplyf( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたオブジェクトの配列を乗算 (IDLの記法)
 */
mdarray_fcomplex &mdarray_fcomplex::vmultiplyf( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vmultiplyf(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::dividef( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を，指定されたオブジェクトの配列で除算 (IDLの記法)
 */
mdarray_fcomplex &mdarray_fcomplex::vdividef( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vdividef(src, exp_fmt, ap);
    return *this;
}
 ...
 *
 */
ssize_t mdarray_fcomplex::copy( mdarray *dest,
 ...
 * @deprecated  未実装
 */
ssize_t mdarray_fcomplex::convert_copy( mdarray *dest,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::move_from(ssize_t col_idx, size_t col_len,
					  ssize_t row_idx, size_t row_len, 
 ...
 */
mdarray_fcomplex &mdarray_fcomplex::move_to( 
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_fcomplex &mdarray_fcomplex::trim( ssize_t col_idx, size_t col_len,
				      ssize_t row_idx, size_t row_len, 
				      ssize_t layer_idx, size_t layer_len )
{
 ...
 * @return    自身の参照
 */
mdarray_fcomplex &mdarray_fcomplex::flip_cols( ssize_t col_idx, size_t col_len,
					  ssize_t row_idx, size_t row_len, 
					  ssize_t layer_idx, size_t layer_len )
{
 ...
 * @return    自身の参照
 */
mdarray_fcomplex &mdarray_fcomplex::flip_rows( ssize_t col_idx, size_t col_len,
					  ssize_t row_idx, size_t row_len, 
					  ssize_t layer_idx, size_t layer_len )
{
 ...
 */
ssize_t mdarray_fcomplex::transpose_xy_copy( mdarray *dest,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 */
ssize_t mdarray_fcomplex::transpose_xyz2zxy_copy( mdarray *dest,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 */
ssize_t mdarray_fcomplex::rotate_xy_copy( mdarray *dest, int angle,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::clean( ssize_t col_index, size_t col_size,
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::fill( double value, 
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::fill_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_fcomplex *,void *),
	void *user_ptr,
	ssize_t col_index, size_t col_size,
	ssize_t row_index, size_t row_size,
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::add( double value, 
		    ssize_t col_index, size_t col_size,
		    ssize_t row_index, size_t row_size,
		    ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::subtract( double value, 
				       ssize_t col_index, size_t col_size,
				       ssize_t row_index, size_t row_size,
				       ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::multiply( double value, 
		    ssize_t col_index, size_t col_size,
		    ssize_t row_index, size_t row_size,
		    ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::divide( double value, 
				       ssize_t col_index, size_t col_size,
				       ssize_t row_index, size_t row_size,
				       ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::paste( const mdarray &src,
	ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::paste_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t,ssize_t,ssize_t,ssize_t,mdarray_fcomplex *,void *),
	void *user_ptr,
	ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::add( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::subtract( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::multiply( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::divide( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *             ます．
 */
mdarray_fcomplex &mdarray_fcomplex::register_extptr( fcomplex **extptr_address )
{
    this->mdarray::register_extptr((void *)extptr_address);
    return *this;
}
 ...
 *             ます．
 */
mdarray_fcomplex &mdarray_fcomplex::register_extptr_2d( fcomplex *const **extptr2d_address )
{
    this->mdarray::register_extptr_2d((void *)extptr2d_address);
    return *this;
}
 ...
 *             ます．
 */
mdarray_fcomplex &mdarray_fcomplex::register_extptr_3d( fcomplex *const *const **extptr3d_address )
{
    this->mdarray::register_extptr_3d((void *)extptr3d_address);
    return *this;
}
 ...
 *
 */
mdarray_fcomplex &mdarray_fcomplex::reverse_endian( bool is_little_endian )
{
 ...
 * 
 * @return  型種別 (固定値: fcomplex)
 * @note    このメンバ関数はprotectedです．
 */
ssize_t mdarray_fcomplex::default_size_type()
{
    return FCOMPLEX_ZT;
}
 ...
 * 
 * @param   sz_type 型種別
 * @return  受け入れ可能な型(fcomplex)なら真
 * @note    このメンバ関数はprotectedです．
 */
bool mdarray_fcomplex::is_acceptable_size_type( ssize_t sz_type )
{
    if ( sz_type == FCOMPLEX_ZT ) return true;
    else return false;
}
