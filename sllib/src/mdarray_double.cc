...
/**
 * @file   mdarray_double.cc
 * @brief  double型の多次元配列を扱う mdarray_double クラスのコード
 */

#define CLASS_NAME "mdarray_double"
 ...
 */
mdarray_double::mdarray_double()
{
    this->class_level_rec ++;
    this->mdarray::init(DOUBLE_ZT, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_double::mdarray_double( bool auto_r )
{
    this->class_level_rec ++;
    this->mdarray::init(DOUBLE_ZT, auto_r);
    return;
}
 ...
 *             ます．
 */
mdarray_double::mdarray_double( bool auto_r, double **extptr_address )
{
    this->class_level_rec ++;
    this->mdarray::init(DOUBLE_ZT, auto_r);
 ...
 *             ます．
 */
mdarray_double::mdarray_double( bool auto_r, double *const **extptr2d_address )
{
    this->class_level_rec ++;
    this->mdarray::init(DOUBLE_ZT, auto_r);
 ...
 *             ます．
 */
mdarray_double::mdarray_double( bool auto_r, double *const *const **extptr3d_address )
{
    this->class_level_rec ++;
    this->mdarray::init(DOUBLE_ZT, auto_r);
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_double::mdarray_double( bool auto_r, const size_t naxisx[], size_t ndim, bool init_buf )
{
    this->class_level_rec ++;
    this->mdarray::init(DOUBLE_ZT, auto_r, naxisx, ndim, init_buf);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
*/
mdarray_double::mdarray_double( bool auto_r, size_t naxis0 )
{
    const size_t naxisx[] = {naxis0};
    this->class_level_rec ++;
    this->mdarray::init(DOUBLE_ZT, auto_r, naxisx, 1, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_double::mdarray_double( bool auto_r, size_t naxis0, size_t naxis1 )
{
    const size_t naxisx[] = {naxis0, naxis1};
    this->class_level_rec ++;
    this->mdarray::init(DOUBLE_ZT, auto_r, naxisx, 2, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_double::mdarray_double( bool auto_r, size_t naxis0, size_t naxis1, size_t naxis2 )
{
    const size_t naxisx[] = {naxis0, naxis1, naxis2};
    this->class_level_rec ++;
    this->mdarray::init(DOUBLE_ZT, auto_r, naxisx, 3, true);
    return;
}
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_double::mdarray_double( bool auto_r, const char *dim_info,
			      double v0, ... )
{
    va_list ap;
 ...
 * @throw  内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_double::mdarray_double( const mdarray_double &obj )
{
    this->class_level_rec ++;
 ...
 *
 */
mdarray_double &mdarray_double::operator=(const mdarray &obj)
{
 ...
 *
 */
mdarray_double &mdarray_double::operator=(dcomplex v)
{
 ...
 *
 */
mdarray_double &mdarray_double::operator=(double v)
{
 ...
 *
 */
mdarray_double &mdarray_double::operator=(long long v)
{
 ...
 *
 */
mdarray_double &mdarray_double::operator=(long v)
{
    debug_report("(long v)");
 ...
 *
 */
mdarray_double &mdarray_double::operator=(int v)
{
    debug_report("(int v)");
 ...
 *
 */
mdarray_double &mdarray_double::init()
{
    debug_report("()");
    this->mdarray::init();
    return *this;
 ...
 *
 */
mdarray_double &mdarray_double::init( bool auto_resize )
{
    this->mdarray::init();
 ...
 *
 */
mdarray_double &mdarray_double::init( bool auto_resize, const size_t naxisx[], size_t ndim, bool init_buf )
{
    this->mdarray::init(DOUBLE_ZT, auto_resize, naxisx, ndim, init_buf);
    return *this;
}
 ...
 *
 */
mdarray_double &mdarray_double::init( bool auto_resize, size_t naxis0 )
{
    const size_t naxisx[] = {naxis0};
    this->mdarray::init(DOUBLE_ZT, auto_resize, naxisx, 1, true);
    return *this;
}
 ...
 *
 */
mdarray_double &mdarray_double::init( bool auto_resize, size_t naxis0, size_t naxis1 )
{
    const size_t naxisx[] = {naxis0, naxis1};
    this->mdarray::init(DOUBLE_ZT, auto_resize, naxisx, 2, true);
    return *this;
}
 ...
 *
 */
mdarray_double &mdarray_double::init( bool auto_resize, size_t naxis0, size_t naxis1, size_t naxis2 )
{
    const size_t naxisx[] = {naxis0, naxis1, naxis2};
    this->mdarray::init(DOUBLE_ZT, auto_resize, naxisx, 3, true);
    return *this;
}
 ...
 *          3次元までしかサポートしていません.
 */
size_t mdarray_double::parse_dim_info( const char *dim_info )
{
    size_t i;
    tarray_tstring arr0;
    this->dinfo_dlen[0] = 0;
...
{
    const size_t naxisx[] = {naxis0};
    this->mdarray::init(DOUBLE_ZT, auto_resize, naxisx, 1, false);
...
{
    const size_t naxisx[] = {naxis0, naxis1};
    this->mdarray::init(DOUBLE_ZT, auto_resize, naxisx, 2, false);
    this->mdarray::putdata((const void *)vals, this->byte_length());
    return *this;
}
...
{
    const size_t naxisx[] = {naxis0, naxis1, naxis2};
    this->mdarray::init(DOUBLE_ZT, auto_resize, naxisx, 3, false);
    this->mdarray::putdata((const void *)vals, this->byte_length());
    return *this;
}
 ...
 * @throw   内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_double &mdarray_double::init( bool auto_resize, const char *dim_info, double v0, ... )
{
    va_list ap;
    va_start(ap, v0);
    try {
 ...
 * @throw   内部バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_double &mdarray_double::vinit( bool auto_resize, const char *dim_info, double v0, va_list ap )
{
    size_t ndim = this->parse_dim_info(dim_info);
    if ( ndim < 1 ) {
	this->mdarray::init(DOUBLE_ZT, auto_resize);
    }
    else {
	size_t i;
	this->mdarray::init(DOUBLE_ZT, auto_resize, this->dinfo_dlen, ndim, true);
	i = 0;
	if ( i < this->length() ) this->d(i) = v0;
	i++;
	for ( ; i < this->length() ; i++ ) {
	    this->d(i) = va_arg(ap,double);
	}
    }
    return *this;
}
 ...
 *
 */
mdarray_double &mdarray_double::init( const mdarray &obj )
{
    debug_report("( const mdarray &obj )");
 ...
 *            
 */
mdarray_double &mdarray_double::init_properties( const mdarray &src_obj )
{
 ...
 *
 */
mdarray_double &mdarray_double::set_auto_resize( bool tf )
{
 ...
 *
 */
mdarray_double &mdarray_double::set_auto_init( bool tf )
{
 ...
 *
 */
mdarray_double &mdarray_double::set_rounding( bool tf )
{
 ...
 *
 */
mdarray_double &mdarray_double::set_alloc_strategy( const char *strategy )
{
...
{
    mdarray_double *this_p = (mdarray_double *)p;
    double v0 = *((const double *)v0p);
    *((double *)v1p) = (*(this_p->convert_func_rec))(v0, this_p->convert_user_ptr_rec);
}
*/

/*
mdarray_double &mdarray_double::convert( double (*func)(double,void *),
				       void *user_ptr )
{
    this->convert_func_rec = func;
    this->convert_user_ptr_rec = user_ptr;
    this->mdarray::convert(DOUBLE_ZT, &fnc_for_convert, (void *)this);
    return *this;
}
*/
 ...
 * @throw      内部バッファの確保に失敗した場合
 */
mdarray_double &mdarray_double::convert_via_udf( void (*func)(const double *,double *,size_t,int,void *),
				       void *user_ptr )
{
    this->mdarray::convert_via_udf(DOUBLE_ZT,
 ...
 */
mdarray_double &mdarray_double::swap( mdarray &sobj )
{
 ...
 *  dest には，mdarray_double クラスのオブジェクトあるいは mdarray クラスの
 ...
 *
 */
ssize_t mdarray_double::copy( mdarray *dest ) const
{
 ...
 * @deprecated 非推奨．<br>
 * ssize_t mdarray_double::copy( mdarray *dest ) const <br>
 * をお使いください．
 */
ssize_t mdarray_double::copy( mdarray &dest ) const
{
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_double &mdarray_double::cut( mdarray *dest )
{
    debug_report("( mdarray *dest )");
 ...
 */
mdarray_double &mdarray_double::transpose_xy()
{
 ...
 * @note  高速なアルゴリズムを使用しています．
 */
mdarray_double &mdarray_double::transpose_xyz2zxy()
{
 ...
 * 
 */
mdarray_double &mdarray_double::rotate_xy( int angle )
{
 ...
 *
 */
ssize_t mdarray_double::get_elements( double *dest_buf, size_t elem_size, 
 ...
 *
 */
ssize_t mdarray_double::put_elements( const double *src_buf, size_t elem_size,
 ...
 *
 */
mdarray_double &mdarray_double::increase_dim()
{
 ...
 *
 */
mdarray_double &mdarray_double::decrease_dim()
{
 ...
 *
 */
mdarray_double &mdarray_double::resize( size_t len )
{
 ...
 *
 */
mdarray_double &mdarray_double::resize( size_t dim_index, size_t len )
{
 ...
 *
 */
mdarray_double &mdarray_double::resize( const mdarray &src )
{
 ...
 */
mdarray_double &mdarray_double::resize_1d( size_t x_len )
{
 ...
 */
mdarray_double &mdarray_double::resize_2d( size_t x_len, size_t y_len )
{
 ...
 *  します．
 */
mdarray_double &mdarray_double::resize_3d( size_t x_len, size_t y_len, size_t z_len )
{
 ...
 */
mdarray_double &mdarray_double::resize( const size_t naxisx[], size_t ndim, bool init_buf )
{
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_double &mdarray_double::resizef( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_double &mdarray_double::vresizef( const char *exp_fmt, va_list ap )
{
    this->mdarray::vresizef(exp_fmt,ap);
    return *this;
}
 ...
 *
 */
mdarray_double &mdarray_double::resizeby( ssize_t len )
{
 ...
 *
 */
mdarray_double &mdarray_double::resizeby( size_t dim_index, ssize_t len )
{
 ...
 */
mdarray_double &mdarray_double::resizeby_1d( ssize_t x_len )
{
 ...
 */
mdarray_double &mdarray_double::resizeby_2d( ssize_t x_len, ssize_t y_len )
{
 ...
 */
mdarray_double &mdarray_double::resizeby_3d(ssize_t x_len, ssize_t y_len, ssize_t z_len)
{
 ...
 * @throw     内部バッファの確保に失敗した場合
 */
mdarray_double &mdarray_double::resizeby( const ssize_t naxisx_rel[], size_t ndim, 
			    bool init_buf )
{
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_double &mdarray_double::resizebyf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @throw  内部バッファの確保に失敗した場合
 */
mdarray_double &mdarray_double::vresizebyf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vresizebyf(exp_fmt,ap);
    return *this;
}
 ...
 * @throw     内部バッファの確保に失敗した場合
 */
mdarray_double &mdarray_double::reallocate( const size_t naxisx[], size_t ndim, bool init_buf )
{
 ...
 * @throw    内部バッファの確保に失敗した場合
 */
mdarray_double &mdarray_double::allocate( const size_t naxisx[], size_t ndim, bool init_buf )
{
 ...
 *
 */
mdarray_double &mdarray_double::assign_default( double value )
{
 ...
 *
 */
mdarray_double &mdarray_double::insert( ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_double &mdarray_double::insert( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_double &mdarray_double::erase( ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_double &mdarray_double::erase( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_double &mdarray_double::move( ssize_t idx_src, size_t len, ssize_t idx_dst,
			   bool clr )
{
 ...
 *
 */
mdarray_double &mdarray_double::move( size_t dim_index, 
 ...
 *
 */
mdarray_double &mdarray_double::cpy( ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr )
{
 ...
 *
 */
mdarray_double &mdarray_double::cpy( size_t dim_index, 
			  ssize_t idx_src, size_t len, ssize_t idx_dst,
			  bool clr )
{
 ...
 *
 */
mdarray_double &mdarray_double::swap( ssize_t idx_src, size_t len, ssize_t idx_dst )
{
 ...
 *
 */
mdarray_double &mdarray_double::swap( size_t dim_index, 
		      ssize_t idx_src, size_t len, ssize_t idx_dst )
{
 ...
 *
 */
mdarray_double &mdarray_double::crop( ssize_t idx, size_t len )
{
 ...
 *
 */
mdarray_double &mdarray_double::crop( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 * @deprecated 未実装です.
 */
mdarray_double &mdarray_double::cropf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @deprecated 未実装です.
 */
mdarray_double &mdarray_double::vcropf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vcropf(exp_fmt,ap);
    return *this;
}
 ...
 * @return    自身の参照
 */
mdarray_double &mdarray_double::flip( ssize_t idx, size_t len )
{
 ...
 * @return    自身の参照
 */
mdarray_double &mdarray_double::flip( size_t dim_index, ssize_t idx, size_t len )
{
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
ssize_t mdarray_double::copyf( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
ssize_t mdarray_double::vcopyf( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 * @deprecated  未実装
 */
ssize_t mdarray_double::convertf_copy( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @deprecated  未実装
 */
ssize_t mdarray_double::vconvertf_copy( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_double &mdarray_double::trimf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_double &mdarray_double::vtrimf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vtrimf(exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_double &mdarray_double::flipf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  任意の次元(複数も可)で配列の並びを反転 (IDLの記法)
 */
mdarray_double &mdarray_double::vflipf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vflipf(exp_fmt, ap);
    return *this;
}
 ...
 */
ssize_t mdarray_double::transposef_xy_copy( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @brief  (x,y)のトランスポーズを行なった配列を取得 (IDLの記法)
 */
ssize_t mdarray_double::vtransposef_xy_copy( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 */
ssize_t mdarray_double::transposef_xyz2zxy_copy( mdarray *dest_obj, const char *exp_fmt, ... ) const
{
    ssize_t ret;
    va_list ap;
    va_start(ap, exp_fmt);
 ...
 * @brief  (x,y,z)→(z,x,y)のトランスポーズを行なった配列を取得 (IDLの記法)
 */
ssize_t mdarray_double::vtransposef_xyz2zxy_copy( mdarray *dest_obj, const char *exp_fmt, va_list ap ) const
{
 ...
 */
mdarray_double &mdarray_double::cleanf( const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列をデフォルト値でパディング (IDLの記法)
 */
mdarray_double &mdarray_double::vcleanf( const char *exp_fmt, va_list ap )
{
    this->mdarray::vcleanf(exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_double &mdarray_double::fillf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を指定されたスカラー値で書き換え (IDLの記法)
 */
mdarray_double &mdarray_double::vfillf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vfillf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_double &mdarray_double::fillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_double *,void *),
 ...
 * @brief  自身の配列をスカラー値で書き換え (ユーザ関数経由・IDLの記法)
 */
mdarray_double &mdarray_double::vfillf_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_double *,void *),
 ...
 */
mdarray_double &mdarray_double::addf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたスカラー値で加算 (IDLの記法)
 */
mdarray_double &mdarray_double::vaddf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vaddf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_double &mdarray_double::subtractf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を，指定されたスカラー値で減算 (IDLの記法)
 */
mdarray_double &mdarray_double::vsubtractf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vsubtractf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_double &mdarray_double::multiplyf( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたスカラー値を乗算 (IDLの記法)
 */
mdarray_double &mdarray_double::vmultiplyf( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vmultiplyf(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_double &mdarray_double::dividef( double value, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を，指定されたスカラー値で除算 (IDLの記法)
 */
mdarray_double &mdarray_double::vdividef( double value, const char *exp_fmt, va_list ap )
{
    this->mdarray::vdividef(value, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_double &mdarray_double::pastef( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に指定されたオブジェクトの配列を貼り付け (IDLの記法)
 */
mdarray_double &mdarray_double::vpastef( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vpastef(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_double &mdarray_double::pastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_double *,void *),
	void *user_ptr,
        const char *exp_fmt, ... )
{
 ...
 * @brief  自身の配列に指定された配列を貼り付け (ユーザ関数経由・IDLの記法)
 */
mdarray_double &mdarray_double::vpastef_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t, ssize_t,ssize_t,ssize_t,mdarray_double *,void *),
	void *user_ptr,
 ...
 */
mdarray_double &mdarray_double::addf( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたオブジェクトの配列を加算 (IDLの記法)
 */
mdarray_double &mdarray_double::vaddf( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vaddf(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_double &mdarray_double::subtractf( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief 自身の配列を，指定されたオブジェクトの配列で減算 (IDLの記法)
 */
mdarray_double &mdarray_double::vsubtractf( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vsubtractf(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_double &mdarray_double::multiplyf( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列に，指定されたオブジェクトの配列を乗算 (IDLの記法)
 */
mdarray_double &mdarray_double::vmultiplyf( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vmultiplyf(src, exp_fmt, ap);
    return *this;
}
 ...
 */
mdarray_double &mdarray_double::dividef( const mdarray &src, const char *exp_fmt, ... )
{
    va_list ap;
    va_start(ap, exp_fmt);
    try {
 ...
 * @brief  自身の配列を，指定されたオブジェクトの配列で除算 (IDLの記法)
 */
mdarray_double &mdarray_double::vdividef( const mdarray &src, const char *exp_fmt, va_list ap )
{
    this->mdarray::vdividef(src, exp_fmt, ap);
    return *this;
}
 ...
 *
 */
ssize_t mdarray_double::copy( mdarray *dest,
 ...
 * @deprecated  未実装
 */
ssize_t mdarray_double::convert_copy( mdarray *dest,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 */
mdarray_double &mdarray_double::move_from(ssize_t col_idx, size_t col_len,
					  ssize_t row_idx, size_t row_len, 
 ...
 */
mdarray_double &mdarray_double::move_to( 
 ...
 * @throw     バッファの確保に失敗した場合．メモリ破壊を起こした場合．
 */
mdarray_double &mdarray_double::trim( ssize_t col_idx, size_t col_len,
				      ssize_t row_idx, size_t row_len, 
				      ssize_t layer_idx, size_t layer_len )
{
 ...
 * @return    自身の参照
 */
mdarray_double &mdarray_double::flip_cols( ssize_t col_idx, size_t col_len,
					  ssize_t row_idx, size_t row_len, 
					  ssize_t layer_idx, size_t layer_len )
{
 ...
 * @return    自身の参照
 */
mdarray_double &mdarray_double::flip_rows( ssize_t col_idx, size_t col_len,
					  ssize_t row_idx, size_t row_len, 
					  ssize_t layer_idx, size_t layer_len )
{
 ...
 */
ssize_t mdarray_double::transpose_xy_copy( mdarray *dest,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 */
ssize_t mdarray_double::transpose_xyz2zxy_copy( mdarray *dest,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 */
ssize_t mdarray_double::rotate_xy_copy( mdarray *dest, int angle,
				    ssize_t col_idx, size_t col_len,
				    ssize_t row_idx, size_t row_len, 
				    ssize_t layer_idx, size_t layer_len ) const
{
 ...
 *
 */
mdarray_double &mdarray_double::clean( ssize_t col_index, size_t col_size,
 ...
 *
 */
mdarray_double &mdarray_double::fill( double value, 
 ...
 *
 */
mdarray_double &mdarray_double::fill_via_udf( double value, 
	void (*func)(double [],double,size_t, ssize_t,ssize_t,ssize_t,mdarray_double *,void *),
	void *user_ptr,
	ssize_t col_index, size_t col_size,
	ssize_t row_index, size_t row_size,
 ...
 *
 */
mdarray_double &mdarray_double::add( double value, 
		    ssize_t col_index, size_t col_size,
		    ssize_t row_index, size_t row_size,
		    ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_double &mdarray_double::subtract( double value, 
				       ssize_t col_index, size_t col_size,
				       ssize_t row_index, size_t row_size,
				       ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_double &mdarray_double::multiply( double value, 
		    ssize_t col_index, size_t col_size,
		    ssize_t row_index, size_t row_size,
		    ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_double &mdarray_double::divide( double value, 
				       ssize_t col_index, size_t col_size,
				       ssize_t row_index, size_t row_size,
				       ssize_t layer_index, size_t layer_size )
{
 ...
 *
 */
mdarray_double &mdarray_double::paste( const mdarray &src,
	ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_double &mdarray_double::paste_via_udf( const mdarray &src,
	void (*func)(double [],double [],size_t,ssize_t,ssize_t,ssize_t,mdarray_double *,void *),
	void *user_ptr,
	ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_double &mdarray_double::add( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_double &mdarray_double::subtract( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_double &mdarray_double::multiply( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *
 */
mdarray_double &mdarray_double::divide( const mdarray &src_img,
	  ssize_t dest_col, ssize_t dest_row, ssize_t dest_layer )
{
 ...
 *             ます．
 */
mdarray_double &mdarray_double::register_extptr( double **extptr_address )
{
    this->mdarray::register_extptr((void *)extptr_address);
    return *this;
}
 ...
 *             ます．
 */
mdarray_double &mdarray_double::register_extptr_2d( double *const **extptr2d_address )
{
    this->mdarray::register_extptr_2d((void *)extptr2d_address);
    return *this;
}
 ...
 *             ます．
 */
mdarray_double &mdarray_double::register_extptr_3d( double *const *const **extptr3d_address )
{
    this->mdarray::register_extptr_3d((void *)extptr3d_address);
    return *this;
}
 ...
 *
 */
mdarray_double &mdarray_double::reverse_endian( bool is_little_endian )
{
 ...
 * 
 * @return  型種別 (固定値: double)
 * @note    このメンバ関数はprotectedです．
 */
ssize_t mdarray_double::default_size_type()
{
    return DOUBLE_ZT;
}
 ...
 * 
 * @param   sz_type 型種別
 * @return  受け入れ可能な型(double)なら真
 * @note    このメンバ関数はprotectedです．
 */
bool mdarray_double::is_acceptable_size_type( ssize_t sz_type )
{
    if ( sz_type == DOUBLE_ZT ) return true;
    else return false;
}
