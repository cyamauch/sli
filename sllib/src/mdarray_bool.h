...
/**
 * @file   mdarray_bool.h
 * @brief  bool型の多次元配列を扱う mdarray_bool クラスのヘッダファイル
 */
 ...
 * @brief  bool型の多次元配列を扱うためのクラス
 *
 *   mdarray_boolクラスは，bool型の多次元配列を IDL や Python のように
 ...
 * 
 * @note  mdarray_boolクラスは mdarray(基底クラス) を継承しています．<br>
  ...
  public:
    ...
    */
    ...
    virtual mdarray_bool &vinit( bool auto_resize, const char *dim_info,
				  int v0, va_list );
#endif
    /*  mdarray_bool &init( const mdarray &obj ); が隠れている */
