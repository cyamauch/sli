...
/* Time-stamp: <2012-11-30 12:40:47 cyamauch> */

/*

  Performance test of s_memmove()
  
  g++ -Wall -O2 -msse2 s_memcpy_test.cc -o s_memcpy_test -DUSE_SIMD
...
#include "../../src/private/s_memcpy.h"
...
int main()
{
    ...
    tm0 = clock() / (double)CLOCKS_PER_SEC;
    s_memcpy(p1, p0, buf_len, 0);
    tm1 = clock() / (double)CLOCKS_PER_SEC;
    printf("s_memcpy() etime: %g\n",tm1 - tm0);
...
#include "../../src/private/s_memcpy.cc"
